...
Cranberry28: {
	...
	config: [
		...
		// Cranberry28 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry28 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry28
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry28 proxy object. All configs
