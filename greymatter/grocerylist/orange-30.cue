...
Orange_30: {
	...
	config: [
		...
		// Orange_30 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_30 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-30/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-30$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-30
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-30 proxy object. All configs
