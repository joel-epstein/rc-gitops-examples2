...
Blueberry10: {
	...
	config: [
		...
		// Blueberry10 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry10 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry10/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry10$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry10
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry10 proxy object. All configs
