...
Kiwi_332: {
	...
	config: [
		...
		// Kiwi_332 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_332 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_332/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_332$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_332
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_332 proxy object. All configs
