...
Grape_82: {
	...
	config: [
		...
		// Grape_82 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_82 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-82/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-82$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-82
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-82 proxy object. All configs
