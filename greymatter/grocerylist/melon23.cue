...
Melon23: {
	...
	config: [
		...
		// Melon23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon23
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon23 proxy object. All configs
