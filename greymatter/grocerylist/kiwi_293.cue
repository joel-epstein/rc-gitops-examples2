...
Kiwi_293: {
	...
	config: [
		...
		// Kiwi_293 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_293 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_293/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_293$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_293
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_293 proxy object. All configs
