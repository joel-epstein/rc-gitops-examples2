...
Orange_50: {
	...
	config: [
		...
		// Orange_50 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_50 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-50/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-50$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-50
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-50 proxy object. All configs
