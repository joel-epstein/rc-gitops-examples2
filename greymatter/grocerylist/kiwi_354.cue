...
Kiwi_354: {
	...
	config: [
		...
		// Kiwi_354 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_354 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_354/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_354$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_354
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_354 proxy object. All configs
