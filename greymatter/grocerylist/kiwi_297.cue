...
Kiwi_297: {
	...
	config: [
		...
		// Kiwi_297 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_297 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_297/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_297$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_297
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_297 proxy object. All configs
