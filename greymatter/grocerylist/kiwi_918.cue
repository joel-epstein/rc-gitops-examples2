...
Kiwi_918: {
	...
	config: [
		...
		// Kiwi_918 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_918 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_918/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_918$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_918
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_918 proxy object. All configs
