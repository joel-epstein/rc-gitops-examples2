...
Melon_67: {
	...
	config: [
		...
		// Melon_67 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_67 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-67/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-67$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-67
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-67 proxy object. All configs
