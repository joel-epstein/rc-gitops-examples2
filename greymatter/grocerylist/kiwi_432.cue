...
Kiwi_432: {
	...
	config: [
		...
		// Kiwi_432 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_432 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_432/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_432$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_432
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_432 proxy object. All configs
