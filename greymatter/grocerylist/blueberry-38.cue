...
Blueberry_38: {
	...
	config: [
		...
		// Blueberry_38 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_38 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-38
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-38 proxy object. All configs
