...
Star45: {
	...
	config: [
		...
		// Star45 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star45 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star45/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star45$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star45
		#catalog_entry & {
			name:                      Name
		...
		// Shared star45 proxy object. All configs
