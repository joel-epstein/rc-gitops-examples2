...
Kiwi_97: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-97/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-97$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-97
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-97 proxy object. All configs
