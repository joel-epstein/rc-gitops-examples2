...
Tangerine33: {
	...
	config: [
		...
		// Tangerine33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine33
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine33 proxy object. All configs
