...
Kiwi_951: {
	...
	config: [
		...
		// Kiwi_951 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_951 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_951/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_951$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_951
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_951 proxy object. All configs
