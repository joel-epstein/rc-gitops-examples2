...
Cranberry29: {
	...
	config: [
		...
		// Cranberry29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry29
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry29 proxy object. All configs
