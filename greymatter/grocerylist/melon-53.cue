...
Melon_53: {
	...
	config: [
		...
		// Melon_53 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_53 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-53/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-53$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-53
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-53 proxy object. All configs
