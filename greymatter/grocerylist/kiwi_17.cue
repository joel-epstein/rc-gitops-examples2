...
Kiwi_17: {
	...
	config: [
		...
		// Kiwi_17 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_17 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_17
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_17 proxy object. All configs
