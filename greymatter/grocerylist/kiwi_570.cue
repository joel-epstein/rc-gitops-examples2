...
Kiwi_570: {
	...
	config: [
		...
		// Kiwi_570 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_570 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_570/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_570$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_570
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_570 proxy object. All configs
