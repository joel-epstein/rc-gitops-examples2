...
Kiwi85: {
	...
	config: [
		...
		// Kiwi85 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi85 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi85/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi85$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi85
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi85 proxy object. All configs
