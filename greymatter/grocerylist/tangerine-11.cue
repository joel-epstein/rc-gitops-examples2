...
Tangerine_11: {
	...
	config: [
		...
		// Tangerine_11 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_11 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-11/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-11$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-11
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-11 proxy object. All configs
