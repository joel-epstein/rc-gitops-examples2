...
Tangerine_18: {
	...
	config: [
		...
		// Tangerine_18 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_18 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-18/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-18$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-18
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-18 proxy object. All configs
