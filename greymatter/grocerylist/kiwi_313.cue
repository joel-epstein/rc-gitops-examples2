...
Kiwi_313: {
	...
	config: [
		...
		// Kiwi_313 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_313 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_313/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_313$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_313
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_313 proxy object. All configs
