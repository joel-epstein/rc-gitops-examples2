...
Kiwi_381: {
	...
	config: [
		...
		// Kiwi_381 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_381 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_381/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_381$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_381
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_381 proxy object. All configs
