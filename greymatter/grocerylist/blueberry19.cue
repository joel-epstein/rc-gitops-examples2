...
Blueberry19: {
	...
	config: [
		...
		// Blueberry19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry19
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry19 proxy object. All configs
