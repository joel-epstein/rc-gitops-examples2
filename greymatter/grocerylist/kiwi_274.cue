...
Kiwi_274: {
	...
	config: [
		...
		// Kiwi_274 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_274 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_274/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_274$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_274
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_274 proxy object. All configs
