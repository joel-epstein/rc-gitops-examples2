...
Blueberry_41: {
	...
	config: [
		...
		// Blueberry_41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-41
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-41 proxy object. All configs
