...
Kiwi_108: {
	...
	config: [
		...
		// Kiwi_108 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_108 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_108/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_108$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_108
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_108 proxy object. All configs
