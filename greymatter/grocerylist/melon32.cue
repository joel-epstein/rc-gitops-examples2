...
Melon32: {
	...
	config: [
		...
		// Melon32 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon32 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon32/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon32$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon32
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon32 proxy object. All configs
