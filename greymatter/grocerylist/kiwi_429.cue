...
Kiwi_429: {
	...
	config: [
		...
		// Kiwi_429 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_429 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_429/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_429$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_429
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_429 proxy object. All configs
