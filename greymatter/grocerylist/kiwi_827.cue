...
Kiwi_827: {
	...
	config: [
		...
		// Kiwi_827 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_827 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_827/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_827$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_827
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_827 proxy object. All configs
