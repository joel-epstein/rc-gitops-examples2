...
Kiwi_227: {
	...
	config: [
		...
		// Kiwi_227 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_227 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_227/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_227$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_227
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_227 proxy object. All configs
