...
Kiwi_925: {
	...
	config: [
		...
		// Kiwi_925 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_925 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_925/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_925$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_925
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_925 proxy object. All configs
