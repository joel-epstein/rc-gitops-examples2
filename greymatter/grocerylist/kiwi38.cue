...
Kiwi38: {
	...
	config: [
		...
		// Kiwi38 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi38
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi38 proxy object. All configs
