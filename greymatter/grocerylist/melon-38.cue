...
Melon_38: {
	...
	config: [
		...
		// Melon_38 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_38 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-38
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-38 proxy object. All configs
