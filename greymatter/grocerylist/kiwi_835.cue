...
Kiwi_835: {
	...
	config: [
		...
		// Kiwi_835 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_835 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_835/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_835$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_835
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_835 proxy object. All configs
