...
Kiwi_640: {
	...
	config: [
		...
		// Kiwi_640 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_640 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_640/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_640$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_640
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_640 proxy object. All configs
