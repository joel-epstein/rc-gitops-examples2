...
Melon2: {
	...
	config: [
		...
		// Melon2 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon2 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon2/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon2$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon2
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon2 proxy object. All configs
