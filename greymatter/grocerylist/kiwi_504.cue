...
Kiwi_504: {
	...
	config: [
		...
		// Kiwi_504 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_504 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_504/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_504$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_504
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_504 proxy object. All configs
