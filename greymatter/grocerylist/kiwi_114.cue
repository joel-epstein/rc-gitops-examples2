...
Kiwi_114: {
	...
	config: [
		...
		// Kiwi_114 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_114 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_114/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_114$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_114
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_114 proxy object. All configs
