...
Blueberry12: {
	...
	config: [
		...
		// Blueberry12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry12
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry12 proxy object. All configs
