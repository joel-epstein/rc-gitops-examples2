...
Kiwi_712: {
	...
	config: [
		...
		// Kiwi_712 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_712 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_712/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_712$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_712
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_712 proxy object. All configs
