...
Orange_32: {
	...
	config: [
		...
		// Orange_32 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_32 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-32/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-32$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-32
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-32 proxy object. All configs
