...
Kiwi_927: {
	...
	config: [
		...
		// Kiwi_927 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_927 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_927/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_927$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_927
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_927 proxy object. All configs
