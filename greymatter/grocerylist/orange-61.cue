...
Orange_61: {
	...
	config: [
		...
		// Orange_61 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_61 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-61/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-61$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-61
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-61 proxy object. All configs
