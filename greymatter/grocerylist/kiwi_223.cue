...
Kiwi_223: {
	...
	config: [
		...
		// Kiwi_223 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_223 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_223/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_223$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_223
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_223 proxy object. All configs
