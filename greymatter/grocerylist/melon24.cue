...
Melon24: {
	...
	config: [
		...
		// Melon24 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon24 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon24/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon24$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon24
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon24 proxy object. All configs
