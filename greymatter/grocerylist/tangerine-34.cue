...
Tangerine_34: {
	...
	config: [
		...
		// Tangerine_34 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_34 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-34
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-34 proxy object. All configs
