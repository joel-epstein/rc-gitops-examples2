...
Kiwi_954: {
	...
	config: [
		...
		// Kiwi_954 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_954 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_954/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_954$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_954
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_954 proxy object. All configs
