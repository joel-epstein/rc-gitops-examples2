...
Orange_13: {
	...
	config: [
		...
		// Orange_13 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_13 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-13
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-13 proxy object. All configs
