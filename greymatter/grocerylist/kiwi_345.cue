...
Kiwi_345: {
	...
	config: [
		...
		// Kiwi_345 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_345 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_345/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_345$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_345
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_345 proxy object. All configs
