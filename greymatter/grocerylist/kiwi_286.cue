...
Kiwi_286: {
	...
	config: [
		...
		// Kiwi_286 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_286 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_286/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_286$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_286
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_286 proxy object. All configs
