...
Kiwi_628: {
	...
	config: [
		...
		// Kiwi_628 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_628 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_628/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_628$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_628
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_628 proxy object. All configs
