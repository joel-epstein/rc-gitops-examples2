...
Melon_57: {
	...
	config: [
		...
		// Melon_57 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_57 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-57/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-57$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-57
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-57 proxy object. All configs
