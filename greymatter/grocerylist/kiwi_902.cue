...
Kiwi_902: {
	...
	config: [
		...
		// Kiwi_902 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_902 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_902/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_902$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_902
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_902 proxy object. All configs
