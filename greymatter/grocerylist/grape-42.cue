...
Grape_42: {
	...
	config: [
		...
		// Grape_42 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_42 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-42/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-42$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-42
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-42 proxy object. All configs
