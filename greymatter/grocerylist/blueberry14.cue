...
Blueberry14: {
	...
	config: [
		...
		// Blueberry14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry14
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry14 proxy object. All configs
