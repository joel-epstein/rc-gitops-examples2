...
Kiwi_482: {
	...
	config: [
		...
		// Kiwi_482 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_482 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_482/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_482$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_482
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_482 proxy object. All configs
