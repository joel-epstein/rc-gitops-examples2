...
Orange_15: {
	...
	config: [
		...
		// Orange_15 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_15 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-15/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-15$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-15
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-15 proxy object. All configs
