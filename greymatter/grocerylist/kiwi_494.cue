...
Kiwi_494: {
	...
	config: [
		...
		// Kiwi_494 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_494 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_494/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_494$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_494
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_494 proxy object. All configs
