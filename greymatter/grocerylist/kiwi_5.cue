...
Kiwi_5: {
	...
	config: [
		...
		// Kiwi_5 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_5 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_5/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_5$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_5
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_5 proxy object. All configs
