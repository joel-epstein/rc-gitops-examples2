...
Melon43: {
	...
	config: [
		...
		// Melon43 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon43 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon43/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon43$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon43
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon43 proxy object. All configs
