...
Kiwi_3: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_3/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_3$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_3
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_3 proxy object. All configs
