...
Kiwi_7: {
	...
	config: [
		...
		// Kiwi_7 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_7 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_7/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_7$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_7
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_7 proxy object. All configs
