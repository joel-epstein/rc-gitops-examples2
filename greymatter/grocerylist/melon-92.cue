...
Melon_92: {
	...
	config: [
		...
		// Melon_92 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_92 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-92/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-92$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-92
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-92 proxy object. All configs
