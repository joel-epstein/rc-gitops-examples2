...
Kiwi_551: {
	...
	config: [
		...
		// Kiwi_551 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_551 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_551/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_551$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_551
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_551 proxy object. All configs
