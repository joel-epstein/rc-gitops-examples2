...
Kiwi_513: {
	...
	config: [
		...
		// Kiwi_513 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_513 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_513/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_513$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_513
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_513 proxy object. All configs
