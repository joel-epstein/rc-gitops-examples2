...
Kiwi_144: {
	...
	config: [
		...
		// Kiwi_144 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_144 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_144/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_144$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_144
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_144 proxy object. All configs
