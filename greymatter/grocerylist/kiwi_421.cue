...
Kiwi_421: {
	...
	config: [
		...
		// Kiwi_421 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_421 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_421/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_421$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_421
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_421 proxy object. All configs
