...
Kiwi_919: {
	...
	config: [
		...
		// Kiwi_919 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_919 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_919/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_919$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_919
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_919 proxy object. All configs
