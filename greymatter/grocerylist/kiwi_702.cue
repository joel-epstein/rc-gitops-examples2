...
Kiwi_702: {
	...
	config: [
		...
		// Kiwi_702 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_702 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_702/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_702$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_702
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_702 proxy object. All configs
