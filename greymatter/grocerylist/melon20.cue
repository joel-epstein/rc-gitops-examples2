...
Melon20: {
	...
	config: [
		...
		// Melon20 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon20 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon20/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon20$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon20
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon20 proxy object. All configs
