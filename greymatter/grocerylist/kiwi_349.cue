...
Kiwi_349: {
	...
	config: [
		...
		// Kiwi_349 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_349 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_349/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_349$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_349
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_349 proxy object. All configs
