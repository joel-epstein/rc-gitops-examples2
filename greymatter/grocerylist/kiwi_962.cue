...
Kiwi_962: {
	...
	config: [
		...
		// Kiwi_962 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_962 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_962/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_962$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_962
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_962 proxy object. All configs
