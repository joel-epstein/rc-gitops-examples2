...
Kiwi_597: {
	...
	config: [
		...
		// Kiwi_597 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_597 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_597/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_597$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_597
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_597 proxy object. All configs
