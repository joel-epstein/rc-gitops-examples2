...
Kiwi_584: {
	...
	config: [
		...
		// Kiwi_584 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_584 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_584/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_584$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_584
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_584 proxy object. All configs
