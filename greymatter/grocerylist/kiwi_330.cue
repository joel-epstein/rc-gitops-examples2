...
Kiwi_330: {
	...
	config: [
		...
		// Kiwi_330 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_330 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_330/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_330$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_330
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_330 proxy object. All configs
