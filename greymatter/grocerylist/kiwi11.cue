...
Kiwi11: {
	...
	config: [
		...
		// Kiwi11 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi11 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi11/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi11$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi11
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi11 proxy object. All configs
