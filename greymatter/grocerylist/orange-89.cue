...
Orange_89: {
	...
	config: [
		...
		// Orange_89 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_89 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-89/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-89$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-89
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-89 proxy object. All configs
