...
Cranberry27: {
	...
	config: [
		...
		// Cranberry27 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry27 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry27/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry27$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry27
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry27 proxy object. All configs
