...
Kiwi_263: {
	...
	config: [
		...
		// Kiwi_263 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_263 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_263/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_263$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_263
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_263 proxy object. All configs
