...
Kiwi_931: {
	...
	config: [
		...
		// Kiwi_931 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_931 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_931/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_931$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_931
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_931 proxy object. All configs
