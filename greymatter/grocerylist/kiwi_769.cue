...
Kiwi_769: {
	...
	config: [
		...
		// Kiwi_769 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_769 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_769/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_769$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_769
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_769 proxy object. All configs
