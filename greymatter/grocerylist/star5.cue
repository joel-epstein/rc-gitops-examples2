...
Star5: {
	...
	config: [
		...
		// Star5 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star5 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star5/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star5$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star5
		#catalog_entry & {
			name:                      Name
		...
		// Shared star5 proxy object. All configs
