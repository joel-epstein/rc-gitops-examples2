...
Kiwi_720: {
	...
	config: [
		...
		// Kiwi_720 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_720 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_720/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_720$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_720
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_720 proxy object. All configs
