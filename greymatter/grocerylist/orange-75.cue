...
Orange_75: {
	...
	config: [
		...
		// Orange_75 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_75 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-75/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-75$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-75
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-75 proxy object. All configs
