...
Cranberry1: {
	...
	config: [
		...
		// Cranberry1 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry1 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry1/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry1$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry1
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry1 proxy object. All configs
