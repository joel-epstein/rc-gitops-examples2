...
Tangerine_88: {
	...
	config: [
		...
		// Tangerine_88 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_88 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-88/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-88$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-88
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-88 proxy object. All configs
