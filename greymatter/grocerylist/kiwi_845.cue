...
Kiwi_845: {
	...
	config: [
		...
		// Kiwi_845 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_845 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_845/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_845$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_845
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_845 proxy object. All configs
