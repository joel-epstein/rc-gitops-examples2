...
Tangerine_44: {
	...
	config: [
		...
		// Tangerine_44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-44
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-44 proxy object. All configs
