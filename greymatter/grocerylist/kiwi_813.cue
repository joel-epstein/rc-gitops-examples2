...
Kiwi_813: {
	...
	config: [
		...
		// Kiwi_813 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_813 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_813/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_813$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_813
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_813 proxy object. All configs
