...
Kiwi_990: {
	...
	config: [
		...
		// Kiwi_990 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_990 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_990/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_990$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_990
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_990 proxy object. All configs
