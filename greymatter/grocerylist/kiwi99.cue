...
Kiwi99: {
	...
	config: [
		...
		// Kiwi99 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi99 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi99/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi99$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi99
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi99 proxy object. All configs
