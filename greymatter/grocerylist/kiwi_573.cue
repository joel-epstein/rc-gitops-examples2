...
Kiwi_573: {
	...
	config: [
		...
		// Kiwi_573 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_573 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_573/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_573$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_573
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_573 proxy object. All configs
