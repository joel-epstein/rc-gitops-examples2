...
Kiwi64: {
	...
	config: [
		...
		// Kiwi64 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi64 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi64/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi64$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi64
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi64 proxy object. All configs
