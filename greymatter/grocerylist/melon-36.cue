...
Melon_36: {
	...
	config: [
		...
		// Melon_36 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_36 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-36
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-36 proxy object. All configs
