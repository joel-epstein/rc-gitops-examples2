...
Blueberry50: {
	...
	config: [
		...
		// Blueberry50 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry50 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry50/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry50$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry50
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry50 proxy object. All configs
