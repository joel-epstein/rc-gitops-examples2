...
Blueberry_45: {
	...
	config: [
		...
		// Blueberry_45 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_45 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-45/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-45$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-45
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-45 proxy object. All configs
