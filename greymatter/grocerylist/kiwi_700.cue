...
Kiwi_700: {
	...
	config: [
		...
		// Kiwi_700 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_700 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_700/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_700$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_700
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_700 proxy object. All configs
