...
Kiwi_54: {
	...
	config: [
		...
		// Kiwi_54 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_54 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_54/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_54$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_54
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_54 proxy object. All configs
