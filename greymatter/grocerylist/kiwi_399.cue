...
Kiwi_399: {
	...
	config: [
		...
		// Kiwi_399 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_399 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_399/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_399$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_399
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_399 proxy object. All configs
