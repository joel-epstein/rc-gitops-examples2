...
Kiwi_518: {
	...
	config: [
		...
		// Kiwi_518 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_518 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_518/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_518$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_518
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_518 proxy object. All configs
