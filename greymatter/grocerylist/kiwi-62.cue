...
Kiwi_62: {
	...
	config: [
		...
		// Kiwi_62 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_62 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-62/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-62$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-62
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-62 proxy object. All configs
