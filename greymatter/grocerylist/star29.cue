...
Star29: {
	...
	config: [
		...
		// Star29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star29
		#catalog_entry & {
			name:                      Name
		...
		// Shared star29 proxy object. All configs
