...
Melon_72: {
	...
	config: [
		...
		// Melon_72 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_72 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-72/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-72$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-72
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-72 proxy object. All configs
