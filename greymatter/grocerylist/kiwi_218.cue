...
Kiwi_218: {
	...
	config: [
		...
		// Kiwi_218 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_218 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_218/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_218$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_218
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_218 proxy object. All configs
