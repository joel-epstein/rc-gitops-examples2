...
Kiwi_335: {
	...
	config: [
		...
		// Kiwi_335 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_335 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_335/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_335$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_335
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_335 proxy object. All configs
