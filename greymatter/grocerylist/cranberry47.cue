...
Cranberry47: {
	...
	config: [
		...
		// Cranberry47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry47
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry47 proxy object. All configs
