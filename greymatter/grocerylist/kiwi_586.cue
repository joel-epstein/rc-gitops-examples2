...
Kiwi_586: {
	...
	config: [
		...
		// Kiwi_586 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_586 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_586/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_586$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_586
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_586 proxy object. All configs
