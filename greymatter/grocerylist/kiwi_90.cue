...
Kiwi_90: {
	...
	config: [
		...
		// Kiwi_90 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_90 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_90/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_90$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_90
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_90 proxy object. All configs
