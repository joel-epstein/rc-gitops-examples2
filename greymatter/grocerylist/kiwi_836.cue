...
Kiwi_836: {
	...
	config: [
		...
		// Kiwi_836 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_836 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_836/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_836$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_836
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_836 proxy object. All configs
