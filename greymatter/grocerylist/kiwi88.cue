...
Kiwi88: {
	...
	config: [
		...
		// Kiwi88 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi88 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi88/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi88$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi88
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi88 proxy object. All configs
