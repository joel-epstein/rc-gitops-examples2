...
Tangerine_17: {
	...
	config: [
		...
		// Tangerine_17 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_17 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-17
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-17 proxy object. All configs
