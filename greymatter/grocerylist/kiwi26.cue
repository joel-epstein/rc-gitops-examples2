...
Kiwi26: {
	...
	config: [
		...
		// Kiwi26 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi26 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi26/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi26$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi26
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi26 proxy object. All configs
