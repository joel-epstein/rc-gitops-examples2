...
Kiwi_975: {
	...
	config: [
		...
		// Kiwi_975 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_975 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_975/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_975$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_975
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_975 proxy object. All configs
