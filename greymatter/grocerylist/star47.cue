...
Star47: {
	...
	config: [
		...
		// Star47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star47
		#catalog_entry & {
			name:                      Name
		...
		// Shared star47 proxy object. All configs
