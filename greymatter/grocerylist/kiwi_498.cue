...
Kiwi_498: {
	...
	config: [
		...
		// Kiwi_498 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_498 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_498/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_498$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_498
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_498 proxy object. All configs
