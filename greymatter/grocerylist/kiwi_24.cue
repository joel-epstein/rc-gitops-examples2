...
Kiwi_24: {
	...
	config: [
		...
		// Kiwi_24 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_24 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_24/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_24$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_24
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_24 proxy object. All configs
