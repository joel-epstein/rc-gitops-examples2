...
Kiwi_873: {
	...
	config: [
		...
		// Kiwi_873 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_873 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_873/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_873$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_873
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_873 proxy object. All configs
