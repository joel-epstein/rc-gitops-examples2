...
Kiwi_413: {
	...
	config: [
		...
		// Kiwi_413 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_413 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_413/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_413$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_413
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_413 proxy object. All configs
