...
Kiwi_220: {
	...
	config: [
		...
		// Kiwi_220 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_220 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_220/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_220$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_220
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_220 proxy object. All configs
