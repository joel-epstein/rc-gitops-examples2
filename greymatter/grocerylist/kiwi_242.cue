...
Kiwi_242: {
	...
	config: [
		...
		// Kiwi_242 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_242 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_242/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_242$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_242
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_242 proxy object. All configs
