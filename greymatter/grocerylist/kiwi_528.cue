...
Kiwi_528: {
	...
	config: [
		...
		// Kiwi_528 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_528 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_528/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_528$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_528
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_528 proxy object. All configs
