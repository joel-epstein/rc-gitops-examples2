...
Kiwi_749: {
	...
	config: [
		...
		// Kiwi_749 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_749 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_749/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_749$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_749
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_749 proxy object. All configs
