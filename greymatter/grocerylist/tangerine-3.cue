...
Tangerine_3: {
	...
	config: [
		...
		// Tangerine_3 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_3 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-3/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-3$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-3
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-3 proxy object. All configs
