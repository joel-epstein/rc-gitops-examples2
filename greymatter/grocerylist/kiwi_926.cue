...
Kiwi_926: {
	...
	config: [
		...
		// Kiwi_926 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_926 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_926/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_926$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_926
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_926 proxy object. All configs
