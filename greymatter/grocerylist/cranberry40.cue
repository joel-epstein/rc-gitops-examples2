...
Cranberry40: {
	...
	config: [
		...
		// Cranberry40 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry40 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry40/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry40$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry40
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry40 proxy object. All configs
