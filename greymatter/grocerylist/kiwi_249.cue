...
Kiwi_249: {
	...
	config: [
		...
		// Kiwi_249 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_249 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_249/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_249$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_249
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_249 proxy object. All configs
