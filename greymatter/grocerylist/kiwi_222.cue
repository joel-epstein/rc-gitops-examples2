...
Kiwi_222: {
	...
	config: [
		...
		// Kiwi_222 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_222 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_222/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_222$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_222
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_222 proxy object. All configs
