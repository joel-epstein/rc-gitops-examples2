...
Tangerine_56: {
	...
	config: [
		...
		// Tangerine_56 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_56 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-56/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-56$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-56
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-56 proxy object. All configs
