...
Kiwi_153: {
	...
	config: [
		...
		// Kiwi_153 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_153 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_153/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_153$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_153
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_153 proxy object. All configs
