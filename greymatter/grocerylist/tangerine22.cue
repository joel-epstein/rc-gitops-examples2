...
Tangerine22: {
	...
	config: [
		...
		// Tangerine22 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine22 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine22
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine22 proxy object. All configs
