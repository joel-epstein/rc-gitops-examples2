...
Orange_53: {
	...
	config: [
		...
		// Orange_53 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_53 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-53/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-53$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-53
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-53 proxy object. All configs
