...
Tangerine_75: {
	...
	config: [
		...
		// Tangerine_75 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_75 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-75/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-75$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-75
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-75 proxy object. All configs
