...
Kiwi_190: {
	...
	config: [
		...
		// Kiwi_190 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_190 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_190/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_190$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_190
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_190 proxy object. All configs
