...
Orange_42: {
	...
	config: [
		...
		// Orange_42 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_42 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-42/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-42$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-42
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-42 proxy object. All configs
