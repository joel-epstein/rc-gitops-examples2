...
Blueberry_82: {
	...
	config: [
		...
		// Blueberry_82 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_82 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-82/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-82$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-82
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-82 proxy object. All configs
