...
Blueberry_58: {
	...
	config: [
		...
		// Blueberry_58 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_58 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-58/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-58$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-58
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-58 proxy object. All configs
