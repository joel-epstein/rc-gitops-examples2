...
Tangerine_10: {
	...
	config: [
		...
		// Tangerine_10 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_10 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-10/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-10$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-10
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-10 proxy object. All configs
