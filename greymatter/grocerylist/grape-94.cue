...
Grape_94: {
	...
	config: [
		...
		// Grape_94 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_94 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-94/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-94$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-94
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-94 proxy object. All configs
