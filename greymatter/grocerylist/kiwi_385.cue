...
Kiwi_385: {
	...
	config: [
		...
		// Kiwi_385 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_385 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_385/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_385$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_385
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_385 proxy object. All configs
