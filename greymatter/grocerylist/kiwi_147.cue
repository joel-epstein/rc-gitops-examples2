...
Kiwi_147: {
	...
	config: [
		...
		// Kiwi_147 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_147 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_147/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_147$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_147
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_147 proxy object. All configs
