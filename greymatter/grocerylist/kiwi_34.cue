...
Kiwi_34: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_34
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_34 proxy object. All configs
