...
Orange_90: {
	...
	config: [
		...
		// Orange_90 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_90 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-90/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-90$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-90
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-90 proxy object. All configs
