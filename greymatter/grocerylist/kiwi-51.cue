...
Kiwi_51: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-51/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-51$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-51
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-51 proxy object. All configs
