...
Kiwi_948: {
	...
	config: [
		...
		// Kiwi_948 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_948 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_948/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_948$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_948
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_948 proxy object. All configs
