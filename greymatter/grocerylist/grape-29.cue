...
Grape_29: {
	...
	config: [
		...
		// Grape_29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-29
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-29 proxy object. All configs
