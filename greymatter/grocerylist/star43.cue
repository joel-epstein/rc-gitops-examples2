...
Star43: {
	...
	config: [
		...
		// Star43 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star43 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star43/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star43$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star43
		#catalog_entry & {
			name:                      Name
		...
		// Shared star43 proxy object. All configs
