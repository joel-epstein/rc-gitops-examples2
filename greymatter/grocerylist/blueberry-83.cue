...
Blueberry_83: {
	...
	config: [
		...
		// Blueberry_83 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_83 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-83/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-83$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-83
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-83 proxy object. All configs
