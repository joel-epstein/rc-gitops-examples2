...
Kiwi_430: {
	...
	config: [
		...
		// Kiwi_430 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_430 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_430/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_430$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_430
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_430 proxy object. All configs
