...
Kiwi_999: {
	...
	config: [
		...
		// Kiwi_999 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_999 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_999/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_999$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_999
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_999 proxy object. All configs
