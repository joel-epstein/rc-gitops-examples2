...
Kiwi_172: {
	...
	config: [
		...
		// Kiwi_172 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_172 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_172/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_172$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_172
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_172 proxy object. All configs
