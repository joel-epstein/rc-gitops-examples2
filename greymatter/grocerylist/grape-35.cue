...
Grape_35: {
	...
	config: [
		...
		// Grape_35 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_35 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-35/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-35$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-35
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-35 proxy object. All configs
