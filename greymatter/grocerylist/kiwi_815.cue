...
Kiwi_815: {
	...
	config: [
		...
		// Kiwi_815 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_815 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_815/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_815$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_815
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_815 proxy object. All configs
