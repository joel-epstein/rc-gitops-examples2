...
Kiwi_878: {
	...
	config: [
		...
		// Kiwi_878 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_878 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_878/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_878$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_878
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_878 proxy object. All configs
