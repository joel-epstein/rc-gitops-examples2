...
Kiwi_319: {
	...
	config: [
		...
		// Kiwi_319 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_319 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_319/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_319$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_319
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_319 proxy object. All configs
