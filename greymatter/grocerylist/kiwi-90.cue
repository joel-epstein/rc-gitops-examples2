...
Kiwi_90: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-90/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-90$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-90
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-90 proxy object. All configs
