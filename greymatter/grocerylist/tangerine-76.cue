...
Tangerine_76: {
	...
	config: [
		...
		// Tangerine_76 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_76 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-76/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-76$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-76
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-76 proxy object. All configs
