...
Kiwi_857: {
	...
	config: [
		...
		// Kiwi_857 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_857 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_857/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_857$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_857
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_857 proxy object. All configs
