...
Melon_89: {
	...
	config: [
		...
		// Melon_89 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_89 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-89/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-89$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-89
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-89 proxy object. All configs
