...
Melon45: {
	...
	config: [
		...
		// Melon45 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon45 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon45/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon45$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon45
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon45 proxy object. All configs
