...
Kiwi_544: {
	...
	config: [
		...
		// Kiwi_544 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_544 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_544/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_544$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_544
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_544 proxy object. All configs
