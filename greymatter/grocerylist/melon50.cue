...
Melon50: {
	...
	config: [
		...
		// Melon50 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon50 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon50/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon50$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon50
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon50 proxy object. All configs
