...
Melon12: {
	...
	config: [
		...
		// Melon12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon12
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon12 proxy object. All configs
