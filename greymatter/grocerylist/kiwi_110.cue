...
Kiwi_110: {
	...
	config: [
		...
		// Kiwi_110 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_110 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_110/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_110$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_110
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_110 proxy object. All configs
