...
Tangerine47: {
	...
	config: [
		...
		// Tangerine47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine47
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine47 proxy object. All configs
