...
Grape_79: {
	...
	config: [
		...
		// Grape_79 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_79 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-79/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-79$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-79
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-79 proxy object. All configs
