...
Kiwi_169: {
	...
	config: [
		...
		// Kiwi_169 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_169 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_169/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_169$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_169
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_169 proxy object. All configs
