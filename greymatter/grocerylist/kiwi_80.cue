...
Kiwi_80: {
	...
	config: [
		...
		// Kiwi_80 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_80 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_80/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_80$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_80
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_80 proxy object. All configs
