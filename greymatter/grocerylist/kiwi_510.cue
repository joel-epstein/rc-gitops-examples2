...
Kiwi_510: {
	...
	config: [
		...
		// Kiwi_510 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_510 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_510/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_510$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_510
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_510 proxy object. All configs
