...
Kiwi_916: {
	...
	config: [
		...
		// Kiwi_916 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_916 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_916/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_916$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_916
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_916 proxy object. All configs
