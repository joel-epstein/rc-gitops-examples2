...
Kiwi_458: {
	...
	config: [
		...
		// Kiwi_458 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_458 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_458/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_458$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_458
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_458 proxy object. All configs
