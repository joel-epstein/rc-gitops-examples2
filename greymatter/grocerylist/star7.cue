...
Star7: {
	...
	config: [
		...
		// Star7 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star7 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star7/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star7$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star7
		#catalog_entry & {
			name:                      Name
		...
		// Shared star7 proxy object. All configs
