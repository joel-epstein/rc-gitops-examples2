...
Kiwi_715: {
	...
	config: [
		...
		// Kiwi_715 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_715 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_715/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_715$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_715
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_715 proxy object. All configs
