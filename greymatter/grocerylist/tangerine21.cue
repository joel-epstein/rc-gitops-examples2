...
Tangerine21: {
	...
	config: [
		...
		// Tangerine21 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine21 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine21/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine21$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine21
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine21 proxy object. All configs
