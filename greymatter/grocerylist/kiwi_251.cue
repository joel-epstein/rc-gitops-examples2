...
Kiwi_251: {
	...
	config: [
		...
		// Kiwi_251 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_251 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_251/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_251$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_251
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_251 proxy object. All configs
