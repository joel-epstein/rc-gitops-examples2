...
Kiwi32: {
	...
	config: [
		...
		// Kiwi32 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi32/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi32$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi32
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi32 proxy object. All configs
