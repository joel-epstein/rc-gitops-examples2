...
Kiwi_662: {
	...
	config: [
		...
		// Kiwi_662 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_662 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_662/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_662$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_662
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_662 proxy object. All configs
