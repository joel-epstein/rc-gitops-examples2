...
Kiwi_362: {
	...
	config: [
		...
		// Kiwi_362 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_362 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_362/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_362$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_362
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_362 proxy object. All configs
