...
Kiwi4: {
	...
	config: [
		...
		// Kiwi4 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi4/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi4$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi4
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi4 proxy object. All configs
