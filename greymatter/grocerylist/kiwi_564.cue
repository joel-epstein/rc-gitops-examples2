...
Kiwi_564: {
	...
	config: [
		...
		// Kiwi_564 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_564 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_564/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_564$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_564
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_564 proxy object. All configs
