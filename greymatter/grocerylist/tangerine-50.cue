...
Tangerine_50: {
	...
	config: [
		...
		// Tangerine_50 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_50 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-50/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-50$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-50
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-50 proxy object. All configs
