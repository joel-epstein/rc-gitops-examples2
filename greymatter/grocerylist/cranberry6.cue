...
Cranberry6: {
	...
	config: [
		...
		// Cranberry6 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry6 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry6/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry6$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry6
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry6 proxy object. All configs
