...
Kiwi_735: {
	...
	config: [
		...
		// Kiwi_735 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_735 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_735/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_735$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_735
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_735 proxy object. All configs
