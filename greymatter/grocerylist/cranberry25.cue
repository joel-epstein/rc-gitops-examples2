...
Cranberry25: {
	...
	config: [
		...
		// Cranberry25 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry25 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry25/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry25$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry25
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry25 proxy object. All configs
