...
Kiwi_171: {
	...
	config: [
		...
		// Kiwi_171 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_171 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_171/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_171$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_171
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_171 proxy object. All configs
