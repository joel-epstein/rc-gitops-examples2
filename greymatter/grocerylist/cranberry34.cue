...
Cranberry34: {
	...
	config: [
		...
		// Cranberry34 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry34 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry34
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry34 proxy object. All configs
