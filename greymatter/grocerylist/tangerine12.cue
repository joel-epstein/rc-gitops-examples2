...
Tangerine12: {
	...
	config: [
		...
		// Tangerine12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine12
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine12 proxy object. All configs
