...
Grape_13: {
	...
	config: [
		...
		// Grape_13 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_13 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-13
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-13 proxy object. All configs
