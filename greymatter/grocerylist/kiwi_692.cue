...
Kiwi_692: {
	...
	config: [
		...
		// Kiwi_692 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_692 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_692/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_692$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_692
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_692 proxy object. All configs
