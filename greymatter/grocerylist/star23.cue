...
Star23: {
	...
	config: [
		...
		// Star23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star23
		#catalog_entry & {
			name:                      Name
		...
		// Shared star23 proxy object. All configs
