...
Melon_21: {
	...
	config: [
		...
		// Melon_21 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_21 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-21/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-21$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-21
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-21 proxy object. All configs
