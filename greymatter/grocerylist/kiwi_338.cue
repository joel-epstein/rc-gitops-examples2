...
Kiwi_338: {
	...
	config: [
		...
		// Kiwi_338 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_338 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_338/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_338$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_338
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_338 proxy object. All configs
