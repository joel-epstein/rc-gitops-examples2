...
Kiwi_287: {
	...
	config: [
		...
		// Kiwi_287 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_287 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_287/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_287$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_287
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_287 proxy object. All configs
