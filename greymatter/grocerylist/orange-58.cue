...
Orange_58: {
	...
	config: [
		...
		// Orange_58 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_58 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-58/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-58$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-58
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-58 proxy object. All configs
