...
Kiwi_972: {
	...
	config: [
		...
		// Kiwi_972 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_972 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_972/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_972$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_972
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_972 proxy object. All configs
