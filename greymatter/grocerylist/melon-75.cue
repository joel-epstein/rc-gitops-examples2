...
Melon_75: {
	...
	config: [
		...
		// Melon_75 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_75 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-75/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-75$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-75
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-75 proxy object. All configs
