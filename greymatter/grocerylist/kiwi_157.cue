...
Kiwi_157: {
	...
	config: [
		...
		// Kiwi_157 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_157 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_157/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_157$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_157
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_157 proxy object. All configs
