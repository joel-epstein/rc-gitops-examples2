...
Kiwi_294: {
	...
	config: [
		...
		// Kiwi_294 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_294 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_294/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_294$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_294
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_294 proxy object. All configs
