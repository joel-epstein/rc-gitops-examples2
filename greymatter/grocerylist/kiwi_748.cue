...
Kiwi_748: {
	...
	config: [
		...
		// Kiwi_748 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_748 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_748/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_748$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_748
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_748 proxy object. All configs
