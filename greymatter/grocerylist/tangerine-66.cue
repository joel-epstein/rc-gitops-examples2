...
Tangerine_66: {
	...
	config: [
		...
		// Tangerine_66 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_66 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-66/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-66$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-66
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-66 proxy object. All configs
