...
Melon_11: {
	...
	config: [
		...
		// Melon_11 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_11 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-11/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-11$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-11
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-11 proxy object. All configs
