...
Kiwi76: {
	...
	config: [
		...
		// Kiwi76 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi76 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi76/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi76$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi76
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi76 proxy object. All configs
