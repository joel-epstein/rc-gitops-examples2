...
Kiwi_457: {
	...
	config: [
		...
		// Kiwi_457 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_457 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_457/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_457$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_457
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_457 proxy object. All configs
