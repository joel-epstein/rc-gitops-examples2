...
Kiwi_631: {
	...
	config: [
		...
		// Kiwi_631 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_631 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_631/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_631$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_631
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_631 proxy object. All configs
