...
Star_58: {
	...
	config: [
		...
		// Star_58 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_58 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-58/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-58$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-58
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-58 proxy object. All configs
