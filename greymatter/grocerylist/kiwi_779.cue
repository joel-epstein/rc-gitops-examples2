...
Kiwi_779: {
	...
	config: [
		...
		// Kiwi_779 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_779 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_779/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_779$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_779
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_779 proxy object. All configs
