...
Blueberry_48: {
	...
	config: [
		...
		// Blueberry_48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-48
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-48 proxy object. All configs
