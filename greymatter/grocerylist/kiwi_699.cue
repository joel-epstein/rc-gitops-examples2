...
Kiwi_699: {
	...
	config: [
		...
		// Kiwi_699 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_699 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_699/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_699$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_699
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_699 proxy object. All configs
