...
Kiwi_756: {
	...
	config: [
		...
		// Kiwi_756 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_756 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_756/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_756$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_756
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_756 proxy object. All configs
