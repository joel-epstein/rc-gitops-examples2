...
Kiwi_810: {
	...
	config: [
		...
		// Kiwi_810 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_810 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_810/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_810$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_810
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_810 proxy object. All configs
