...
Kiwi_205: {
	...
	config: [
		...
		// Kiwi_205 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_205 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_205/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_205$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_205
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_205 proxy object. All configs
