...
Kiwi_191: {
	...
	config: [
		...
		// Kiwi_191 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_191 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_191/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_191$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_191
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_191 proxy object. All configs
