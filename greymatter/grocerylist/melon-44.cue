...
Melon_44: {
	...
	config: [
		...
		// Melon_44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-44
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-44 proxy object. All configs
