...
Blueberry_22: {
	...
	config: [
		...
		// Blueberry_22 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_22 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-22
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-22 proxy object. All configs
