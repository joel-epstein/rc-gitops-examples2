...
Cranberry46: {
	...
	config: [
		...
		// Cranberry46 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry46 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry46
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry46 proxy object. All configs
