...
Kiwi_446: {
	...
	config: [
		...
		// Kiwi_446 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_446 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_446/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_446$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_446
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_446 proxy object. All configs
