...
Kiwi_30: {
	...
	config: [
		...
		// Kiwi_30 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_30 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_30/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_30$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_30
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_30 proxy object. All configs
