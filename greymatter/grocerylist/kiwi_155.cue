...
Kiwi_155: {
	...
	config: [
		...
		// Kiwi_155 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_155 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_155/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_155$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_155
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_155 proxy object. All configs
