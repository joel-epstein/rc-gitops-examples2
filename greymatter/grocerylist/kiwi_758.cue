...
Kiwi_758: {
	...
	config: [
		...
		// Kiwi_758 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_758 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_758/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_758$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_758
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_758 proxy object. All configs
