...
Tangerine_51: {
	...
	config: [
		...
		// Tangerine_51 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_51 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-51/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-51$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-51
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-51 proxy object. All configs
