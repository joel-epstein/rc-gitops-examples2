...
Blueberry38: {
	...
	config: [
		...
		// Blueberry38 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry38 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry38
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry38 proxy object. All configs
