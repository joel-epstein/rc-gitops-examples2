...
Kiwi_882: {
	...
	config: [
		...
		// Kiwi_882 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_882 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_882/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_882$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_882
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_882 proxy object. All configs
