...
Kiwi_822: {
	...
	config: [
		...
		// Kiwi_822 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_822 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_822/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_822$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_822
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_822 proxy object. All configs
