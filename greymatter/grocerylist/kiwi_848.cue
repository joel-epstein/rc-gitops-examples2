...
Kiwi_848: {
	...
	config: [
		...
		// Kiwi_848 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_848 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_848/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_848$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_848
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_848 proxy object. All configs
