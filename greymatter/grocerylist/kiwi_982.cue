...
Kiwi_982: {
	...
	config: [
		...
		// Kiwi_982 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_982 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_982/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_982$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_982
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_982 proxy object. All configs
