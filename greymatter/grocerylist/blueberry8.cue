...
Blueberry8: {
	...
	config: [
		...
		// Blueberry8 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry8 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry8/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry8$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry8
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry8 proxy object. All configs
