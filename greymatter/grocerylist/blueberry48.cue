...
Blueberry48: {
	...
	config: [
		...
		// Blueberry48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry48
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry48 proxy object. All configs
