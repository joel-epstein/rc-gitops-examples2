...
Kiwi_775: {
	...
	config: [
		...
		// Kiwi_775 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_775 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_775/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_775$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_775
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_775 proxy object. All configs
