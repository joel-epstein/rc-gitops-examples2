...
Kiwi_659: {
	...
	config: [
		...
		// Kiwi_659 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_659 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_659/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_659$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_659
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_659 proxy object. All configs
