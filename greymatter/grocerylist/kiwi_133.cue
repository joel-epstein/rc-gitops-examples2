...
Kiwi_133: {
	...
	config: [
		...
		// Kiwi_133 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_133 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_133/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_133$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_133
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_133 proxy object. All configs
