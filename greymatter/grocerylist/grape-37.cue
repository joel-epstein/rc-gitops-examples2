...
Grape_37: {
	...
	config: [
		...
		// Grape_37 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_37 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-37/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-37$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-37
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-37 proxy object. All configs
