...
Kiwi_547: {
	...
	config: [
		...
		// Kiwi_547 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_547 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_547/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_547$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_547
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_547 proxy object. All configs
