...
Kiwi_973: {
	...
	config: [
		...
		// Kiwi_973 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_973 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_973/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_973$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_973
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_973 proxy object. All configs
