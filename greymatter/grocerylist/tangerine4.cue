...
Tangerine4: {
	...
	config: [
		...
		// Tangerine4 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine4 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine4/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine4$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine4
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine4 proxy object. All configs
