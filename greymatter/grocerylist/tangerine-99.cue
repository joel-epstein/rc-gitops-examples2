...
Tangerine_99: {
	...
	config: [
		...
		// Tangerine_99 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_99 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-99/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-99$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-99
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-99 proxy object. All configs
