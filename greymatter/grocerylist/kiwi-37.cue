...
Kiwi_37: {
	...
	config: [
		...
		// Kiwi_37 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_37 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-37/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-37$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-37
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-37 proxy object. All configs
