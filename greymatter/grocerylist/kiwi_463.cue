...
Kiwi_463: {
	...
	config: [
		...
		// Kiwi_463 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_463 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_463/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_463$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_463
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_463 proxy object. All configs
