...
Blueberry_86: {
	...
	config: [
		...
		// Blueberry_86 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_86 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-86/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-86$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-86
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-86 proxy object. All configs
