...
Kiwi_479: {
	...
	config: [
		...
		// Kiwi_479 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_479 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_479/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_479$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_479
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_479 proxy object. All configs
