...
Kiwi_233: {
	...
	config: [
		...
		// Kiwi_233 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_233 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_233/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_233$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_233
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_233 proxy object. All configs
