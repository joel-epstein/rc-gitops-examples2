...
Grape_33: {
	...
	config: [
		...
		// Grape_33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-33
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-33 proxy object. All configs
