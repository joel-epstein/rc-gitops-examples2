...
Kiwi_39: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_39
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_39 proxy object. All configs
