...
Star38: {
	...
	config: [
		...
		// Star38 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star38 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star38
		#catalog_entry & {
			name:                      Name
		...
		// Shared star38 proxy object. All configs
