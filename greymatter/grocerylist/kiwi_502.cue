...
Kiwi_502: {
	...
	config: [
		...
		// Kiwi_502 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_502 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_502/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_502$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_502
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_502 proxy object. All configs
