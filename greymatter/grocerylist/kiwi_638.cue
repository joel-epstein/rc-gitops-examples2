...
Kiwi_638: {
	...
	config: [
		...
		// Kiwi_638 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_638 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_638/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_638$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_638
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_638 proxy object. All configs
