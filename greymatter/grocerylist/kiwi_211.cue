...
Kiwi_211: {
	...
	config: [
		...
		// Kiwi_211 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_211 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_211/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_211$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_211
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_211 proxy object. All configs
