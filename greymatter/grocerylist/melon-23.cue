...
Melon_23: {
	...
	config: [
		...
		// Melon_23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-23
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-23 proxy object. All configs
