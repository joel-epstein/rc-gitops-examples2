...
Kiwi_241: {
	...
	config: [
		...
		// Kiwi_241 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_241 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_241/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_241$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_241
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_241 proxy object. All configs
