...
Melon26: {
	...
	config: [
		...
		// Melon26 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon26 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon26/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon26$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon26
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon26 proxy object. All configs
