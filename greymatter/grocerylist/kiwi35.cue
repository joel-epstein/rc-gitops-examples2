...
Kiwi35: {
	...
	config: [
		...
		// Kiwi35 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi35/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi35$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi35
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi35 proxy object. All configs
