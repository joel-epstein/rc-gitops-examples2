...
Blueberry_93: {
	...
	config: [
		...
		// Blueberry_93 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_93 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-93/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-93$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-93
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-93 proxy object. All configs
