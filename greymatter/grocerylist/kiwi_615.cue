...
Kiwi_615: {
	...
	config: [
		...
		// Kiwi_615 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_615 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_615/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_615$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_615
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_615 proxy object. All configs
