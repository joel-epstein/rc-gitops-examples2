...
Kiwi_837: {
	...
	config: [
		...
		// Kiwi_837 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_837 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_837/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_837$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_837
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_837 proxy object. All configs
