...
Kiwi_522: {
	...
	config: [
		...
		// Kiwi_522 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_522 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_522/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_522$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_522
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_522 proxy object. All configs
