...
Blueberry31: {
	...
	config: [
		...
		// Blueberry31 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry31 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry31/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry31$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry31
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry31 proxy object. All configs
