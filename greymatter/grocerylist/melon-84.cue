...
Melon_84: {
	...
	config: [
		...
		// Melon_84 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_84 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-84/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-84$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-84
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-84 proxy object. All configs
