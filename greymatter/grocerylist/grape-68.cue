...
Grape_68: {
	...
	config: [
		...
		// Grape_68 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_68 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-68/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-68$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-68
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-68 proxy object. All configs
