...
Kiwi_858: {
	...
	config: [
		...
		// Kiwi_858 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_858 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_858/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_858$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_858
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_858 proxy object. All configs
