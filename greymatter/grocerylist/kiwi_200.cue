...
Kiwi_200: {
	...
	config: [
		...
		// Kiwi_200 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_200 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_200/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_200$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_200
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_200 proxy object. All configs
