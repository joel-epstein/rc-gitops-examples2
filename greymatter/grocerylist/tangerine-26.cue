...
Tangerine_26: {
	...
	config: [
		...
		// Tangerine_26 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_26 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-26/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-26$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-26
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-26 proxy object. All configs
