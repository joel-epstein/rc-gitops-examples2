...
Orange_20: {
	...
	config: [
		...
		// Orange_20 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_20 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-20/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-20$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-20
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-20 proxy object. All configs
