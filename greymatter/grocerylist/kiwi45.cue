...
Kiwi45: {
	...
	config: [
		...
		// Kiwi45 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi45/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi45$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi45
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi45 proxy object. All configs
