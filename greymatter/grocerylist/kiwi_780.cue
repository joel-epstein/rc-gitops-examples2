...
Kiwi_780: {
	...
	config: [
		...
		// Kiwi_780 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_780 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_780/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_780$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_780
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_780 proxy object. All configs
