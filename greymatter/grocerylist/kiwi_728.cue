...
Kiwi_728: {
	...
	config: [
		...
		// Kiwi_728 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_728 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_728/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_728$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_728
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_728 proxy object. All configs
