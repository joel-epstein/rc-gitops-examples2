...
Kiwi_219: {
	...
	config: [
		...
		// Kiwi_219 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_219 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_219/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_219$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_219
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_219 proxy object. All configs
