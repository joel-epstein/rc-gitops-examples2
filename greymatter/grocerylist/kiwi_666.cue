...
Kiwi_666: {
	...
	config: [
		...
		// Kiwi_666 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_666 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_666/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_666$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_666
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_666 proxy object. All configs
