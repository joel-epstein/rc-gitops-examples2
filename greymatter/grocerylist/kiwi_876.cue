...
Kiwi_876: {
	...
	config: [
		...
		// Kiwi_876 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_876 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_876/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_876$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_876
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_876 proxy object. All configs
