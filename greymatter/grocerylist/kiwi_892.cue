...
Kiwi_892: {
	...
	config: [
		...
		// Kiwi_892 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_892 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_892/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_892$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_892
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_892 proxy object. All configs
