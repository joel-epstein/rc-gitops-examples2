...
Kiwi_921: {
	...
	config: [
		...
		// Kiwi_921 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_921 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_921/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_921$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_921
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_921 proxy object. All configs
