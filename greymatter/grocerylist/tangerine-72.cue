...
Tangerine_72: {
	...
	config: [
		...
		// Tangerine_72 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_72 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-72/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-72$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-72
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-72 proxy object. All configs
