...
Melon11: {
	...
	config: [
		...
		// Melon11 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon11 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon11/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon11$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon11
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon11 proxy object. All configs
