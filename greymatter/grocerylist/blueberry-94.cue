...
Blueberry_94: {
	...
	config: [
		...
		// Blueberry_94 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_94 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-94/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-94$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-94
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-94 proxy object. All configs
