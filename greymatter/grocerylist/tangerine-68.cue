...
Tangerine_68: {
	...
	config: [
		...
		// Tangerine_68 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_68 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-68/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-68$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-68
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-68 proxy object. All configs
