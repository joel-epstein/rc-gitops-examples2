...
Kiwi_831: {
	...
	config: [
		...
		// Kiwi_831 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_831 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_831/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_831$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_831
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_831 proxy object. All configs
