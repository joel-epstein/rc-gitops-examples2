...
Kiwi_270: {
	...
	config: [
		...
		// Kiwi_270 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_270 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_270/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_270$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_270
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_270 proxy object. All configs
