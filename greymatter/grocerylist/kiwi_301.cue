...
Kiwi_301: {
	...
	config: [
		...
		// Kiwi_301 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_301 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_301/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_301$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_301
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_301 proxy object. All configs
