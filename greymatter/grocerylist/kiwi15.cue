...
Kiwi15: {
	...
	config: [
		...
		// Kiwi15 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi15 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi15/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi15$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi15
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi15 proxy object. All configs
