...
Blueberry37: {
	...
	config: [
		...
		// Blueberry37 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry37 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry37/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry37$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry37
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry37 proxy object. All configs
