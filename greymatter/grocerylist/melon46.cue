...
Melon46: {
	...
	config: [
		...
		// Melon46 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon46 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon46
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon46 proxy object. All configs
