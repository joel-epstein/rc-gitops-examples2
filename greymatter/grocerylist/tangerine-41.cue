...
Tangerine_41: {
	...
	config: [
		...
		// Tangerine_41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-41
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-41 proxy object. All configs
