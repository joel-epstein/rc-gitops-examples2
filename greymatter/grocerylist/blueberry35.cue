...
Blueberry35: {
	...
	config: [
		...
		// Blueberry35 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry35 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry35/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry35$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry35
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry35 proxy object. All configs
