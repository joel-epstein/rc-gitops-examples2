...
Kiwi_674: {
	...
	config: [
		...
		// Kiwi_674 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_674 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_674/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_674$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_674
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_674 proxy object. All configs
