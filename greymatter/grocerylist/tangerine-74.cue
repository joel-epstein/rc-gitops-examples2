...
Tangerine_74: {
	...
	config: [
		...
		// Tangerine_74 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_74 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-74/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-74$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-74
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-74 proxy object. All configs
