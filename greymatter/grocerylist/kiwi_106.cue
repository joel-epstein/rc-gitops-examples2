...
Kiwi_106: {
	...
	config: [
		...
		// Kiwi_106 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_106 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_106/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_106$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_106
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_106 proxy object. All configs
