...
Tangerine_39: {
	...
	config: [
		...
		// Tangerine_39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-39
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-39 proxy object. All configs
