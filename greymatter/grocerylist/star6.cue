...
Star6: {
	...
	config: [
		...
		// Star6 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star6 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star6/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star6$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star6
		#catalog_entry & {
			name:                      Name
		...
		// Shared star6 proxy object. All configs
