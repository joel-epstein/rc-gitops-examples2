...
Orange_65: {
	...
	config: [
		...
		// Orange_65 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_65 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-65/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-65$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-65
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-65 proxy object. All configs
