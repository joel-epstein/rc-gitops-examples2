...
Kiwi_946: {
	...
	config: [
		...
		// Kiwi_946 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_946 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_946/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_946$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_946
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_946 proxy object. All configs
