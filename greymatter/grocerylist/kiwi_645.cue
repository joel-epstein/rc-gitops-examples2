...
Kiwi_645: {
	...
	config: [
		...
		// Kiwi_645 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_645 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_645/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_645$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_645
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_645 proxy object. All configs
