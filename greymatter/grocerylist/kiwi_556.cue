...
Kiwi_556: {
	...
	config: [
		...
		// Kiwi_556 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_556 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_556/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_556$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_556
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_556 proxy object. All configs
