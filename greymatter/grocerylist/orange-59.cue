...
Orange_59: {
	...
	config: [
		...
		// Orange_59 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_59 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-59/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-59$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-59
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-59 proxy object. All configs
