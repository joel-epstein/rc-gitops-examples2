...
Kiwi_723: {
	...
	config: [
		...
		// Kiwi_723 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_723 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_723/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_723$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_723
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_723 proxy object. All configs
