...
Kiwi_346: {
	...
	config: [
		...
		// Kiwi_346 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_346 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_346/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_346$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_346
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_346 proxy object. All configs
