...
Kiwi_750: {
	...
	config: [
		...
		// Kiwi_750 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_750 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_750/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_750$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_750
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_750 proxy object. All configs
