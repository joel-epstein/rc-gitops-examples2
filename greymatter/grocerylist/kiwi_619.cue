...
Kiwi_619: {
	...
	config: [
		...
		// Kiwi_619 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_619 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_619/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_619$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_619
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_619 proxy object. All configs
