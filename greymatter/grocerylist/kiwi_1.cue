...
Kiwi_1: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_1/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_1$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_1
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_1 proxy object. All configs
