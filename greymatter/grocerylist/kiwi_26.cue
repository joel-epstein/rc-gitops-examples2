...
Kiwi_26: {
	...
	config: [
		...
		// Kiwi_26 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_26 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_26/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_26$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_26
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_26 proxy object. All configs
