...
Kiwi_825: {
	...
	config: [
		...
		// Kiwi_825 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_825 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_825/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_825$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_825
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_825 proxy object. All configs
