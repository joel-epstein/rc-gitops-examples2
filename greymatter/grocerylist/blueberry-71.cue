...
Blueberry_71: {
	...
	config: [
		...
		// Blueberry_71 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_71 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-71/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-71$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-71
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-71 proxy object. All configs
