...
Kiwi_992: {
	...
	config: [
		...
		// Kiwi_992 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_992 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_992/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_992$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_992
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_992 proxy object. All configs
