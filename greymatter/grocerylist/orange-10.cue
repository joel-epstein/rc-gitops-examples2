...
Orange_10: {
	...
	config: [
		...
		// Orange_10 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_10 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-10/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-10$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-10
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-10 proxy object. All configs
