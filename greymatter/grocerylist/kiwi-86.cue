...
Kiwi_86: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-86/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-86$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-86
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-86 proxy object. All configs
