...
Kiwi_198: {
	...
	config: [
		...
		// Kiwi_198 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_198 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_198/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_198$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_198
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_198 proxy object. All configs
