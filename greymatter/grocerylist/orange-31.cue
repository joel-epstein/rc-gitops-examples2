...
Orange_31: {
	...
	config: [
		...
		// Orange_31 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_31 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-31/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-31$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-31
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-31 proxy object. All configs
