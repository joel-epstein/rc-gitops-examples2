...
Kiwi_811: {
	...
	config: [
		...
		// Kiwi_811 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_811 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_811/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_811$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_811
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_811 proxy object. All configs
