...
Tangerine_20: {
	...
	config: [
		...
		// Tangerine_20 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_20 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-20/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-20$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-20
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-20 proxy object. All configs
