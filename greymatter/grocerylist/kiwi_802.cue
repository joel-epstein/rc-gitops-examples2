...
Kiwi_802: {
	...
	config: [
		...
		// Kiwi_802 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_802 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_802/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_802$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_802
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_802 proxy object. All configs
