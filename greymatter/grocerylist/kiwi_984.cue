...
Kiwi_984: {
	...
	config: [
		...
		// Kiwi_984 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_984 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_984/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_984$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_984
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_984 proxy object. All configs
