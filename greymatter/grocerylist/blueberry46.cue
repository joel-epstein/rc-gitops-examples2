...
Blueberry46: {
	...
	config: [
		...
		// Blueberry46 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry46 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry46
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry46 proxy object. All configs
