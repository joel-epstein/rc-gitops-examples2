...
Kiwi_63: {
	...
	config: [
		...
		// Kiwi_63 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_63 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_63/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_63$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_63
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_63 proxy object. All configs
