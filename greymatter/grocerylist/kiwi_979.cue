...
Kiwi_979: {
	...
	config: [
		...
		// Kiwi_979 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_979 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_979/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_979$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_979
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_979 proxy object. All configs
