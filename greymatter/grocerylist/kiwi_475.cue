...
Kiwi_475: {
	...
	config: [
		...
		// Kiwi_475 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_475 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_475/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_475$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_475
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_475 proxy object. All configs
