...
Star35: {
	...
	config: [
		...
		// Star35 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star35 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star35/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star35$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star35
		#catalog_entry & {
			name:                      Name
		...
		// Shared star35 proxy object. All configs
