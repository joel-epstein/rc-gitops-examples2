...
Kiwi_402: {
	...
	config: [
		...
		// Kiwi_402 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_402 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_402/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_402$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_402
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_402 proxy object. All configs
