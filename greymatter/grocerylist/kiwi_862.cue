...
Kiwi_862: {
	...
	config: [
		...
		// Kiwi_862 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_862 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_862/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_862$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_862
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_862 proxy object. All configs
