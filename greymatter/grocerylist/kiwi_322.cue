...
Kiwi_322: {
	...
	config: [
		...
		// Kiwi_322 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_322 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_322/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_322$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_322
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_322 proxy object. All configs
