...
Kiwi_397: {
	...
	config: [
		...
		// Kiwi_397 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_397 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_397/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_397$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_397
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_397 proxy object. All configs
