...
Kiwi_372: {
	...
	config: [
		...
		// Kiwi_372 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_372 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_372/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_372$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_372
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_372 proxy object. All configs
