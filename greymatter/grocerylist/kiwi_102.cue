...
Kiwi_102: {
	...
	config: [
		...
		// Kiwi_102 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_102 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_102/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_102$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_102
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_102 proxy object. All configs
