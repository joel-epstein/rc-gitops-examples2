...
Kiwi_336: {
	...
	config: [
		...
		// Kiwi_336 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_336 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_336/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_336$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_336
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_336 proxy object. All configs
