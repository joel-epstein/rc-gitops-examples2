...
Kiwi_298: {
	...
	config: [
		...
		// Kiwi_298 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_298 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_298/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_298$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_298
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_298 proxy object. All configs
