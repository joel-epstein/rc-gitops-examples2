...
Kiwi_112: {
	...
	config: [
		...
		// Kiwi_112 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_112 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_112/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_112$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_112
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_112 proxy object. All configs
