...
Kiwi_320: {
	...
	config: [
		...
		// Kiwi_320 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_320 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_320/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_320$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_320
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_320 proxy object. All configs
