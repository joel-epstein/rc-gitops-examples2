...
Kiwi_396: {
	...
	config: [
		...
		// Kiwi_396 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_396 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_396/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_396$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_396
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_396 proxy object. All configs
