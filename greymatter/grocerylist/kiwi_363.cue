...
Kiwi_363: {
	...
	config: [
		...
		// Kiwi_363 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_363 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_363/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_363$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_363
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_363 proxy object. All configs
