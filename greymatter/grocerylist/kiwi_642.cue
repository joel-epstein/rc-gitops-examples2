...
Kiwi_642: {
	...
	config: [
		...
		// Kiwi_642 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_642 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_642/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_642$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_642
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_642 proxy object. All configs
