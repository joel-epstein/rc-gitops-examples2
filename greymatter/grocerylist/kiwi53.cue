...
Kiwi53: {
	...
	config: [
		...
		// Kiwi53 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi53/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi53$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi53
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi53 proxy object. All configs
