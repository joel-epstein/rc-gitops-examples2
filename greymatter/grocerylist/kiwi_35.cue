...
Kiwi_35: {
	...
	config: [
		...
		// Kiwi_35 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_35 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_35/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_35$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_35
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_35 proxy object. All configs
