...
Melon_99: {
	...
	config: [
		...
		// Melon_99 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_99 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-99/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-99$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-99
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-99 proxy object. All configs
