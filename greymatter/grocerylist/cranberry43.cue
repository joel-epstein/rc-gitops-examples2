...
Cranberry43: {
	...
	config: [
		...
		// Cranberry43 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry43 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry43/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry43$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry43
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry43 proxy object. All configs
