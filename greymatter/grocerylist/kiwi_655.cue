...
Kiwi_655: {
	...
	config: [
		...
		// Kiwi_655 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_655 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_655/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_655$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_655
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_655 proxy object. All configs
