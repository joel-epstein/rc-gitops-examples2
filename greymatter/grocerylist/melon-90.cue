...
Melon_90: {
	...
	config: [
		...
		// Melon_90 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_90 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-90/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-90$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-90
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-90 proxy object. All configs
