...
Kiwi_781: {
	...
	config: [
		...
		// Kiwi_781 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_781 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_781/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_781$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_781
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_781 proxy object. All configs
