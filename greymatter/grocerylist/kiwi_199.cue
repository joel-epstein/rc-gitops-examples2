...
Kiwi_199: {
	...
	config: [
		...
		// Kiwi_199 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_199 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_199/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_199$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_199
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_199 proxy object. All configs
