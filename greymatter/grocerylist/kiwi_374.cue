...
Kiwi_374: {
	...
	config: [
		...
		// Kiwi_374 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_374 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_374/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_374$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_374
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_374 proxy object. All configs
