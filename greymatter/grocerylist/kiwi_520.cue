...
Kiwi_520: {
	...
	config: [
		...
		// Kiwi_520 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_520 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_520/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_520$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_520
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_520 proxy object. All configs
