...
Kiwi_156: {
	...
	config: [
		...
		// Kiwi_156 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_156 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_156/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_156$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_156
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_156 proxy object. All configs
