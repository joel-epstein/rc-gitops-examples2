...
Kiwi_377: {
	...
	config: [
		...
		// Kiwi_377 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_377 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_377/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_377$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_377
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_377 proxy object. All configs
