...
Kiwi_138: {
	...
	config: [
		...
		// Kiwi_138 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_138 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_138/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_138$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_138
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_138 proxy object. All configs
