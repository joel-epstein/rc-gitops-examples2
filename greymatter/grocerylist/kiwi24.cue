...
Kiwi24: {
	...
	config: [
		...
		// Kiwi24 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi24/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi24$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi24
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi24 proxy object. All configs
