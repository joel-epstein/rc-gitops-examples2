...
Melon_12: {
	...
	config: [
		...
		// Melon_12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-12
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-12 proxy object. All configs
