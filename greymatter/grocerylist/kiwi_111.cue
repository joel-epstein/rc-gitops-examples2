...
Kiwi_111: {
	...
	config: [
		...
		// Kiwi_111 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_111 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_111/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_111$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_111
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_111 proxy object. All configs
