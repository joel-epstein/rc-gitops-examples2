...
Grape_93: {
	...
	config: [
		...
		// Grape_93 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_93 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-93/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-93$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-93
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-93 proxy object. All configs
