...
Kiwi_267: {
	...
	config: [
		...
		// Kiwi_267 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_267 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_267/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_267$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_267
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_267 proxy object. All configs
