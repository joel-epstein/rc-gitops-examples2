...
Kiwi_911: {
	...
	config: [
		...
		// Kiwi_911 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_911 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_911/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_911$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_911
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_911 proxy object. All configs
