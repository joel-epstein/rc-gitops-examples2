...
Kiwi_997: {
	...
	config: [
		...
		// Kiwi_997 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_997 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_997/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_997$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_997
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_997 proxy object. All configs
