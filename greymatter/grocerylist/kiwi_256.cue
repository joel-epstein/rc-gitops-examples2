...
Kiwi_256: {
	...
	config: [
		...
		// Kiwi_256 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_256 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_256/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_256$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_256
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_256 proxy object. All configs
