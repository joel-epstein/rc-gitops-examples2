...
Kiwi_132: {
	...
	config: [
		...
		// Kiwi_132 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_132 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_132/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_132$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_132
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_132 proxy object. All configs
