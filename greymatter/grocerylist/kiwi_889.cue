...
Kiwi_889: {
	...
	config: [
		...
		// Kiwi_889 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_889 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_889/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_889$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_889
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_889 proxy object. All configs
