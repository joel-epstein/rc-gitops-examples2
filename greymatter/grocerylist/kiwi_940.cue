...
Kiwi_940: {
	...
	config: [
		...
		// Kiwi_940 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_940 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_940/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_940$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_940
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_940 proxy object. All configs
