...
Kiwi82: {
	...
	config: [
		...
		// Kiwi82 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi82 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi82/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi82$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi82
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi82 proxy object. All configs
