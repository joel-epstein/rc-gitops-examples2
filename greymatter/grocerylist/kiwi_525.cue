...
Kiwi_525: {
	...
	config: [
		...
		// Kiwi_525 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_525 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_525/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_525$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_525
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_525 proxy object. All configs
