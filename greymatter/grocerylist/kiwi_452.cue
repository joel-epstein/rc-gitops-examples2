...
Kiwi_452: {
	...
	config: [
		...
		// Kiwi_452 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_452 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_452/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_452$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_452
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_452 proxy object. All configs
