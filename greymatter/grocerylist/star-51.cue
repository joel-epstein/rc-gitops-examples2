...
Star_51: {
	...
	config: [
		...
		// Star_51 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_51 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-51/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-51$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-51
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-51 proxy object. All configs
