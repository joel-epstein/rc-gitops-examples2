...
Kiwi_410: {
	...
	config: [
		...
		// Kiwi_410 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_410 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_410/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_410$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_410
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_410 proxy object. All configs
