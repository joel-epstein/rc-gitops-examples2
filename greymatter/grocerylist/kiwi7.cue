...
Kiwi7: {
	...
	config: [
		...
		// Kiwi7 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi7/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi7$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi7
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi7 proxy object. All configs
