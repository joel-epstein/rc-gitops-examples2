...
Kiwi_127: {
	...
	config: [
		...
		// Kiwi_127 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_127 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_127/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_127$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_127
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_127 proxy object. All configs
