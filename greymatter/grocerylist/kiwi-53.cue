...
Kiwi_53: {
	...
	config: [
		...
		// Kiwi_53 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_53 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-53/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-53$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-53
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-53 proxy object. All configs
