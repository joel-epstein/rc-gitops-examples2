...
Blueberry29: {
	...
	config: [
		...
		// Blueberry29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry29
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry29 proxy object. All configs
