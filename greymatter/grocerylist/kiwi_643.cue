...
Kiwi_643: {
	...
	config: [
		...
		// Kiwi_643 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_643 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_643/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_643$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_643
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_643 proxy object. All configs
