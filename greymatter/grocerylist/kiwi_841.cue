...
Kiwi_841: {
	...
	config: [
		...
		// Kiwi_841 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_841 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_841/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_841$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_841
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_841 proxy object. All configs
