...
Kiwi98: {
	...
	config: [
		...
		// Kiwi98 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi98 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi98/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi98$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi98
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi98 proxy object. All configs
