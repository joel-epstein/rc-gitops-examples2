...
Kiwi_565: {
	...
	config: [
		...
		// Kiwi_565 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_565 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_565/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_565$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_565
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_565 proxy object. All configs
