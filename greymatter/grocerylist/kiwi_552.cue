...
Kiwi_552: {
	...
	config: [
		...
		// Kiwi_552 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_552 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_552/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_552$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_552
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_552 proxy object. All configs
