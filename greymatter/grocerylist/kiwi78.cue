...
Kiwi78: {
	...
	config: [
		...
		// Kiwi78 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi78 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi78/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi78$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi78
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi78 proxy object. All configs
