...
Kiwi_595: {
	...
	config: [
		...
		// Kiwi_595 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_595 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_595/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_595$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_595
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_595 proxy object. All configs
