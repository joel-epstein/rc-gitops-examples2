...
Blueberry7: {
	...
	config: [
		...
		// Blueberry7 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry7 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry7/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry7$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry7
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry7 proxy object. All configs
