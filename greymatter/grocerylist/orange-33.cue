...
Orange_33: {
	...
	config: [
		...
		// Orange_33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-33
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-33 proxy object. All configs
