...
Orange_74: {
	...
	config: [
		...
		// Orange_74 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_74 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-74/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-74$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-74
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-74 proxy object. All configs
