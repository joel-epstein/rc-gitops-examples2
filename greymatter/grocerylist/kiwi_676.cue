...
Kiwi_676: {
	...
	config: [
		...
		// Kiwi_676 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_676 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_676/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_676$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_676
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_676 proxy object. All configs
