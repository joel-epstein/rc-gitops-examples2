...
Kiwi_828: {
	...
	config: [
		...
		// Kiwi_828 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_828 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_828/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_828$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_828
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_828 proxy object. All configs
