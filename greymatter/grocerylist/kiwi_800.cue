...
Kiwi_800: {
	...
	config: [
		...
		// Kiwi_800 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_800 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_800/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_800$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_800
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_800 proxy object. All configs
