...
Orange_40: {
	...
	config: [
		...
		// Orange_40 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_40 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-40/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-40$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-40
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-40 proxy object. All configs
