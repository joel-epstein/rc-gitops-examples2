...
Blueberry11: {
	...
	config: [
		...
		// Blueberry11 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry11 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry11/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry11$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry11
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry11 proxy object. All configs
