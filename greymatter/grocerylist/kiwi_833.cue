...
Kiwi_833: {
	...
	config: [
		...
		// Kiwi_833 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_833 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_833/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_833$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_833
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_833 proxy object. All configs
