...
Tangerine_91: {
	...
	config: [
		...
		// Tangerine_91 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_91 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-91/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-91$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-91
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-91 proxy object. All configs
