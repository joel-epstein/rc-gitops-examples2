...
Kiwi_969: {
	...
	config: [
		...
		// Kiwi_969 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_969 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_969/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_969$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_969
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_969 proxy object. All configs
