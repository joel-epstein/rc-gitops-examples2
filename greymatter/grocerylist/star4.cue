...
Star4: {
	...
	config: [
		...
		// Star4 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star4 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star4/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star4$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star4
		#catalog_entry & {
			name:                      Name
		...
		// Shared star4 proxy object. All configs
