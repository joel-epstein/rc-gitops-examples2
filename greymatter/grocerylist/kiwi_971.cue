...
Kiwi_971: {
	...
	config: [
		...
		// Kiwi_971 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_971 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_971/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_971$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_971
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_971 proxy object. All configs
