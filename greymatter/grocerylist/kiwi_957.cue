...
Kiwi_957: {
	...
	config: [
		...
		// Kiwi_957 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_957 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_957/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_957$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_957
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_957 proxy object. All configs
