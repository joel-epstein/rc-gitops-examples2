...
Orange_87: {
	...
	config: [
		...
		// Orange_87 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_87 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-87/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-87$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-87
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-87 proxy object. All configs
