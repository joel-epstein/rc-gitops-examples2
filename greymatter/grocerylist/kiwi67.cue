...
Kiwi67: {
	...
	config: [
		...
		// Kiwi67 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi67/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi67$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi67
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi67 proxy object. All configs
