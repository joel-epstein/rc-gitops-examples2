...
Grape_76: {
	...
	config: [
		...
		// Grape_76 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_76 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-76/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-76$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-76
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-76 proxy object. All configs
