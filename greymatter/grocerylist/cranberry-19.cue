...
Cranberry_19: {
	...
	config: [
		...
		// Cranberry_19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-19
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-19 proxy object. All configs
