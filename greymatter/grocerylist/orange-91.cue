...
Orange_91: {
	...
	config: [
		...
		// Orange_91 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_91 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-91/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-91$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-91
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-91 proxy object. All configs
