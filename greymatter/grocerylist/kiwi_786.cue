...
Kiwi_786: {
	...
	config: [
		...
		// Kiwi_786 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_786 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_786/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_786$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_786
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_786 proxy object. All configs
