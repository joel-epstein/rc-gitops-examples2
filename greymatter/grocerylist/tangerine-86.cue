...
Tangerine_86: {
	...
	config: [
		...
		// Tangerine_86 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_86 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-86/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-86$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-86
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-86 proxy object. All configs
