...
Kiwi_51: {
	...
	config: [
		...
		// Kiwi_51 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_51 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_51/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_51$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_51
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_51 proxy object. All configs
