...
Kiwi_392: {
	...
	config: [
		...
		// Kiwi_392 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_392 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_392/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_392$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_392
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_392 proxy object. All configs
