...
Blueberry_19: {
	...
	config: [
		...
		// Blueberry_19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-19
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-19 proxy object. All configs
