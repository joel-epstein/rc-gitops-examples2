...
Kiwi_532: {
	...
	config: [
		...
		// Kiwi_532 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_532 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_532/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_532$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_532
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_532 proxy object. All configs
