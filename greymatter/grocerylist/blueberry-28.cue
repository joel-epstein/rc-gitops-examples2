...
Blueberry_28: {
	...
	config: [
		...
		// Blueberry_28 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_28 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-28
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-28 proxy object. All configs
