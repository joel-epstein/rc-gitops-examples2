...
Grape_52: {
	...
	config: [
		...
		// Grape_52 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_52 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-52/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-52$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-52
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-52 proxy object. All configs
