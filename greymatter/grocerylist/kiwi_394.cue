...
Kiwi_394: {
	...
	config: [
		...
		// Kiwi_394 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_394 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_394/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_394$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_394
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_394 proxy object. All configs
