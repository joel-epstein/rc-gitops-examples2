...
Tangerine37: {
	...
	config: [
		...
		// Tangerine37 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine37 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine37/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine37$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine37
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine37 proxy object. All configs
