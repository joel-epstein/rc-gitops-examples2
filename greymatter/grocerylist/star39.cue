...
Star39: {
	...
	config: [
		...
		// Star39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star39
		#catalog_entry & {
			name:                      Name
		...
		// Shared star39 proxy object. All configs
