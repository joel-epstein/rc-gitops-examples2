...
Orange_73: {
	...
	config: [
		...
		// Orange_73 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_73 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-73/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-73$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-73
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-73 proxy object. All configs
