...
Kiwi_914: {
	...
	config: [
		...
		// Kiwi_914 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_914 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_914/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_914$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_914
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_914 proxy object. All configs
