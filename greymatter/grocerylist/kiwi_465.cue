...
Kiwi_465: {
	...
	config: [
		...
		// Kiwi_465 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_465 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_465/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_465$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_465
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_465 proxy object. All configs
