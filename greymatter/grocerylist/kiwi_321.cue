...
Kiwi_321: {
	...
	config: [
		...
		// Kiwi_321 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_321 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_321/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_321$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_321
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_321 proxy object. All configs
