...
Kiwi_235: {
	...
	config: [
		...
		// Kiwi_235 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_235 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_235/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_235$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_235
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_235 proxy object. All configs
