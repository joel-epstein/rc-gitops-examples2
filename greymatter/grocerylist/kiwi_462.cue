...
Kiwi_462: {
	...
	config: [
		...
		// Kiwi_462 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_462 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_462/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_462$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_462
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_462 proxy object. All configs
