...
Melon4: {
	...
	config: [
		...
		// Melon4 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon4 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon4/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon4$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon4
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon4 proxy object. All configs
