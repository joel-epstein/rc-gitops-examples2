...
Tangerine_81: {
	...
	config: [
		...
		// Tangerine_81 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_81 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-81/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-81$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-81
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-81 proxy object. All configs
