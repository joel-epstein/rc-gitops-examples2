...
Blueberry_97: {
	...
	config: [
		...
		// Blueberry_97 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_97 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-97/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-97$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-97
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-97 proxy object. All configs
