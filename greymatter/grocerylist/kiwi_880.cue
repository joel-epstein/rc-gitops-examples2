...
Kiwi_880: {
	...
	config: [
		...
		// Kiwi_880 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_880 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_880/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_880$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_880
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_880 proxy object. All configs
