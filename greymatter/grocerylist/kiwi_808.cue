...
Kiwi_808: {
	...
	config: [
		...
		// Kiwi_808 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_808 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_808/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_808$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_808
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_808 proxy object. All configs
