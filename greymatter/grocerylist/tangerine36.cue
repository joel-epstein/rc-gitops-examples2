...
Tangerine36: {
	...
	config: [
		...
		// Tangerine36 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine36 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine36
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine36 proxy object. All configs
