...
Blueberry_70: {
	...
	config: [
		...
		// Blueberry_70 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_70 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-70/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-70$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-70
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-70 proxy object. All configs
