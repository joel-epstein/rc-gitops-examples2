...
Kiwi_706: {
	...
	config: [
		...
		// Kiwi_706 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_706 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_706/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_706$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_706
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_706 proxy object. All configs
