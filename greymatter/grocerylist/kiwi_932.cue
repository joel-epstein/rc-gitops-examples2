...
Kiwi_932: {
	...
	config: [
		...
		// Kiwi_932 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_932 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_932/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_932$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_932
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_932 proxy object. All configs
