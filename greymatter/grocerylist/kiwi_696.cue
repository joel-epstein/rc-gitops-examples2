...
Kiwi_696: {
	...
	config: [
		...
		// Kiwi_696 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_696 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_696/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_696$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_696
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_696 proxy object. All configs
