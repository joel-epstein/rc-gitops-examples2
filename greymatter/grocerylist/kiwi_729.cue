...
Kiwi_729: {
	...
	config: [
		...
		// Kiwi_729 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_729 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_729/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_729$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_729
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_729 proxy object. All configs
