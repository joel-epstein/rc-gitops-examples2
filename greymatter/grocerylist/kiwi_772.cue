...
Kiwi_772: {
	...
	config: [
		...
		// Kiwi_772 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_772 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_772/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_772$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_772
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_772 proxy object. All configs
