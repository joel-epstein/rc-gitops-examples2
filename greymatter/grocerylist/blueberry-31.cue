...
Blueberry_31: {
	...
	config: [
		...
		// Blueberry_31 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_31 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-31/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-31$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-31
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-31 proxy object. All configs
