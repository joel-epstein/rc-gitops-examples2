...
Kiwi_698: {
	...
	config: [
		...
		// Kiwi_698 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_698 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_698/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_698$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_698
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_698 proxy object. All configs
