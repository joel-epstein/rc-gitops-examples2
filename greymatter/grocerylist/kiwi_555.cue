...
Kiwi_555: {
	...
	config: [
		...
		// Kiwi_555 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_555 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_555/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_555$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_555
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_555 proxy object. All configs
