...
Kiwi_575: {
	...
	config: [
		...
		// Kiwi_575 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_575 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_575/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_575$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_575
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_575 proxy object. All configs
