...
Kiwi_74: {
	...
	config: [
		...
		// Kiwi_74 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_74 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_74/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_74$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_74
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_74 proxy object. All configs
