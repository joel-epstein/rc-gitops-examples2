...
Kiwi52: {
	...
	config: [
		...
		// Kiwi52 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi52/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi52$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi52
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi52 proxy object. All configs
