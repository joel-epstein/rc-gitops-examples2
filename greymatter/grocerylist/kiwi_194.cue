...
Kiwi_194: {
	...
	config: [
		...
		// Kiwi_194 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_194 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_194/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_194$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_194
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_194 proxy object. All configs
