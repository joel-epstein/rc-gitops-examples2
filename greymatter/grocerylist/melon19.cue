...
Melon19: {
	...
	config: [
		...
		// Melon19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon19
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon19 proxy object. All configs
