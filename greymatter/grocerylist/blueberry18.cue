...
Blueberry18: {
	...
	config: [
		...
		// Blueberry18 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry18 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry18/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry18$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry18
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry18 proxy object. All configs
