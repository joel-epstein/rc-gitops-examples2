...
Star2: {
	...
	config: [
		...
		// Star2 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star2 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star2/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star2$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star2
		#catalog_entry & {
			name:                      Name
		...
		// Shared star2 proxy object. All configs
