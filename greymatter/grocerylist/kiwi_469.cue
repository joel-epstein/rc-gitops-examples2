...
Kiwi_469: {
	...
	config: [
		...
		// Kiwi_469 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_469 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_469/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_469$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_469
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_469 proxy object. All configs
