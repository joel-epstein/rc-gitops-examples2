...
Blueberry20: {
	...
	config: [
		...
		// Blueberry20 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry20 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry20/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry20$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry20
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry20 proxy object. All configs
