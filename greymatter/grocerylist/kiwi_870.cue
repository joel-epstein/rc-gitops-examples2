...
Kiwi_870: {
	...
	config: [
		...
		// Kiwi_870 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_870 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_870/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_870$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_870
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_870 proxy object. All configs
