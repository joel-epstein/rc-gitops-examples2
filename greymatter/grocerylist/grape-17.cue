...
Grape_17: {
	...
	config: [
		...
		// Grape_17 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_17 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-17
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-17 proxy object. All configs
