...
Tangerine_36: {
	...
	config: [
		...
		// Tangerine_36 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_36 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-36
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-36 proxy object. All configs
