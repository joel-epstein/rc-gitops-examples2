...
Kiwi17: {
	...
	config: [
		...
		// Kiwi17 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi17
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi17 proxy object. All configs
