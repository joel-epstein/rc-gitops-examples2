...
Kiwi_150: {
	...
	config: [
		...
		// Kiwi_150 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_150 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_150/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_150$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_150
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_150 proxy object. All configs
