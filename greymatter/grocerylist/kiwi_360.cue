...
Kiwi_360: {
	...
	config: [
		...
		// Kiwi_360 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_360 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_360/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_360$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_360
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_360 proxy object. All configs
