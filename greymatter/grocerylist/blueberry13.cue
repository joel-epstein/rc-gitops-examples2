...
Blueberry13: {
	...
	config: [
		...
		// Blueberry13 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry13 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry13
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry13 proxy object. All configs
