...
Kiwi_136: {
	...
	config: [
		...
		// Kiwi_136 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_136 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_136/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_136$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_136
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_136 proxy object. All configs
