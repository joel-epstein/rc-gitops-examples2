...
Kiwi_15: {
	...
	config: [
		...
		// Kiwi_15 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_15 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-15/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-15$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-15
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-15 proxy object. All configs
