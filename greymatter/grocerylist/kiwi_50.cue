...
Kiwi_50: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_50/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_50$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_50
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_50 proxy object. All configs
