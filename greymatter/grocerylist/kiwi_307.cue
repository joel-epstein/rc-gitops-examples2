...
Kiwi_307: {
	...
	config: [
		...
		// Kiwi_307 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_307 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_307/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_307$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_307
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_307 proxy object. All configs
