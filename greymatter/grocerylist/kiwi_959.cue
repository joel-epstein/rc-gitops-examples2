...
Kiwi_959: {
	...
	config: [
		...
		// Kiwi_959 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_959 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_959/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_959$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_959
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_959 proxy object. All configs
