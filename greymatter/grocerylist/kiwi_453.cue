...
Kiwi_453: {
	...
	config: [
		...
		// Kiwi_453 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_453 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_453/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_453$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_453
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_453 proxy object. All configs
