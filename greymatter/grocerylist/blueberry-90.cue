...
Blueberry_90: {
	...
	config: [
		...
		// Blueberry_90 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_90 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-90/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-90$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-90
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-90 proxy object. All configs
