...
Kiwi_746: {
	...
	config: [
		...
		// Kiwi_746 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_746 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_746/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_746$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_746
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_746 proxy object. All configs
