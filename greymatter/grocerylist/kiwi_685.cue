...
Kiwi_685: {
	...
	config: [
		...
		// Kiwi_685 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_685 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_685/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_685$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_685
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_685 proxy object. All configs
