...
Kiwi_470: {
	...
	config: [
		...
		// Kiwi_470 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_470 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_470/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_470$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_470
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_470 proxy object. All configs
