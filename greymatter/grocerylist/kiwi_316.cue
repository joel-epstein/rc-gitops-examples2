...
Kiwi_316: {
	...
	config: [
		...
		// Kiwi_316 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_316 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_316/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_316$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_316
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_316 proxy object. All configs
