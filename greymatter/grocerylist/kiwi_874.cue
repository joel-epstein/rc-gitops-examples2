...
Kiwi_874: {
	...
	config: [
		...
		// Kiwi_874 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_874 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_874/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_874$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_874
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_874 proxy object. All configs
