...
Kiwi_306: {
	...
	config: [
		...
		// Kiwi_306 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_306 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_306/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_306$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_306
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_306 proxy object. All configs
