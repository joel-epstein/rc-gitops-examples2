...
Kiwi_282: {
	...
	config: [
		...
		// Kiwi_282 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_282 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_282/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_282$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_282
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_282 proxy object. All configs
