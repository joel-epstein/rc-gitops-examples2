...
Kiwi_936: {
	...
	config: [
		...
		// Kiwi_936 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_936 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_936/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_936$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_936
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_936 proxy object. All configs
