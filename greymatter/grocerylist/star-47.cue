...
Star_47: {
	...
	config: [
		...
		// Star_47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-47
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-47 proxy object. All configs
