...
Kiwi_598: {
	...
	config: [
		...
		// Kiwi_598 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_598 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_598/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_598$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_598
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_598 proxy object. All configs
