...
Tangerine39: {
	...
	config: [
		...
		// Tangerine39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine39
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine39 proxy object. All configs
