...
Kiwi_739: {
	...
	config: [
		...
		// Kiwi_739 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_739 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_739/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_739$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_739
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_739 proxy object. All configs
