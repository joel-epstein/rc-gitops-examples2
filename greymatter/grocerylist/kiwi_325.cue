...
Kiwi_325: {
	...
	config: [
		...
		// Kiwi_325 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_325 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_325/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_325$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_325
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_325 proxy object. All configs
