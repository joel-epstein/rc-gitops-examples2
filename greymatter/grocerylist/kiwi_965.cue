...
Kiwi_965: {
	...
	config: [
		...
		// Kiwi_965 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_965 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_965/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_965$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_965
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_965 proxy object. All configs
