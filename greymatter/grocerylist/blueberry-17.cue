...
Blueberry_17: {
	...
	config: [
		...
		// Blueberry_17 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_17 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-17
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-17 proxy object. All configs
