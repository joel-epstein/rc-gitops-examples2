...
Kiwi65: {
	...
	config: [
		...
		// Kiwi65 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi65 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi65/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi65$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi65
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi65 proxy object. All configs
