...
Cranberry42: {
	...
	config: [
		...
		// Cranberry42 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry42 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry42/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry42$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry42
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry42 proxy object. All configs
