...
Kiwi_213: {
	...
	config: [
		...
		// Kiwi_213 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_213 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_213/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_213$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_213
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_213 proxy object. All configs
