...
Tangerine_63: {
	...
	config: [
		...
		// Tangerine_63 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_63 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-63/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-63$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-63
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-63 proxy object. All configs
