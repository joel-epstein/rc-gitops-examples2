...
Kiwi_496: {
	...
	config: [
		...
		// Kiwi_496 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_496 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_496/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_496$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_496
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_496 proxy object. All configs
