...
Kiwi_12: {
	...
	config: [
		...
		// Kiwi_12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_12
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_12 proxy object. All configs
