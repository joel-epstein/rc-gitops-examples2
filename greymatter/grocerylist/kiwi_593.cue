...
Kiwi_593: {
	...
	config: [
		...
		// Kiwi_593 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_593 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_593/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_593$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_593
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_593 proxy object. All configs
