...
Kiwi_417: {
	...
	config: [
		...
		// Kiwi_417 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_417 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_417/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_417$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_417
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_417 proxy object. All configs
