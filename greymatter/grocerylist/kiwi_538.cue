...
Kiwi_538: {
	...
	config: [
		...
		// Kiwi_538 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_538 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_538/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_538$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_538
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_538 proxy object. All configs
