...
Tangerine_24: {
	...
	config: [
		...
		// Tangerine_24 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_24 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-24/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-24$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-24
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-24 proxy object. All configs
