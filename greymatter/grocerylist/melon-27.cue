...
Melon_27: {
	...
	config: [
		...
		// Melon_27 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_27 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-27/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-27$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-27
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-27 proxy object. All configs
