...
Kiwi_215: {
	...
	config: [
		...
		// Kiwi_215 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_215 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_215/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_215$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_215
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_215 proxy object. All configs
