...
Orange_92: {
	...
	config: [
		...
		// Orange_92 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_92 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-92/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-92$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-92
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-92 proxy object. All configs
