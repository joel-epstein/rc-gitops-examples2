...
Melon_52: {
	...
	config: [
		...
		// Melon_52 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_52 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-52/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-52$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-52
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-52 proxy object. All configs
