...
Grape_86: {
	...
	config: [
		...
		// Grape_86 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_86 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-86/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-86$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-86
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-86 proxy object. All configs
