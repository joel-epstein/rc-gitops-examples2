...
Tangerine_55: {
	...
	config: [
		...
		// Tangerine_55 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_55 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-55/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-55$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-55
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-55 proxy object. All configs
