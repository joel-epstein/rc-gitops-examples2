...
Kiwi_197: {
	...
	config: [
		...
		// Kiwi_197 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_197 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_197/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_197$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_197
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_197 proxy object. All configs
