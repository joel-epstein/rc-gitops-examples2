...
Tangerine42: {
	...
	config: [
		...
		// Tangerine42 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine42 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine42/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine42$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine42
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine42 proxy object. All configs
