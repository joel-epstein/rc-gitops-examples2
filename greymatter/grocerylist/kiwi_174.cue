...
Kiwi_174: {
	...
	config: [
		...
		// Kiwi_174 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_174 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_174/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_174$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_174
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_174 proxy object. All configs
