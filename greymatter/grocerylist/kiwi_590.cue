...
Kiwi_590: {
	...
	config: [
		...
		// Kiwi_590 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_590 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_590/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_590$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_590
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_590 proxy object. All configs
