...
Orange_51: {
	...
	config: [
		...
		// Orange_51 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_51 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-51/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-51$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-51
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-51 proxy object. All configs
