...
Kiwi_348: {
	...
	config: [
		...
		// Kiwi_348 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_348 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_348/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_348$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_348
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_348 proxy object. All configs
