...
Melon_15: {
	...
	config: [
		...
		// Melon_15 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_15 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-15/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-15$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-15
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-15 proxy object. All configs
