...
Kiwi_736: {
	...
	config: [
		...
		// Kiwi_736 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_736 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_736/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_736$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_736
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_736 proxy object. All configs
