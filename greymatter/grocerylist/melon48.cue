...
Melon48: {
	...
	config: [
		...
		// Melon48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon48
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon48 proxy object. All configs
