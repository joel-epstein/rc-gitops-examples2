...
Kiwi_437: {
	...
	config: [
		...
		// Kiwi_437 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_437 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_437/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_437$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_437
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_437 proxy object. All configs
