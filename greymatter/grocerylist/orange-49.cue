...
Orange_49: {
	...
	config: [
		...
		// Orange_49 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_49 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-49/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-49$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-49
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-49 proxy object. All configs
