...
Kiwi_22: {
	...
	config: [
		...
		// Kiwi_22 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_22 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-22
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-22 proxy object. All configs
