...
Melon35: {
	...
	config: [
		...
		// Melon35 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon35 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon35/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon35$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon35
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon35 proxy object. All configs
