...
Kiwi_784: {
	...
	config: [
		...
		// Kiwi_784 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_784 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_784/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_784$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_784
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_784 proxy object. All configs
