...
Kiwi_599: {
	...
	config: [
		...
		// Kiwi_599 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_599 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_599/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_599$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_599
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_599 proxy object. All configs
