...
Kiwi_594: {
	...
	config: [
		...
		// Kiwi_594 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_594 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_594/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_594$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_594
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_594 proxy object. All configs
