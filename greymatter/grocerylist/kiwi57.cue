...
Kiwi57: {
	...
	config: [
		...
		// Kiwi57 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi57/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi57$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi57
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi57 proxy object. All configs
