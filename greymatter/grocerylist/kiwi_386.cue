...
Kiwi_386: {
	...
	config: [
		...
		// Kiwi_386 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_386 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_386/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_386$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_386
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_386 proxy object. All configs
