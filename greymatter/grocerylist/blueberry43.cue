...
Blueberry43: {
	...
	config: [
		...
		// Blueberry43 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry43 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry43/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry43$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry43
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry43 proxy object. All configs
