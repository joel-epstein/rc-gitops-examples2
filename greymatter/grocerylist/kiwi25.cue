...
Kiwi25: {
	...
	config: [
		...
		// Kiwi25 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi25/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi25$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi25
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi25 proxy object. All configs
