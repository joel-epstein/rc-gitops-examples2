...
Cranberry31: {
	...
	config: [
		...
		// Cranberry31 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry31 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry31/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry31$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry31
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry31 proxy object. All configs
