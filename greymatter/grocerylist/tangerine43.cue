...
Tangerine43: {
	...
	config: [
		...
		// Tangerine43 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine43 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine43/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine43$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine43
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine43 proxy object. All configs
