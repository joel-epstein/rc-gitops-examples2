...
Kiwi_292: {
	...
	config: [
		...
		// Kiwi_292 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_292 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_292/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_292$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_292
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_292 proxy object. All configs
