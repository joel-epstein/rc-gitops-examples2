...
Orange_67: {
	...
	config: [
		...
		// Orange_67 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_67 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-67/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-67$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-67
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-67 proxy object. All configs
