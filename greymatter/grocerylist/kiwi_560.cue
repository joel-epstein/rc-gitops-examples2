...
Kiwi_560: {
	...
	config: [
		...
		// Kiwi_560 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_560 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_560/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_560$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_560
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_560 proxy object. All configs
