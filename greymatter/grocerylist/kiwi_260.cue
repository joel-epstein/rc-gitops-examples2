...
Kiwi_260: {
	...
	config: [
		...
		// Kiwi_260 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_260 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_260/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_260$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_260
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_260 proxy object. All configs
