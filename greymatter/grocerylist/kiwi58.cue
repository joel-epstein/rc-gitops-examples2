...
Kiwi58: {
	...
	config: [
		...
		// Kiwi58 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi58/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi58$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi58
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi58 proxy object. All configs
