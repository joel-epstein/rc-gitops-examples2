...
Kiwi_682: {
	...
	config: [
		...
		// Kiwi_682 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_682 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_682/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_682$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_682
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_682 proxy object. All configs
