...
Kiwi_238: {
	...
	config: [
		...
		// Kiwi_238 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_238 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_238/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_238$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_238
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_238 proxy object. All configs
