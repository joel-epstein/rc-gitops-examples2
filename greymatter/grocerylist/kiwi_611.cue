...
Kiwi_611: {
	...
	config: [
		...
		// Kiwi_611 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_611 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_611/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_611$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_611
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_611 proxy object. All configs
