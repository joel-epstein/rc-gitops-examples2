...
Kiwi_445: {
	...
	config: [
		...
		// Kiwi_445 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_445 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_445/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_445$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_445
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_445 proxy object. All configs
