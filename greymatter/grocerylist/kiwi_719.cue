...
Kiwi_719: {
	...
	config: [
		...
		// Kiwi_719 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_719 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_719/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_719$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_719
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_719 proxy object. All configs
