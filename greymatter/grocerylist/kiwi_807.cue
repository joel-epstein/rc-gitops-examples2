...
Kiwi_807: {
	...
	config: [
		...
		// Kiwi_807 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_807 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_807/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_807$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_807
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_807 proxy object. All configs
