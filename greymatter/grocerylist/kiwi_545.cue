...
Kiwi_545: {
	...
	config: [
		...
		// Kiwi_545 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_545 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_545/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_545$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_545
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_545 proxy object. All configs
