...
Kiwi_497: {
	...
	config: [
		...
		// Kiwi_497 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_497 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_497/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_497$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_497
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_497 proxy object. All configs
