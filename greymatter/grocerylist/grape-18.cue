...
Grape_18: {
	...
	config: [
		...
		// Grape_18 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_18 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-18/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-18$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-18
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-18 proxy object. All configs
