...
Kiwi_868: {
	...
	config: [
		...
		// Kiwi_868 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_868 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_868/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_868$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_868
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_868 proxy object. All configs
