...
Tangerine_14: {
	...
	config: [
		...
		// Tangerine_14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-14
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-14 proxy object. All configs
