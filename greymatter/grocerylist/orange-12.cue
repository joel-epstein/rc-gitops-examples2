...
Orange_12: {
	...
	config: [
		...
		// Orange_12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-12
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-12 proxy object. All configs
