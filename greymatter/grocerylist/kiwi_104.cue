...
Kiwi_104: {
	...
	config: [
		...
		// Kiwi_104 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_104 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_104/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_104$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_104
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_104 proxy object. All configs
