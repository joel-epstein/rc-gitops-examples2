...
Star_33: {
	...
	config: [
		...
		// Star_33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-33
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-33 proxy object. All configs
