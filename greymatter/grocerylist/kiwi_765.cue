...
Kiwi_765: {
	...
	config: [
		...
		// Kiwi_765 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_765 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_765/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_765$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_765
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_765 proxy object. All configs
