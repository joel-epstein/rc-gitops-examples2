...
Blueberry_77: {
	...
	config: [
		...
		// Blueberry_77 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_77 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-77/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-77$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-77
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-77 proxy object. All configs
