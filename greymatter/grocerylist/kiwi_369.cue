...
Kiwi_369: {
	...
	config: [
		...
		// Kiwi_369 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_369 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_369/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_369$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_369
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_369 proxy object. All configs
