...
Kiwi_82: {
	...
	config: [
		...
		// Kiwi_82 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_82 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-82/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-82$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-82
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-82 proxy object. All configs
