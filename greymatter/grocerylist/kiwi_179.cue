...
Kiwi_179: {
	...
	config: [
		...
		// Kiwi_179 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_179 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_179/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_179$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_179
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_179 proxy object. All configs
