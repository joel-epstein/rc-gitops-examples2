...
Kiwi_680: {
	...
	config: [
		...
		// Kiwi_680 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_680 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_680/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_680$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_680
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_680 proxy object. All configs
