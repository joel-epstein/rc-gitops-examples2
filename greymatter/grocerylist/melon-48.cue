...
Melon_48: {
	...
	config: [
		...
		// Melon_48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-48
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-48 proxy object. All configs
