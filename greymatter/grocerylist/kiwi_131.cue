...
Kiwi_131: {
	...
	config: [
		...
		// Kiwi_131 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_131 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_131/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_131$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_131
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_131 proxy object. All configs
