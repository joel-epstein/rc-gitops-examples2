...
Kiwi40: {
	...
	config: [
		...
		// Kiwi40 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi40/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi40$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi40
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi40 proxy object. All configs
