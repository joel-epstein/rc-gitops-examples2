...
Kiwi_620: {
	...
	config: [
		...
		// Kiwi_620 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_620 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_620/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_620$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_620
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_620 proxy object. All configs
