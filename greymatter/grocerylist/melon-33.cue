...
Melon_33: {
	...
	config: [
		...
		// Melon_33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-33
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-33 proxy object. All configs
