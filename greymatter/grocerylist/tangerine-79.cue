...
Tangerine_79: {
	...
	config: [
		...
		// Tangerine_79 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_79 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-79/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-79$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-79
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-79 proxy object. All configs
