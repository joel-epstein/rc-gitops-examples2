...
Kiwi_757: {
	...
	config: [
		...
		// Kiwi_757 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_757 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_757/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_757$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_757
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_757 proxy object. All configs
