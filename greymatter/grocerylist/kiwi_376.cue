...
Kiwi_376: {
	...
	config: [
		...
		// Kiwi_376 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_376 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_376/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_376$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_376
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_376 proxy object. All configs
