...
Kiwi_731: {
	...
	config: [
		...
		// Kiwi_731 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_731 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_731/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_731$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_731
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_731 proxy object. All configs
