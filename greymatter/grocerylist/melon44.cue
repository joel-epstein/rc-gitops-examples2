...
Melon44: {
	...
	config: [
		...
		// Melon44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon44
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon44 proxy object. All configs
