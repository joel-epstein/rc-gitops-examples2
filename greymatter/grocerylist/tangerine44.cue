...
Tangerine44: {
	...
	config: [
		...
		// Tangerine44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine44
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine44 proxy object. All configs
