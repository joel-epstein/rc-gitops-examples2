...
Kiwi_366: {
	...
	config: [
		...
		// Kiwi_366 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_366 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_366/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_366$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_366
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_366 proxy object. All configs
