...
Kiwi_834: {
	...
	config: [
		...
		// Kiwi_834 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_834 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_834/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_834$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_834
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_834 proxy object. All configs
