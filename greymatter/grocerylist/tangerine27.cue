...
Tangerine27: {
	...
	config: [
		...
		// Tangerine27 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine27 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine27/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine27$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine27
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine27 proxy object. All configs
