...
Grape_51: {
	...
	config: [
		...
		// Grape_51 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_51 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-51/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-51$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-51
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-51 proxy object. All configs
