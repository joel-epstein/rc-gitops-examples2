...
Grape_22: {
	...
	config: [
		...
		// Grape_22 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_22 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-22
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-22 proxy object. All configs
