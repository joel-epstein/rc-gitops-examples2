...
Kiwi_2: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_2/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_2$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_2
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_2 proxy object. All configs
