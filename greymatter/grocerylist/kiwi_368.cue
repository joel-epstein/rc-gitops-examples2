...
Kiwi_368: {
	...
	config: [
		...
		// Kiwi_368 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_368 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_368/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_368$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_368
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_368 proxy object. All configs
