...
Orange_93: {
	...
	config: [
		...
		// Orange_93 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_93 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-93/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-93$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-93
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-93 proxy object. All configs
