...
Kiwi_148: {
	...
	config: [
		...
		// Kiwi_148 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_148 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_148/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_148$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_148
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_148 proxy object. All configs
