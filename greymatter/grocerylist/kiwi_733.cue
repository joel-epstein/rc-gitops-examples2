...
Kiwi_733: {
	...
	config: [
		...
		// Kiwi_733 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_733 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_733/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_733$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_733
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_733 proxy object. All configs
