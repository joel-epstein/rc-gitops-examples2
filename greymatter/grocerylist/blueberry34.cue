...
Blueberry34: {
	...
	config: [
		...
		// Blueberry34 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry34 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry34
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry34 proxy object. All configs
