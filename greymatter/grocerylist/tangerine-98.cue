...
Tangerine_98: {
	...
	config: [
		...
		// Tangerine_98 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_98 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-98/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-98$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-98
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-98 proxy object. All configs
