...
Kiwi_68: {
	...
	config: [
		...
		// Kiwi_68 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_68 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-68/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-68$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-68
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-68 proxy object. All configs
