...
Grape_11: {
	...
	config: [
		...
		// Grape_11 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_11 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-11/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-11$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-11
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-11 proxy object. All configs
