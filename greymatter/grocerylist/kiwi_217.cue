...
Kiwi_217: {
	...
	config: [
		...
		// Kiwi_217 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_217 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_217/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_217$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_217
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_217 proxy object. All configs
