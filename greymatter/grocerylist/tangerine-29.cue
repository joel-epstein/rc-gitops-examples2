...
Tangerine_29: {
	...
	config: [
		...
		// Tangerine_29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-29
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-29 proxy object. All configs
