...
Kiwi_459: {
	...
	config: [
		...
		// Kiwi_459 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_459 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_459/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_459$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_459
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_459 proxy object. All configs
