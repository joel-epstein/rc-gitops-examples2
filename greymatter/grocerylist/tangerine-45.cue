...
Tangerine_45: {
	...
	config: [
		...
		// Tangerine_45 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_45 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-45/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-45$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-45
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-45 proxy object. All configs
