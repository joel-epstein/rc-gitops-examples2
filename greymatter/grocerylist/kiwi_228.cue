...
Kiwi_228: {
	...
	config: [
		...
		// Kiwi_228 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_228 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_228/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_228$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_228
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_228 proxy object. All configs
