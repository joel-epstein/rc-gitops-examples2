...
Tangerine18: {
	...
	config: [
		...
		// Tangerine18 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine18 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine18/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine18$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine18
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine18 proxy object. All configs
