...
Kiwi_434: {
	...
	config: [
		...
		// Kiwi_434 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_434 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_434/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_434$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_434
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_434 proxy object. All configs
