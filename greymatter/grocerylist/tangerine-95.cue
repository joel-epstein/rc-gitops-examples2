...
Tangerine_95: {
	...
	config: [
		...
		// Tangerine_95 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_95 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-95/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-95$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-95
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-95 proxy object. All configs
