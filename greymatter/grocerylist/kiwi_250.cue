...
Kiwi_250: {
	...
	config: [
		...
		// Kiwi_250 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_250 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_250/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_250$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_250
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_250 proxy object. All configs
