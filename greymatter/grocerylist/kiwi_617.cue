...
Kiwi_617: {
	...
	config: [
		...
		// Kiwi_617 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_617 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_617/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_617$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_617
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_617 proxy object. All configs
