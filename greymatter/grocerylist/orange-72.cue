...
Orange_72: {
	...
	config: [
		...
		// Orange_72 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_72 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-72/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-72$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-72
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-72 proxy object. All configs
