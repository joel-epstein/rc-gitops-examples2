...
Kiwi_232: {
	...
	config: [
		...
		// Kiwi_232 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_232 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_232/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_232$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_232
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_232 proxy object. All configs
