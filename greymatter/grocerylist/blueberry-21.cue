...
Blueberry_21: {
	...
	config: [
		...
		// Blueberry_21 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_21 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-21/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-21$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-21
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-21 proxy object. All configs
