...
Blueberry_34: {
	...
	config: [
		...
		// Blueberry_34 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_34 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-34
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-34 proxy object. All configs
