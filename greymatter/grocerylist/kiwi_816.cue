...
Kiwi_816: {
	...
	config: [
		...
		// Kiwi_816 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_816 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_816/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_816$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_816
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_816 proxy object. All configs
