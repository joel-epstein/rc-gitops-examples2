...
Kiwi_764: {
	...
	config: [
		...
		// Kiwi_764 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_764 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_764/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_764$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_764
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_764 proxy object. All configs
