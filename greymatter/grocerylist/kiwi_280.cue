...
Kiwi_280: {
	...
	config: [
		...
		// Kiwi_280 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_280 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_280/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_280$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_280
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_280 proxy object. All configs
