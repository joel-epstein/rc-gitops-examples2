...
Tangerine_94: {
	...
	config: [
		...
		// Tangerine_94 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_94 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-94/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-94$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-94
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-94 proxy object. All configs
