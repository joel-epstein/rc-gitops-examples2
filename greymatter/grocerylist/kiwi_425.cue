...
Kiwi_425: {
	...
	config: [
		...
		// Kiwi_425 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_425 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_425/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_425$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_425
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_425 proxy object. All configs
