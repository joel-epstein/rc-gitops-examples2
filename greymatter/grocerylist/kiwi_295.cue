...
Kiwi_295: {
	...
	config: [
		...
		// Kiwi_295 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_295 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_295/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_295$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_295
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_295 proxy object. All configs
