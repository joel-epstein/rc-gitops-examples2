...
Kiwi_637: {
	...
	config: [
		...
		// Kiwi_637 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_637 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_637/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_637$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_637
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_637 proxy object. All configs
