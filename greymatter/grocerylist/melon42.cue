...
Melon42: {
	...
	config: [
		...
		// Melon42 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon42 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon42/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon42$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon42
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon42 proxy object. All configs
