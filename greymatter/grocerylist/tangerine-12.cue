...
Tangerine_12: {
	...
	config: [
		...
		// Tangerine_12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-12
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-12 proxy object. All configs
