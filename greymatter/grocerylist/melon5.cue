...
Melon5: {
	...
	config: [
		...
		// Melon5 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon5 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon5/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon5$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon5
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon5 proxy object. All configs
