...
Grape_26: {
	...
	config: [
		...
		// Grape_26 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_26 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-26/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-26$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-26
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-26 proxy object. All configs
