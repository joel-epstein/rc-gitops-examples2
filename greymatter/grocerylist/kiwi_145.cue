...
Kiwi_145: {
	...
	config: [
		...
		// Kiwi_145 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_145 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_145/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_145$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_145
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_145 proxy object. All configs
