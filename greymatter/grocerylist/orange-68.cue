...
Orange_68: {
	...
	config: [
		...
		// Orange_68 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_68 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-68/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-68$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-68
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-68 proxy object. All configs
