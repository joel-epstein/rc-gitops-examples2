...
Kiwi_958: {
	...
	config: [
		...
		// Kiwi_958 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_958 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_958/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_958$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_958
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_958 proxy object. All configs
