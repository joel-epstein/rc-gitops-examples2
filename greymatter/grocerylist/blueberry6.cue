...
Blueberry6: {
	...
	config: [
		...
		// Blueberry6 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry6 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry6/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry6$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry6
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry6 proxy object. All configs
