...
Kiwi_342: {
	...
	config: [
		...
		// Kiwi_342 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_342 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_342/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_342$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_342
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_342 proxy object. All configs
