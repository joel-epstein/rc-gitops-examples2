...
Kiwi_415: {
	...
	config: [
		...
		// Kiwi_415 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_415 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_415/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_415$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_415
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_415 proxy object. All configs
