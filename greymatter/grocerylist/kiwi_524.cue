...
Kiwi_524: {
	...
	config: [
		...
		// Kiwi_524 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_524 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_524/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_524$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_524
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_524 proxy object. All configs
