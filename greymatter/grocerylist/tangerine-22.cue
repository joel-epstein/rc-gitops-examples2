...
Tangerine_22: {
	...
	config: [
		...
		// Tangerine_22 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_22 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-22
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-22 proxy object. All configs
