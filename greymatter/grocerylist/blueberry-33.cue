...
Blueberry_33: {
	...
	config: [
		...
		// Blueberry_33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-33
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-33 proxy object. All configs
