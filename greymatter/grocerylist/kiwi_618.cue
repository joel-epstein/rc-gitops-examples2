...
Kiwi_618: {
	...
	config: [
		...
		// Kiwi_618 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_618 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_618/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_618$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_618
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_618 proxy object. All configs
