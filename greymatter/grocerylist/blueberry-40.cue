...
Blueberry_40: {
	...
	config: [
		...
		// Blueberry_40 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_40 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-40/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-40$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-40
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-40 proxy object. All configs
