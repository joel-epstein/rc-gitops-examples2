...
Kiwi_651: {
	...
	config: [
		...
		// Kiwi_651 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_651 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_651/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_651$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_651
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_651 proxy object. All configs
