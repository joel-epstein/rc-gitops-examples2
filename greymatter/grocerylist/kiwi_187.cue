...
Kiwi_187: {
	...
	config: [
		...
		// Kiwi_187 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_187 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_187/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_187$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_187
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_187 proxy object. All configs
