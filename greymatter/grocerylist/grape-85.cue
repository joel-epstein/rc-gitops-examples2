...
Grape_85: {
	...
	config: [
		...
		// Grape_85 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_85 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-85/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-85$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-85
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-85 proxy object. All configs
