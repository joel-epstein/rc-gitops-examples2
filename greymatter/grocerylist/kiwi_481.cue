...
Kiwi_481: {
	...
	config: [
		...
		// Kiwi_481 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_481 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_481/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_481$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_481
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_481 proxy object. All configs
