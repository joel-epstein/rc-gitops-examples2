...
Kiwi_178: {
	...
	config: [
		...
		// Kiwi_178 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_178 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_178/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_178$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_178
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_178 proxy object. All configs
