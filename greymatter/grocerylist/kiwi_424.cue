...
Kiwi_424: {
	...
	config: [
		...
		// Kiwi_424 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_424 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_424/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_424$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_424
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_424 proxy object. All configs
