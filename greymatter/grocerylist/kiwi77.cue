...
Kiwi77: {
	...
	config: [
		...
		// Kiwi77 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi77/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi77$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi77
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi77 proxy object. All configs
