...
Tangerine_97: {
	...
	config: [
		...
		// Tangerine_97 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_97 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-97/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-97$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-97
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-97 proxy object. All configs
