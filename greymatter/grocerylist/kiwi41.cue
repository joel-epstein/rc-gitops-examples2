...
Kiwi41: {
	...
	config: [
		...
		// Kiwi41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi41
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi41 proxy object. All configs
