...
Blueberry_53: {
	...
	config: [
		...
		// Blueberry_53 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_53 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-53/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-53$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-53
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-53 proxy object. All configs
