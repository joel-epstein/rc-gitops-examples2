...
Star40: {
	...
	config: [
		...
		// Star40 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star40 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star40/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star40$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star40
		#catalog_entry & {
			name:                      Name
		...
		// Shared star40 proxy object. All configs
