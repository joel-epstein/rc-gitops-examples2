...
Kiwi_986: {
	...
	config: [
		...
		// Kiwi_986 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_986 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_986/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_986$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_986
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_986 proxy object. All configs
