...
Star41: {
	...
	config: [
		...
		// Star41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star41
		#catalog_entry & {
			name:                      Name
		...
		// Shared star41 proxy object. All configs
