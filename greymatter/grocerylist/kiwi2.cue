...
Kiwi2: {
	...
	config: [
		...
		// Kiwi2 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi2/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi2$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi2
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi2 proxy object. All configs
