...
Kiwi_708: {
	...
	config: [
		...
		// Kiwi_708 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_708 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_708/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_708$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_708
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_708 proxy object. All configs
