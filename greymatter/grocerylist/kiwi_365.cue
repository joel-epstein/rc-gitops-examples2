...
Kiwi_365: {
	...
	config: [
		...
		// Kiwi_365 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_365 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_365/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_365$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_365
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_365 proxy object. All configs
