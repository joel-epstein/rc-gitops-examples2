...
Kiwi_689: {
	...
	config: [
		...
		// Kiwi_689 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_689 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_689/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_689$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_689
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_689 proxy object. All configs
