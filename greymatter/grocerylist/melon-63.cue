...
Melon_63: {
	...
	config: [
		...
		// Melon_63 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_63 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-63/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-63$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-63
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-63 proxy object. All configs
