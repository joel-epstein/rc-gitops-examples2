...
Star33: {
	...
	config: [
		...
		// Star33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star33
		#catalog_entry & {
			name:                      Name
		...
		// Shared star33 proxy object. All configs
