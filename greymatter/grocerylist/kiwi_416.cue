...
Kiwi_416: {
	...
	config: [
		...
		// Kiwi_416 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_416 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_416/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_416$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_416
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_416 proxy object. All configs
