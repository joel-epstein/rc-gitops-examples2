...
Kiwi_742: {
	...
	config: [
		...
		// Kiwi_742 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_742 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_742/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_742$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_742
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_742 proxy object. All configs
