...
Kiwi10: {
	...
	config: [
		...
		// Kiwi10 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi10 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi10/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi10$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi10
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi10 proxy object. All configs
