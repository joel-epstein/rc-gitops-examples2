...
Orange_69: {
	...
	config: [
		...
		// Orange_69 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_69 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-69/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-69$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-69
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-69 proxy object. All configs
