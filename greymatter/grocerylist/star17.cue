...
Star17: {
	...
	config: [
		...
		// Star17 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star17 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star17
		#catalog_entry & {
			name:                      Name
		...
		// Shared star17 proxy object. All configs
