...
Tangerine_83: {
	...
	config: [
		...
		// Tangerine_83 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_83 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-83/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-83$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-83
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-83 proxy object. All configs
