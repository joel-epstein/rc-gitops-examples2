...
Tangerine_37: {
	...
	config: [
		...
		// Tangerine_37 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_37 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-37/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-37$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-37
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-37 proxy object. All configs
