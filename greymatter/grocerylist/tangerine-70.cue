...
Tangerine_70: {
	...
	config: [
		...
		// Tangerine_70 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_70 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-70/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-70$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-70
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-70 proxy object. All configs
