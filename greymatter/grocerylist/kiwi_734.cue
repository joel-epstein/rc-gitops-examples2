...
Kiwi_734: {
	...
	config: [
		...
		// Kiwi_734 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_734 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_734/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_734$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_734
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_734 proxy object. All configs
