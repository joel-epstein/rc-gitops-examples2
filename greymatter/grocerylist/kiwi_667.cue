...
Kiwi_667: {
	...
	config: [
		...
		// Kiwi_667 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_667 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_667/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_667$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_667
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_667 proxy object. All configs
