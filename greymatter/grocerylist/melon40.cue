...
Melon40: {
	...
	config: [
		...
		// Melon40 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon40 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon40/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon40$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon40
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon40 proxy object. All configs
