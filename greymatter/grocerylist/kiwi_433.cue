...
Kiwi_433: {
	...
	config: [
		...
		// Kiwi_433 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_433 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_433/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_433$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_433
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_433 proxy object. All configs
