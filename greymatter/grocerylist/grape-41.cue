...
Grape_41: {
	...
	config: [
		...
		// Grape_41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-41
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-41 proxy object. All configs
