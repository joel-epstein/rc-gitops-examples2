...
Kiwi_226: {
	...
	config: [
		...
		// Kiwi_226 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_226 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_226/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_226$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_226
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_226 proxy object. All configs
