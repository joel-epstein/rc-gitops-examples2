...
Kiwi20: {
	...
	config: [
		...
		// Kiwi20 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi20 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi20/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi20$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi20
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi20 proxy object. All configs
