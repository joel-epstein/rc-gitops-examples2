...
Orange_43: {
	...
	config: [
		...
		// Orange_43 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_43 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-43/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-43$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-43
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-43 proxy object. All configs
