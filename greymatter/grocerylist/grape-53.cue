...
Grape_53: {
	...
	config: [
		...
		// Grape_53 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_53 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-53/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-53$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-53
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-53 proxy object. All configs
