...
Blueberry40: {
	...
	config: [
		...
		// Blueberry40 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry40 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry40/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry40$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry40
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry40 proxy object. All configs
