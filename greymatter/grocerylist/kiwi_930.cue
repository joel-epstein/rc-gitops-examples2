...
Kiwi_930: {
	...
	config: [
		...
		// Kiwi_930 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_930 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_930/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_930$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_930
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_930 proxy object. All configs
