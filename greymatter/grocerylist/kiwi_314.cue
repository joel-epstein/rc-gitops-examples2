...
Kiwi_314: {
	...
	config: [
		...
		// Kiwi_314 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_314 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_314/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_314$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_314
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_314 proxy object. All configs
