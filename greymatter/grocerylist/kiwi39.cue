...
Kiwi39: {
	...
	config: [
		...
		// Kiwi39 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi39
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi39 proxy object. All configs
