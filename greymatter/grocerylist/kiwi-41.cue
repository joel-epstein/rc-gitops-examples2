...
Kiwi_41: {
	...
	config: [
		...
		// Kiwi_41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-41
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-41 proxy object. All configs
