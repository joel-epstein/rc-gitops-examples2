...
Cranberry_51: {
	...
	config: [
		...
		// Cranberry_51 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_51 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-51/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-51$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-51
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-51 proxy object. All configs
