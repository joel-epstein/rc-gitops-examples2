...
Kiwi_726: {
	...
	config: [
		...
		// Kiwi_726 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_726 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_726/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_726$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_726
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_726 proxy object. All configs
