...
Kiwi_275: {
	...
	config: [
		...
		// Kiwi_275 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_275 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_275/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_275$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_275
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_275 proxy object. All configs
