...
Kiwi_956: {
	...
	config: [
		...
		// Kiwi_956 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_956 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_956/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_956$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_956
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_956 proxy object. All configs
