...
Blueberry_44: {
	...
	config: [
		...
		// Blueberry_44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-44
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-44 proxy object. All configs
