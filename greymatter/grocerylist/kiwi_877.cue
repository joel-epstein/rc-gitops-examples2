...
Kiwi_877: {
	...
	config: [
		...
		// Kiwi_877 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_877 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_877/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_877$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_877
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_877 proxy object. All configs
