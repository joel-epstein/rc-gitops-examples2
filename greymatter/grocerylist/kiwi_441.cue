...
Kiwi_441: {
	...
	config: [
		...
		// Kiwi_441 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_441 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_441/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_441$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_441
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_441 proxy object. All configs
