...
Kiwi_45: {
	...
	config: [
		...
		// Kiwi_45 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_45 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_45/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_45$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_45
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_45 proxy object. All configs
