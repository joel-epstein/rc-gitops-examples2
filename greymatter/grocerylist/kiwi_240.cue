...
Kiwi_240: {
	...
	config: [
		...
		// Kiwi_240 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_240 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_240/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_240$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_240
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_240 proxy object. All configs
