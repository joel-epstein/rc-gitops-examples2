...
Kiwi_289: {
	...
	config: [
		...
		// Kiwi_289 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_289 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_289/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_289$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_289
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_289 proxy object. All configs
