...
Cranberry33: {
	...
	config: [
		...
		// Cranberry33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry33
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry33 proxy object. All configs
