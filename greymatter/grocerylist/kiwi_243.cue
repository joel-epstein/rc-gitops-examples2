...
Kiwi_243: {
	...
	config: [
		...
		// Kiwi_243 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_243 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_243/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_243$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_243
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_243 proxy object. All configs
