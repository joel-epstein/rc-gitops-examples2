...
Blueberry_66: {
	...
	config: [
		...
		// Blueberry_66 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_66 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-66/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-66$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-66
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-66 proxy object. All configs
