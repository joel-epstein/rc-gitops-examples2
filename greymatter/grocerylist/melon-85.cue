...
Melon_85: {
	...
	config: [
		...
		// Melon_85 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_85 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-85/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-85$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-85
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-85 proxy object. All configs
