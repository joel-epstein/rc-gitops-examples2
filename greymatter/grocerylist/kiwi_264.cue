...
Kiwi_264: {
	...
	config: [
		...
		// Kiwi_264 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_264 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_264/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_264$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_264
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_264 proxy object. All configs
