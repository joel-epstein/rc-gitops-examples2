...
Tangerine11: {
	...
	config: [
		...
		// Tangerine11 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine11 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine11/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine11$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine11
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine11 proxy object. All configs
