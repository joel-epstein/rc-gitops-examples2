...
Kiwi_460: {
	...
	config: [
		...
		// Kiwi_460 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_460 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_460/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_460$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_460
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_460 proxy object. All configs
