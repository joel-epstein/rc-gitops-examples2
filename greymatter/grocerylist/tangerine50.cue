...
Tangerine50: {
	...
	config: [
		...
		// Tangerine50 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine50 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine50/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine50$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine50
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine50 proxy object. All configs
