...
Kiwi_602: {
	...
	config: [
		...
		// Kiwi_602 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_602 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_602/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_602$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_602
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_602 proxy object. All configs
