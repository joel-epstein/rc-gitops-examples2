...
Kiwi9: {
	...
	config: [
		...
		// Kiwi9 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi9/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi9$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi9
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi9 proxy object. All configs
