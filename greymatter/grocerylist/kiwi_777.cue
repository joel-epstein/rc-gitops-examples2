...
Kiwi_777: {
	...
	config: [
		...
		// Kiwi_777 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_777 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_777/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_777$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_777
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_777 proxy object. All configs
