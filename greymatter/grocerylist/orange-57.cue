...
Orange_57: {
	...
	config: [
		...
		// Orange_57 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_57 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-57/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-57$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-57
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-57 proxy object. All configs
