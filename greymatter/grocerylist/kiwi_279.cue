...
Kiwi_279: {
	...
	config: [
		...
		// Kiwi_279 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_279 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_279/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_279$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_279
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_279 proxy object. All configs
