...
Tangerine23: {
	...
	config: [
		...
		// Tangerine23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine23
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine23 proxy object. All configs
