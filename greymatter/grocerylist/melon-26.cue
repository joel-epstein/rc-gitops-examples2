...
Melon_26: {
	...
	config: [
		...
		// Melon_26 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_26 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-26/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-26$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-26
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-26 proxy object. All configs
