...
Melon_83: {
	...
	config: [
		...
		// Melon_83 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_83 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-83/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-83$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-83
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-83 proxy object. All configs
