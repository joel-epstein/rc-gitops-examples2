...
Kiwi_55: {
	...
	config: [
		...
		// Kiwi_55 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_55 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_55/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_55$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_55
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_55 proxy object. All configs
