...
Kiwi18: {
	...
	config: [
		...
		// Kiwi18 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi18 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi18/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi18$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi18
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi18 proxy object. All configs
