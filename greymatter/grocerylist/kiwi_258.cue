...
Kiwi_258: {
	...
	config: [
		...
		// Kiwi_258 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_258 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_258/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_258$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_258
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_258 proxy object. All configs
