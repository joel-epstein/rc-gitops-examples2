...
Kiwi_329: {
	...
	config: [
		...
		// Kiwi_329 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_329 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_329/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_329$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_329
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_329 proxy object. All configs
