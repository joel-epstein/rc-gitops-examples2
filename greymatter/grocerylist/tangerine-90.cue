...
Tangerine_90: {
	...
	config: [
		...
		// Tangerine_90 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_90 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-90/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-90$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-90
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-90 proxy object. All configs
