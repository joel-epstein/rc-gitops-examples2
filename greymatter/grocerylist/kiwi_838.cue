...
Kiwi_838: {
	...
	config: [
		...
		// Kiwi_838 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_838 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_838/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_838$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_838
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_838 proxy object. All configs
