...
Cranberry_47: {
	...
	config: [
		...
		// Cranberry_47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-47
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-47 proxy object. All configs
