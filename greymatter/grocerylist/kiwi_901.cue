...
Kiwi_901: {
	...
	config: [
		...
		// Kiwi_901 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_901 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_901/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_901$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_901
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_901 proxy object. All configs
