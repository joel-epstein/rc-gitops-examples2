...
Kiwi_324: {
	...
	config: [
		...
		// Kiwi_324 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_324 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_324/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_324$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_324
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_324 proxy object. All configs
