...
Melon_24: {
	...
	config: [
		...
		// Melon_24 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_24 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-24/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-24$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-24
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-24 proxy object. All configs
