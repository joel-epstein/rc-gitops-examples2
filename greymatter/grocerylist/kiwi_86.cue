...
Kiwi_86: {
	...
	config: [
		...
		// Kiwi_86 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_86 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_86/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_86$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_86
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_86 proxy object. All configs
