...
Tangerine34: {
	...
	config: [
		...
		// Tangerine34 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine34 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine34
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine34 proxy object. All configs
