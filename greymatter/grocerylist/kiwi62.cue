...
Kiwi62: {
	...
	config: [
		...
		// Kiwi62 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi62 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi62/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi62$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi62
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi62 proxy object. All configs
