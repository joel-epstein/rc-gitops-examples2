...
Blueberry_63: {
	...
	config: [
		...
		// Blueberry_63 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_63 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-63/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-63$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-63
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-63 proxy object. All configs
