...
Melon_46: {
	...
	config: [
		...
		// Melon_46 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_46 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-46
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-46 proxy object. All configs
