...
Blueberry_79: {
	...
	config: [
		...
		// Blueberry_79 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_79 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-79/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-79$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-79
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-79 proxy object. All configs
