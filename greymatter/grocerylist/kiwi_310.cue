...
Kiwi_310: {
	...
	config: [
		...
		// Kiwi_310 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_310 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_310/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_310$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_310
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_310 proxy object. All configs
