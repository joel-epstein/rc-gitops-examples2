...
Kiwi_370: {
	...
	config: [
		...
		// Kiwi_370 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_370 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_370/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_370$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_370
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_370 proxy object. All configs
