...
Melon39: {
	...
	config: [
		...
		// Melon39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon39
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon39 proxy object. All configs
