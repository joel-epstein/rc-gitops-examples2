...
Kiwi_212: {
	...
	config: [
		...
		// Kiwi_212 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_212 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_212/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_212$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_212
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_212 proxy object. All configs
