...
Cranberry38: {
	...
	config: [
		...
		// Cranberry38 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry38 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry38
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry38 proxy object. All configs
