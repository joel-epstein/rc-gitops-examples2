...
Kiwi_996: {
	...
	config: [
		...
		// Kiwi_996 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_996 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_996/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_996$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_996
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_996 proxy object. All configs
