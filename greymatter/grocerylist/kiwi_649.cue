...
Kiwi_649: {
	...
	config: [
		...
		// Kiwi_649 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_649 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_649/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_649$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_649
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_649 proxy object. All configs
