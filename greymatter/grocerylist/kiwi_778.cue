...
Kiwi_778: {
	...
	config: [
		...
		// Kiwi_778 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_778 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_778/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_778$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_778
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_778 proxy object. All configs
