...
Kiwi_419: {
	...
	config: [
		...
		// Kiwi_419 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_419 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_419/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_419$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_419
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_419 proxy object. All configs
