...
Grape_71: {
	...
	config: [
		...
		// Grape_71 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_71 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-71/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-71$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-71
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-71 proxy object. All configs
