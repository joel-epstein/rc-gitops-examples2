...
Kiwi_43: {
	...
	config: [
		...
		// Kiwi_43 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_43 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_43/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_43$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_43
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_43 proxy object. All configs
