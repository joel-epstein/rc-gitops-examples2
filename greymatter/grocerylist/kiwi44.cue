...
Kiwi44: {
	...
	config: [
		...
		// Kiwi44 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi44
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi44 proxy object. All configs
