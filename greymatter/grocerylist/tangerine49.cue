...
Tangerine49: {
	...
	config: [
		...
		// Tangerine49 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine49 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine49/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine49$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine49
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine49 proxy object. All configs
