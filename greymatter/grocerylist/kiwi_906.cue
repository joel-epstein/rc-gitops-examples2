...
Kiwi_906: {
	...
	config: [
		...
		// Kiwi_906 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_906 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_906/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_906$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_906
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_906 proxy object. All configs
