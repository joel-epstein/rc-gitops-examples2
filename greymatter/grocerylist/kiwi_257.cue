...
Kiwi_257: {
	...
	config: [
		...
		// Kiwi_257 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_257 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_257/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_257$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_257
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_257 proxy object. All configs
