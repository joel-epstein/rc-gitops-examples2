...
Kiwi_229: {
	...
	config: [
		...
		// Kiwi_229 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_229 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_229/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_229$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_229
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_229 proxy object. All configs
