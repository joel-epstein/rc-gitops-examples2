...
Kiwi_705: {
	...
	config: [
		...
		// Kiwi_705 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_705 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_705/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_705$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_705
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_705 proxy object. All configs
