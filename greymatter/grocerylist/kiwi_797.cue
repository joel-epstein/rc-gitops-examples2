...
Kiwi_797: {
	...
	config: [
		...
		// Kiwi_797 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_797 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_797/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_797$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_797
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_797 proxy object. All configs
