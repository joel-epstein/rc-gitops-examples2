...
Kiwi_186: {
	...
	config: [
		...
		// Kiwi_186 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_186 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_186/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_186$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_186
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_186 proxy object. All configs
