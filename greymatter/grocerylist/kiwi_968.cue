...
Kiwi_968: {
	...
	config: [
		...
		// Kiwi_968 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_968 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_968/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_968$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_968
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_968 proxy object. All configs
