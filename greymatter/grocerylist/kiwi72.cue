...
Kiwi72: {
	...
	config: [
		...
		// Kiwi72 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi72 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi72/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi72$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi72
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi72 proxy object. All configs
