...
Blueberry_47: {
	...
	config: [
		...
		// Blueberry_47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-47
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-47 proxy object. All configs
