...
Kiwi_893: {
	...
	config: [
		...
		// Kiwi_893 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_893 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_893/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_893$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_893
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_893 proxy object. All configs
