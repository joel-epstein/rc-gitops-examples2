...
Kiwi_707: {
	...
	config: [
		...
		// Kiwi_707 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_707 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_707/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_707$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_707
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_707 proxy object. All configs
