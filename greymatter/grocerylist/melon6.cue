...
Melon6: {
	...
	config: [
		...
		// Melon6 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon6 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon6/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon6$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon6
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon6 proxy object. All configs
