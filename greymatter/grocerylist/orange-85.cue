...
Orange_85: {
	...
	config: [
		...
		// Orange_85 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_85 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-85/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-85$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-85
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-85 proxy object. All configs
