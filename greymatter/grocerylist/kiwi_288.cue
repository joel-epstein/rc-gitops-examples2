...
Kiwi_288: {
	...
	config: [
		...
		// Kiwi_288 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_288 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_288/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_288$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_288
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_288 proxy object. All configs
