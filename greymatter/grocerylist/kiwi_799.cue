...
Kiwi_799: {
	...
	config: [
		...
		// Kiwi_799 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_799 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_799/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_799$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_799
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_799 proxy object. All configs
