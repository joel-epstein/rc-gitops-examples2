...
Kiwi_753: {
	...
	config: [
		...
		// Kiwi_753 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_753 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_753/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_753$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_753
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_753 proxy object. All configs
