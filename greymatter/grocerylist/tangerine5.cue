...
Tangerine5: {
	...
	config: [
		...
		// Tangerine5 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine5 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine5/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine5$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine5
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine5 proxy object. All configs
