...
Kiwi54: {
	...
	config: [
		...
		// Kiwi54 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi54 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi54/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi54$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi54
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi54 proxy object. All configs
