...
Melon_56: {
	...
	config: [
		...
		// Melon_56 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_56 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-56/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-56$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-56
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-56 proxy object. All configs
