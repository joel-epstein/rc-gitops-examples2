...
Orange_38: {
	...
	config: [
		...
		// Orange_38 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_38 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-38
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-38 proxy object. All configs
