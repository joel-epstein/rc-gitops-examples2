...
Kiwi_691: {
	...
	config: [
		...
		// Kiwi_691 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_691 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_691/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_691$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_691
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_691 proxy object. All configs
