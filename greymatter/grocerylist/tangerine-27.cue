...
Tangerine_27: {
	...
	config: [
		...
		// Tangerine_27 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_27 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-27/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-27$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-27
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-27 proxy object. All configs
