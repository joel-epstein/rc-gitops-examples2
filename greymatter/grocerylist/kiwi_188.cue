...
Kiwi_188: {
	...
	config: [
		...
		// Kiwi_188 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_188 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_188/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_188$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_188
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_188 proxy object. All configs
