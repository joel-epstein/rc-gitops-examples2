...
Cranberry_57: {
	...
	config: [
		...
		// Cranberry_57 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_57 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-57/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-57$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-57
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-57 proxy object. All configs
