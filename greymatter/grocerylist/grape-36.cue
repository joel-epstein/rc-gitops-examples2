...
Grape_36: {
	...
	config: [
		...
		// Grape_36 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_36 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-36
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-36 proxy object. All configs
