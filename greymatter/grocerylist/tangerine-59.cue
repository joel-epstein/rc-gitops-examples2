...
Tangerine_59: {
	...
	config: [
		...
		// Tangerine_59 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_59 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-59/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-59$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-59
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-59 proxy object. All configs
