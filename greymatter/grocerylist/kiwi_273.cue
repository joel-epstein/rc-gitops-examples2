...
Kiwi_273: {
	...
	config: [
		...
		// Kiwi_273 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_273 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_273/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_273$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_273
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_273 proxy object. All configs
