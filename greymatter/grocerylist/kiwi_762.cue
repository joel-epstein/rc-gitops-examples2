...
Kiwi_762: {
	...
	config: [
		...
		// Kiwi_762 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_762 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_762/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_762$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_762
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_762 proxy object. All configs
