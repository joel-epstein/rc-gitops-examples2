...
Kiwi36: {
	...
	config: [
		...
		// Kiwi36 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi36
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi36 proxy object. All configs
