...
Tangerine_7: {
	...
	config: [
		...
		// Tangerine_7 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_7 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-7/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-7$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-7
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-7 proxy object. All configs
