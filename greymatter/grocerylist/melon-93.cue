...
Melon_93: {
	...
	config: [
		...
		// Melon_93 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_93 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-93/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-93$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-93
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-93 proxy object. All configs
