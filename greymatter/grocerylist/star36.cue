...
Star36: {
	...
	config: [
		...
		// Star36 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star36 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star36
		#catalog_entry & {
			name:                      Name
		...
		// Shared star36 proxy object. All configs
