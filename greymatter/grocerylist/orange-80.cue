...
Orange_80: {
	...
	config: [
		...
		// Orange_80 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_80 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-80/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-80$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-80
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-80 proxy object. All configs
