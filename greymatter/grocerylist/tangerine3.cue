...
Tangerine3: {
	...
	config: [
		...
		// Tangerine3 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine3 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine3/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine3$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine3
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine3 proxy object. All configs
