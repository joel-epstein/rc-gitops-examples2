...
Kiwi_985: {
	...
	config: [
		...
		// Kiwi_985 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_985 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_985/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_985$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_985
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_985 proxy object. All configs
