...
Kiwi_128: {
	...
	config: [
		...
		// Kiwi_128 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_128 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_128/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_128$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_128
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_128 proxy object. All configs
