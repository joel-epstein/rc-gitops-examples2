...
Kiwi_557: {
	...
	config: [
		...
		// Kiwi_557 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_557 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_557/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_557$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_557
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_557 proxy object. All configs
