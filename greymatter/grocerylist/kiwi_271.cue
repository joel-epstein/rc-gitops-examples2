...
Kiwi_271: {
	...
	config: [
		...
		// Kiwi_271 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_271 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_271/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_271$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_271
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_271 proxy object. All configs
