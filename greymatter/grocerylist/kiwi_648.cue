...
Kiwi_648: {
	...
	config: [
		...
		// Kiwi_648 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_648 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_648/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_648$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_648
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_648 proxy object. All configs
