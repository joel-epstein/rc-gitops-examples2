...
Kiwi_83: {
	...
	config: [
		...
		// Kiwi_83 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_83 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_83/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_83$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_83
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_83 proxy object. All configs
