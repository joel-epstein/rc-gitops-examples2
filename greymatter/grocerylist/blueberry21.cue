...
Blueberry21: {
	...
	config: [
		...
		// Blueberry21 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry21 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry21/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry21$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry21
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry21 proxy object. All configs
