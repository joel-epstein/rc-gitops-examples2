...
Cranberry39: {
	...
	config: [
		...
		// Cranberry39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry39
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry39 proxy object. All configs
