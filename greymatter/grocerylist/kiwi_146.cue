...
Kiwi_146: {
	...
	config: [
		...
		// Kiwi_146 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_146 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_146/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_146$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_146
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_146 proxy object. All configs
