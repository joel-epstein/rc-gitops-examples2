...
Cranberry36: {
	...
	config: [
		...
		// Cranberry36 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry36 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry36
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry36 proxy object. All configs
