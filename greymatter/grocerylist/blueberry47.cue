...
Blueberry47: {
	...
	config: [
		...
		// Blueberry47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry47
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry47 proxy object. All configs
