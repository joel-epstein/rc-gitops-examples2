...
Kiwi_101: {
	...
	config: [
		...
		// Kiwi_101 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_101 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_101/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_101$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_101
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_101 proxy object. All configs
