...
Kiwi_540: {
	...
	config: [
		...
		// Kiwi_540 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_540 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_540/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_540$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_540
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_540 proxy object. All configs
