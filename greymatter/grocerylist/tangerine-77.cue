...
Tangerine_77: {
	...
	config: [
		...
		// Tangerine_77 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_77 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-77/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-77$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-77
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-77 proxy object. All configs
