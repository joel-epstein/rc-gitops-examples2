...
Kiwi_303: {
	...
	config: [
		...
		// Kiwi_303 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_303 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_303/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_303$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_303
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_303 proxy object. All configs
