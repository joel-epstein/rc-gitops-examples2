...
Kiwi_994: {
	...
	config: [
		...
		// Kiwi_994 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_994 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_994/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_994$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_994
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_994 proxy object. All configs
