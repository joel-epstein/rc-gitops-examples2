...
Star15: {
	...
	config: [
		...
		// Star15 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star15 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star15/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star15$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star15
		#catalog_entry & {
			name:                      Name
		...
		// Shared star15 proxy object. All configs
