...
Kiwi_119: {
	...
	config: [
		...
		// Kiwi_119 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_119 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_119/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_119$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_119
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_119 proxy object. All configs
