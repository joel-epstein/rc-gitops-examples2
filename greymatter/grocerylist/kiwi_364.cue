...
Kiwi_364: {
	...
	config: [
		...
		// Kiwi_364 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_364 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_364/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_364$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_364
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_364 proxy object. All configs
