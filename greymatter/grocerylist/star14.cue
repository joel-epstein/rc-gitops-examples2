...
Star14: {
	...
	config: [
		...
		// Star14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star14
		#catalog_entry & {
			name:                      Name
		...
		// Shared star14 proxy object. All configs
