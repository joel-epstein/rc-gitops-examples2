...
Kiwi_955: {
	...
	config: [
		...
		// Kiwi_955 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_955 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_955/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_955$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_955
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_955 proxy object. All configs
