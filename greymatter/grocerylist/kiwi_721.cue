...
Kiwi_721: {
	...
	config: [
		...
		// Kiwi_721 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_721 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_721/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_721$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_721
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_721 proxy object. All configs
