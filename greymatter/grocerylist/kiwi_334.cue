...
Kiwi_334: {
	...
	config: [
		...
		// Kiwi_334 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_334 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_334/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_334$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_334
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_334 proxy object. All configs
