...
Kiwi_679: {
	...
	config: [
		...
		// Kiwi_679 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_679 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_679/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_679$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_679
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_679 proxy object. All configs
