...
Orange_66: {
	...
	config: [
		...
		// Orange_66 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_66 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-66/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-66$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-66
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-66 proxy object. All configs
