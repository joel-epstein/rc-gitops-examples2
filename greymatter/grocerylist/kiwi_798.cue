...
Kiwi_798: {
	...
	config: [
		...
		// Kiwi_798 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_798 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_798/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_798$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_798
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_798 proxy object. All configs
