...
Kiwi_879: {
	...
	config: [
		...
		// Kiwi_879 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_879 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_879/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_879$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_879
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_879 proxy object. All configs
