...
Tangerine_15: {
	...
	config: [
		...
		// Tangerine_15 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_15 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-15/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-15$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-15
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-15 proxy object. All configs
