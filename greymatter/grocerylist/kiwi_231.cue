...
Kiwi_231: {
	...
	config: [
		...
		// Kiwi_231 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_231 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_231/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_231$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_231
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_231 proxy object. All configs
