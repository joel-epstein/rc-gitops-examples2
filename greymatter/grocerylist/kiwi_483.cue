...
Kiwi_483: {
	...
	config: [
		...
		// Kiwi_483 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_483 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_483/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_483$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_483
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_483 proxy object. All configs
