...
Kiwi_947: {
	...
	config: [
		...
		// Kiwi_947 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_947 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_947/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_947$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_947
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_947 proxy object. All configs
