...
Kiwi73: {
	...
	config: [
		...
		// Kiwi73 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi73/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi73$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi73
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi73 proxy object. All configs
