...
Kiwi_66: {
	...
	config: [
		...
		// Kiwi_66 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_66 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_66/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_66$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_66
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_66 proxy object. All configs
