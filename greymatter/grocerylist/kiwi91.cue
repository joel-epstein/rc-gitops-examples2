...
Kiwi91: {
	...
	config: [
		...
		// Kiwi91 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi91 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi91/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi91$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi91
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi91 proxy object. All configs
