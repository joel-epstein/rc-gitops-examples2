...
Kiwi_466: {
	...
	config: [
		...
		// Kiwi_466 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_466 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_466/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_466$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_466
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_466 proxy object. All configs
