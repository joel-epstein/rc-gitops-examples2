...
Kiwi_456: {
	...
	config: [
		...
		// Kiwi_456 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_456 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_456/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_456$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_456
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_456 proxy object. All configs
