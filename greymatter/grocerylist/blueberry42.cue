...
Blueberry42: {
	...
	config: [
		...
		// Blueberry42 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry42 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry42/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry42$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry42
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry42 proxy object. All configs
