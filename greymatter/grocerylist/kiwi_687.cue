...
Kiwi_687: {
	...
	config: [
		...
		// Kiwi_687 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_687 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_687/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_687$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_687
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_687 proxy object. All configs
