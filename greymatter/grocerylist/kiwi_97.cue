...
Kiwi_97: {
	...
	config: [
		...
		// Kiwi_97 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_97 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_97/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_97$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_97
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_97 proxy object. All configs
