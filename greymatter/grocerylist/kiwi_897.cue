...
Kiwi_897: {
	...
	config: [
		...
		// Kiwi_897 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_897 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_897/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_897$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_897
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_897 proxy object. All configs
