...
Kiwi_562: {
	...
	config: [
		...
		// Kiwi_562 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_562 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_562/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_562$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_562
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_562 proxy object. All configs
