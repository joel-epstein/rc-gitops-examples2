...
Kiwi_113: {
	...
	config: [
		...
		// Kiwi_113 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_113 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_113/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_113$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_113
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_113 proxy object. All configs
