...
Kiwi_493: {
	...
	config: [
		...
		// Kiwi_493 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_493 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_493/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_493$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_493
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_493 proxy object. All configs
