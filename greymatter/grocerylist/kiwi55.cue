...
Kiwi55: {
	...
	config: [
		...
		// Kiwi55 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi55/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi55$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi55
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi55 proxy object. All configs
