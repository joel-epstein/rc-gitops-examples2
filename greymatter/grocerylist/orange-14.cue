...
Orange_14: {
	...
	config: [
		...
		// Orange_14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-14
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-14 proxy object. All configs
