...
Kiwi_533: {
	...
	config: [
		...
		// Kiwi_533 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_533 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_533/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_533$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_533
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_533 proxy object. All configs
