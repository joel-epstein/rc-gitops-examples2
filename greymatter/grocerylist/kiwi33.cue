...
Kiwi33: {
	...
	config: [
		...
		// Kiwi33 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi33
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi33 proxy object. All configs
