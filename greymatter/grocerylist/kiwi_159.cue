...
Kiwi_159: {
	...
	config: [
		...
		// Kiwi_159 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_159 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_159/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_159$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_159
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_159 proxy object. All configs
