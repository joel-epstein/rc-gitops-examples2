...
Kiwi_438: {
	...
	config: [
		...
		// Kiwi_438 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_438 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_438/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_438$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_438
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_438 proxy object. All configs
