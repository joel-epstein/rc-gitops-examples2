...
Kiwi87: {
	...
	config: [
		...
		// Kiwi87 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi87/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi87$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi87
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi87 proxy object. All configs
