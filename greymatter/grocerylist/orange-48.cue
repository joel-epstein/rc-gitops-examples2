...
Orange_48: {
	...
	config: [
		...
		// Orange_48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-48
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-48 proxy object. All configs
