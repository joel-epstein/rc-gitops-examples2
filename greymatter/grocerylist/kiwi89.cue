...
Kiwi89: {
	...
	config: [
		...
		// Kiwi89 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi89 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi89/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi89$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi89
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi89 proxy object. All configs
