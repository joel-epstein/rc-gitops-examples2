...
Kiwi28: {
	...
	config: [
		...
		// Kiwi28 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi28 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi28
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi28 proxy object. All configs
