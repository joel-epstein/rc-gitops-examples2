...
Kiwi_669: {
	...
	config: [
		...
		// Kiwi_669 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_669 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_669/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_669$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_669
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_669 proxy object. All configs
