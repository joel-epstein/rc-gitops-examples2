...
Kiwi_766: {
	...
	config: [
		...
		// Kiwi_766 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_766 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_766/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_766$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_766
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_766 proxy object. All configs
