...
Blueberry_26: {
	...
	config: [
		...
		// Blueberry_26 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_26 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-26/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-26$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-26
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-26 proxy object. All configs
