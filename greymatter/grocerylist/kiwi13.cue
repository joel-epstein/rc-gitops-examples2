...
Kiwi13: {
	...
	config: [
		...
		// Kiwi13 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi13
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi13 proxy object. All configs
