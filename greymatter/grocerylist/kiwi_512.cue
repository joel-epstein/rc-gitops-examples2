...
Kiwi_512: {
	...
	config: [
		...
		// Kiwi_512 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_512 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_512/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_512$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_512
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_512 proxy object. All configs
