...
Melon_13: {
	...
	config: [
		...
		// Melon_13 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_13 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-13
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-13 proxy object. All configs
