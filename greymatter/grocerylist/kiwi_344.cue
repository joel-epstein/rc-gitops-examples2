...
Kiwi_344: {
	...
	config: [
		...
		// Kiwi_344 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_344 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_344/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_344$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_344
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_344 proxy object. All configs
