...
Blueberry_51: {
	...
	config: [
		...
		// Blueberry_51 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_51 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-51/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-51$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-51
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-51 proxy object. All configs
