...
Kiwi_795: {
	...
	config: [
		...
		// Kiwi_795 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_795 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_795/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_795$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_795
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_795 proxy object. All configs
