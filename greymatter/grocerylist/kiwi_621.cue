...
Kiwi_621: {
	...
	config: [
		...
		// Kiwi_621 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_621 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_621/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_621$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_621
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_621 proxy object. All configs
