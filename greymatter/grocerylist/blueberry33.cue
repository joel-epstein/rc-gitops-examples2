...
Blueberry33: {
	...
	config: [
		...
		// Blueberry33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry33
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry33 proxy object. All configs
