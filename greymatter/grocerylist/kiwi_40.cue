...
Kiwi_40: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_40/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_40$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_40
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_40 proxy object. All configs
