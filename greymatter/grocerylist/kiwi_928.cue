...
Kiwi_928: {
	...
	config: [
		...
		// Kiwi_928 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_928 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_928/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_928$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_928
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_928 proxy object. All configs
