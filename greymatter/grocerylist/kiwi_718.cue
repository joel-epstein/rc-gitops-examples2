...
Kiwi_718: {
	...
	config: [
		...
		// Kiwi_718 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_718 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_718/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_718$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_718
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_718 proxy object. All configs
