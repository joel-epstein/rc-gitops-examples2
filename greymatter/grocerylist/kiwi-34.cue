...
Kiwi_34: {
	...
	config: [
		...
		// Kiwi_34 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_34 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-34
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-34 proxy object. All configs
