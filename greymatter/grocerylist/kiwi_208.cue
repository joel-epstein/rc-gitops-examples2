...
Kiwi_208: {
	...
	config: [
		...
		// Kiwi_208 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_208 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_208/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_208$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_208
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_208 proxy object. All configs
