...
Kiwi_236: {
	...
	config: [
		...
		// Kiwi_236 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_236 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_236/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_236$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_236
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_236 proxy object. All configs
