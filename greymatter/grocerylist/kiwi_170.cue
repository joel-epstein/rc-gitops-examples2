...
Kiwi_170: {
	...
	config: [
		...
		// Kiwi_170 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_170 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_170/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_170$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_170
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_170 proxy object. All configs
