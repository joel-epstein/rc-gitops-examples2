...
Kiwi_515: {
	...
	config: [
		...
		// Kiwi_515 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_515 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_515/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_515$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_515
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_515 proxy object. All configs
