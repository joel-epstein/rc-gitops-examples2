...
Kiwi_245: {
	...
	config: [
		...
		// Kiwi_245 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_245 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_245/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_245$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_245
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_245 proxy object. All configs
