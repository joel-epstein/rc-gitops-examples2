...
Star12: {
	...
	config: [
		...
		// Star12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star12
		#catalog_entry & {
			name:                      Name
		...
		// Shared star12 proxy object. All configs
