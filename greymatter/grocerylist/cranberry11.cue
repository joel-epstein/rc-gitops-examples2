...
Cranberry11: {
	...
	config: [
		...
		// Cranberry11 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry11 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry11/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry11$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry11
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry11 proxy object. All configs
