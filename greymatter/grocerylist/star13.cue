...
Star13: {
	...
	config: [
		...
		// Star13 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star13 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star13
		#catalog_entry & {
			name:                      Name
		...
		// Shared star13 proxy object. All configs
