...
Tangerine_32: {
	...
	config: [
		...
		// Tangerine_32 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_32 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-32/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-32$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-32
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-32 proxy object. All configs
