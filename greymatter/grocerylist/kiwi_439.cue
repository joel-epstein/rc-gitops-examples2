...
Kiwi_439: {
	...
	config: [
		...
		// Kiwi_439 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_439 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_439/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_439$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_439
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_439 proxy object. All configs
