...
Melon_62: {
	...
	config: [
		...
		// Melon_62 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_62 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-62/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-62$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-62
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-62 proxy object. All configs
