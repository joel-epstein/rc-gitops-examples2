...
Kiwi12: {
	...
	config: [
		...
		// Kiwi12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi12
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi12 proxy object. All configs
