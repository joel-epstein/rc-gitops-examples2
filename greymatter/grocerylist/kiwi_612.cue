...
Kiwi_612: {
	...
	config: [
		...
		// Kiwi_612 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_612 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_612/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_612$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_612
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_612 proxy object. All configs
