...
Kiwi_109: {
	...
	config: [
		...
		// Kiwi_109 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_109 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_109/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_109$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_109
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_109 proxy object. All configs
