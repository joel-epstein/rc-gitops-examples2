...
Kiwi_686: {
	...
	config: [
		...
		// Kiwi_686 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_686 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_686/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_686$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_686
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_686 proxy object. All configs
