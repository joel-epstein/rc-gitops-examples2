...
Star42: {
	...
	config: [
		...
		// Star42 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star42 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star42/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star42$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star42
		#catalog_entry & {
			name:                      Name
		...
		// Shared star42 proxy object. All configs
