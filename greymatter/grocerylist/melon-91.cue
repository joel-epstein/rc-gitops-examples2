...
Melon_91: {
	...
	config: [
		...
		// Melon_91 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_91 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-91/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-91$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-91
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-91 proxy object. All configs
