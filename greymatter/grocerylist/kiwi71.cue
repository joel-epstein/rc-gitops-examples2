...
Kiwi71: {
	...
	config: [
		...
		// Kiwi71 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi71 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi71/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi71$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi71
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi71 proxy object. All configs
