...
Kiwi_393: {
	...
	config: [
		...
		// Kiwi_393 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_393 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_393/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_393$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_393
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_393 proxy object. All configs
