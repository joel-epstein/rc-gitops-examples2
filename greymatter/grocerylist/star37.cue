...
Star37: {
	...
	config: [
		...
		// Star37 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star37 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star37/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star37$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star37
		#catalog_entry & {
			name:                      Name
		...
		// Shared star37 proxy object. All configs
