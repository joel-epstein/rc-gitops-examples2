...
Kiwi_933: {
	...
	config: [
		...
		// Kiwi_933 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_933 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_933/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_933$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_933
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_933 proxy object. All configs
