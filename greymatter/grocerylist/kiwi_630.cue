...
Kiwi_630: {
	...
	config: [
		...
		// Kiwi_630 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_630 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_630/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_630$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_630
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_630 proxy object. All configs
