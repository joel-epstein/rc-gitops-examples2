...
Grape_46: {
	...
	config: [
		...
		// Grape_46 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_46 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-46
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-46 proxy object. All configs
