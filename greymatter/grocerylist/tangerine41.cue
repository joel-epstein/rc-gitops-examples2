...
Tangerine41: {
	...
	config: [
		...
		// Tangerine41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine41
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine41 proxy object. All configs
