...
Kiwi_851: {
	...
	config: [
		...
		// Kiwi_851 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_851 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_851/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_851$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_851
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_851 proxy object. All configs
