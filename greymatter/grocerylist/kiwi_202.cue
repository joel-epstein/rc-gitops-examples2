...
Kiwi_202: {
	...
	config: [
		...
		// Kiwi_202 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_202 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_202/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_202$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_202
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_202 proxy object. All configs
