...
Kiwi_468: {
	...
	config: [
		...
		// Kiwi_468 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_468 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_468/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_468$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_468
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_468 proxy object. All configs
