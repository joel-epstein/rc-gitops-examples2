...
Kiwi_259: {
	...
	config: [
		...
		// Kiwi_259 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_259 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_259/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_259$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_259
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_259 proxy object. All configs
