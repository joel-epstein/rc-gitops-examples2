...
Kiwi_337: {
	...
	config: [
		...
		// Kiwi_337 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_337 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_337/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_337$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_337
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_337 proxy object. All configs
