...
Kiwi_804: {
	...
	config: [
		...
		// Kiwi_804 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_804 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_804/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_804$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_804
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_804 proxy object. All configs
