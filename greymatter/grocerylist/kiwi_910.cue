...
Kiwi_910: {
	...
	config: [
		...
		// Kiwi_910 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_910 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_910/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_910$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_910
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_910 proxy object. All configs
