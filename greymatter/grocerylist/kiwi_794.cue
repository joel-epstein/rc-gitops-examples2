...
Kiwi_794: {
	...
	config: [
		...
		// Kiwi_794 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_794 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_794/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_794$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_794
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_794 proxy object. All configs
