...
Orange_25: {
	...
	config: [
		...
		// Orange_25 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_25 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-25/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-25$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-25
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-25 proxy object. All configs
