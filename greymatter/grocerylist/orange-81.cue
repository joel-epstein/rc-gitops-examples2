...
Orange_81: {
	...
	config: [
		...
		// Orange_81 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_81 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-81/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-81$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-81
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-81 proxy object. All configs
