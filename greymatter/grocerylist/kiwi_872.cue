...
Kiwi_872: {
	...
	config: [
		...
		// Kiwi_872 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_872 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_872/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_872$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_872
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_872 proxy object. All configs
