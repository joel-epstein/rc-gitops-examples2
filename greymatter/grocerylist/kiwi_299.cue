...
Kiwi_299: {
	...
	config: [
		...
		// Kiwi_299 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_299 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_299/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_299$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_299
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_299 proxy object. All configs
