...
Kiwi_688: {
	...
	config: [
		...
		// Kiwi_688 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_688 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_688/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_688$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_688
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_688 proxy object. All configs
