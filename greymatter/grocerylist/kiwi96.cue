...
Kiwi96: {
	...
	config: [
		...
		// Kiwi96 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi96/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi96$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi96
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi96 proxy object. All configs
