...
Kiwi_675: {
	...
	config: [
		...
		// Kiwi_675 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_675 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_675/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_675$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_675
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_675 proxy object. All configs
