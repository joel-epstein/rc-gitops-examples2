...
Kiwi_681: {
	...
	config: [
		...
		// Kiwi_681 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_681 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_681/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_681$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_681
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_681 proxy object. All configs
