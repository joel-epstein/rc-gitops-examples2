...
Kiwi_252: {
	...
	config: [
		...
		// Kiwi_252 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_252 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_252/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_252$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_252
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_252 proxy object. All configs
