...
Kiwi_291: {
	...
	config: [
		...
		// Kiwi_291 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_291 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_291/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_291$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_291
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_291 proxy object. All configs
