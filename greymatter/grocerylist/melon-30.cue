...
Melon_30: {
	...
	config: [
		...
		// Melon_30 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_30 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-30/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-30$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-30
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-30 proxy object. All configs
