...
Blueberry_15: {
	...
	config: [
		...
		// Blueberry_15 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_15 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-15/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-15$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-15
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-15 proxy object. All configs
