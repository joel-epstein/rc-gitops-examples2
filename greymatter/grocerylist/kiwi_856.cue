...
Kiwi_856: {
	...
	config: [
		...
		// Kiwi_856 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_856 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_856/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_856$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_856
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_856 proxy object. All configs
