...
Cranberry23: {
	...
	config: [
		...
		// Cranberry23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry23
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry23 proxy object. All configs
