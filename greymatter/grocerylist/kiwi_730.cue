...
Kiwi_730: {
	...
	config: [
		...
		// Kiwi_730 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_730 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_730/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_730$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_730
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_730 proxy object. All configs
