...
Kiwi_210: {
	...
	config: [
		...
		// Kiwi_210 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_210 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_210/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_210$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_210
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_210 proxy object. All configs
