...
Tangerine19: {
	...
	config: [
		...
		// Tangerine19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine19
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine19 proxy object. All configs
