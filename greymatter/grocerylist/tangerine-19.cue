...
Tangerine_19: {
	...
	config: [
		...
		// Tangerine_19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-19
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-19 proxy object. All configs
