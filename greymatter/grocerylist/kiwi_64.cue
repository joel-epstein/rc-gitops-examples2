...
Kiwi_64: {
	...
	config: [
		...
		// Kiwi_64 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_64 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_64/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_64$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_64
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_64 proxy object. All configs
