...
Kiwi_125: {
	...
	config: [
		...
		// Kiwi_125 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_125 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_125/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_125$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_125
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_125 proxy object. All configs
