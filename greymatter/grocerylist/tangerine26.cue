...
Tangerine26: {
	...
	config: [
		...
		// Tangerine26 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine26 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine26/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine26$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine26
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine26 proxy object. All configs
