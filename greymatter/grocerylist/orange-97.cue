...
Orange_97: {
	...
	config: [
		...
		// Orange_97 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_97 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-97/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-97$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-97
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-97 proxy object. All configs
