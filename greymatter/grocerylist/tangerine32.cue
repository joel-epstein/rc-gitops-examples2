...
Tangerine32: {
	...
	config: [
		...
		// Tangerine32 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine32 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine32/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine32$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine32
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine32 proxy object. All configs
