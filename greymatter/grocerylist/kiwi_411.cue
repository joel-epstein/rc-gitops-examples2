...
Kiwi_411: {
	...
	config: [
		...
		// Kiwi_411 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_411 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_411/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_411$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_411
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_411 proxy object. All configs
