...
Melon_22: {
	...
	config: [
		...
		// Melon_22 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_22 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-22
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-22 proxy object. All configs
