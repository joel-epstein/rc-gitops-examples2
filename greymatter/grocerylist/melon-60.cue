...
Melon_60: {
	...
	config: [
		...
		// Melon_60 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_60 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-60/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-60$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-60
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-60 proxy object. All configs
