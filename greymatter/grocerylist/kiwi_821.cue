...
Kiwi_821: {
	...
	config: [
		...
		// Kiwi_821 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_821 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_821/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_821$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_821
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_821 proxy object. All configs
