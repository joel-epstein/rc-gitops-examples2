...
Kiwi_896: {
	...
	config: [
		...
		// Kiwi_896 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_896 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_896/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_896$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_896
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_896 proxy object. All configs
