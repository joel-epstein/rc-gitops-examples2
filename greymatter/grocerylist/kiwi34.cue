...
Kiwi34: {
	...
	config: [
		...
		// Kiwi34 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi34 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi34
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi34 proxy object. All configs
