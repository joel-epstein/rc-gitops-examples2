...
Kiwi_455: {
	...
	config: [
		...
		// Kiwi_455 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_455 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_455/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_455$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_455
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_455 proxy object. All configs
