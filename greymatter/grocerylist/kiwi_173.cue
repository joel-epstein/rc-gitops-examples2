...
Kiwi_173: {
	...
	config: [
		...
		// Kiwi_173 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_173 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_173/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_173$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_173
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_173 proxy object. All configs
