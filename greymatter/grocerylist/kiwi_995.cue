...
Kiwi_995: {
	...
	config: [
		...
		// Kiwi_995 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_995 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_995/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_995$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_995
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_995 proxy object. All configs
