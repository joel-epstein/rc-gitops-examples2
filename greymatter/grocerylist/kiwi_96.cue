...
Kiwi_96: {
	...
	config: [
		...
		// Kiwi_96 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_96 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_96/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_96$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_96
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_96 proxy object. All configs
