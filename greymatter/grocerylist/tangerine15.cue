...
Tangerine15: {
	...
	config: [
		...
		// Tangerine15 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine15 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine15/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine15$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine15
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine15 proxy object. All configs
