...
Kiwi23: {
	...
	config: [
		...
		// Kiwi23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi23
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi23 proxy object. All configs
