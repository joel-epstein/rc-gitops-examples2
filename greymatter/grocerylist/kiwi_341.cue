...
Kiwi_341: {
	...
	config: [
		...
		// Kiwi_341 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_341 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_341/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_341$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_341
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_341 proxy object. All configs
