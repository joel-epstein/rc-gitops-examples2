...
Kiwi3: {
	...
	config: [
		...
		// Kiwi3 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi3/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi3$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi3
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi3 proxy object. All configs
