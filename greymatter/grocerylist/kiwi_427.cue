...
Kiwi_427: {
	...
	config: [
		...
		// Kiwi_427 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_427 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_427/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_427$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_427
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_427 proxy object. All configs
