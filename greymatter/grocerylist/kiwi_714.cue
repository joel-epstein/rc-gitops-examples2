...
Kiwi_714: {
	...
	config: [
		...
		// Kiwi_714 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_714 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_714/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_714$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_714
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_714 proxy object. All configs
