...
Kiwi_818: {
	...
	config: [
		...
		// Kiwi_818 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_818 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_818/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_818$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_818
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_818 proxy object. All configs
