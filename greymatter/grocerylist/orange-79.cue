...
Orange_79: {
	...
	config: [
		...
		// Orange_79 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_79 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-79/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-79$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-79
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-79 proxy object. All configs
