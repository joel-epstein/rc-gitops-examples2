...
Kiwi_472: {
	...
	config: [
		...
		// Kiwi_472 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_472 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_472/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_472$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_472
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_472 proxy object. All configs
