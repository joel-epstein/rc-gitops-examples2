...
Blueberry23: {
	...
	config: [
		...
		// Blueberry23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry23
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry23 proxy object. All configs
