...
Kiwi_961: {
	...
	config: [
		...
		// Kiwi_961 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_961 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_961/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_961$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_961
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_961 proxy object. All configs
