...
Kiwi_885: {
	...
	config: [
		...
		// Kiwi_885 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_885 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_885/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_885$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_885
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_885 proxy object. All configs
