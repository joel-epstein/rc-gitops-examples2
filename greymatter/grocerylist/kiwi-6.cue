...
Kiwi_6: {
	...
	config: [
		...
		// Kiwi_6 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_6 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-6/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-6$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-6
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-6 proxy object. All configs
