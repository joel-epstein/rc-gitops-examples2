...
Kiwi_884: {
	...
	config: [
		...
		// Kiwi_884 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_884 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_884/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_884$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_884
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_884 proxy object. All configs
