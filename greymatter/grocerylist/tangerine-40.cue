...
Tangerine_40: {
	...
	config: [
		...
		// Tangerine_40 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_40 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-40/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-40$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-40
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-40 proxy object. All configs
