...
Kiwi_46: {
	...
	config: [
		...
		// Kiwi_46 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_46 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-46
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-46 proxy object. All configs
