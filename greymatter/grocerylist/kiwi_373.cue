...
Kiwi_373: {
	...
	config: [
		...
		// Kiwi_373 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_373 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_373/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_373$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_373
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_373 proxy object. All configs
