...
Kiwi_357: {
	...
	config: [
		...
		// Kiwi_357 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_357 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_357/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_357$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_357
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_357 proxy object. All configs
