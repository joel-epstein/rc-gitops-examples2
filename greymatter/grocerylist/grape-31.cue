...
Grape_31: {
	...
	config: [
		...
		// Grape_31 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_31 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-31/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-31$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-31
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-31 proxy object. All configs
