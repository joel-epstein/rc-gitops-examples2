...
Melon_66: {
	...
	config: [
		...
		// Melon_66 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_66 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-66/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-66$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-66
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-66 proxy object. All configs
