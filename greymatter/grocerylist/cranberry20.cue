...
Cranberry20: {
	...
	config: [
		...
		// Cranberry20 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry20 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry20/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry20$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry20
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry20 proxy object. All configs
