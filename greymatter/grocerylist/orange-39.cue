...
Orange_39: {
	...
	config: [
		...
		// Orange_39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-39
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-39 proxy object. All configs
