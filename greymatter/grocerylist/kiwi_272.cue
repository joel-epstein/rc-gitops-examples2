...
Kiwi_272: {
	...
	config: [
		...
		// Kiwi_272 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_272 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_272/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_272$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_272
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_272 proxy object. All configs
