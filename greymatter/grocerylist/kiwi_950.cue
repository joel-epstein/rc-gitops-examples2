...
Kiwi_950: {
	...
	config: [
		...
		// Kiwi_950 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_950 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_950/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_950$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_950
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_950 proxy object. All configs
