...
Kiwi_100: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_100/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_100$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_100
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_100 proxy object. All configs
