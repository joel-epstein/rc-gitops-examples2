...
Melon_71: {
	...
	config: [
		...
		// Melon_71 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_71 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-71/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-71$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-71
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-71 proxy object. All configs
