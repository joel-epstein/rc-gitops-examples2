...
Kiwi93: {
	...
	config: [
		...
		// Kiwi93 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi93/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi93$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi93
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi93 proxy object. All configs
