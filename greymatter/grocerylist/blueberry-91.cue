...
Blueberry_91: {
	...
	config: [
		...
		// Blueberry_91 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_91 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-91/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-91$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-91
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-91 proxy object. All configs
