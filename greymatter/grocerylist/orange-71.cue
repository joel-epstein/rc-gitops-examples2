...
Orange_71: {
	...
	config: [
		...
		// Orange_71 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_71 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-71/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-71$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-71
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-71 proxy object. All configs
