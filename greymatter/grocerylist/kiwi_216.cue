...
Kiwi_216: {
	...
	config: [
		...
		// Kiwi_216 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_216 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_216/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_216$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_216
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_216 proxy object. All configs
