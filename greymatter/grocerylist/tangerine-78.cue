...
Tangerine_78: {
	...
	config: [
		...
		// Tangerine_78 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_78 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-78/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-78$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-78
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-78 proxy object. All configs
