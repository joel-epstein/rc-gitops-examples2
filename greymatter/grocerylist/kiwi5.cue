...
Kiwi5: {
	...
	config: [
		...
		// Kiwi5 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi5/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi5$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi5
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi5 proxy object. All configs
