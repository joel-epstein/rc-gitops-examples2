...
Kiwi_665: {
	...
	config: [
		...
		// Kiwi_665 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_665 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_665/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_665$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_665
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_665 proxy object. All configs
