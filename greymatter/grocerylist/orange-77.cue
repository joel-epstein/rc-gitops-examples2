...
Orange_77: {
	...
	config: [
		...
		// Orange_77 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_77 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-77/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-77$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-77
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-77 proxy object. All configs
