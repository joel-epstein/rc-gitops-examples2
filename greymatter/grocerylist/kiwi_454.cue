...
Kiwi_454: {
	...
	config: [
		...
		// Kiwi_454 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_454 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_454/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_454$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_454
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_454 proxy object. All configs
