...
Tangerine_33: {
	...
	config: [
		...
		// Tangerine_33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-33
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-33 proxy object. All configs
