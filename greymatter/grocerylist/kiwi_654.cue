...
Kiwi_654: {
	...
	config: [
		...
		// Kiwi_654 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_654 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_654/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_654$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_654
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_654 proxy object. All configs
