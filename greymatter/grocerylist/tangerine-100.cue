...
Tangerine_100: {
	...
	config: [
		...
		// Tangerine_100 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_100 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-100/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-100$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-100
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-100 proxy object. All configs
