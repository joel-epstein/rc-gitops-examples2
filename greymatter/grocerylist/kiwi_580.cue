...
Kiwi_580: {
	...
	config: [
		...
		// Kiwi_580 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_580 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_580/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_580$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_580
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_580 proxy object. All configs
