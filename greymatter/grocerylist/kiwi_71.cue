...
Kiwi_71: {
	...
	config: [
		...
		// Kiwi_71 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_71 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_71/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_71$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_71
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_71 proxy object. All configs
