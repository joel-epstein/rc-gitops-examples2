...
Kiwi_823: {
	...
	config: [
		...
		// Kiwi_823 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_823 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_823/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_823$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_823
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_823 proxy object. All configs
