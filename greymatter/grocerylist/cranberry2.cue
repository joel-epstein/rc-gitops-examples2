...
Cranberry2: {
	...
	config: [
		...
		// Cranberry2 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry2 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry2/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry2$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry2
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry2 proxy object. All configs
