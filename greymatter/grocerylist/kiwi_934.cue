...
Kiwi_934: {
	...
	config: [
		...
		// Kiwi_934 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_934 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_934/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_934$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_934
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_934 proxy object. All configs
