...
Grape_19: {
	...
	config: [
		...
		// Grape_19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-19
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-19 proxy object. All configs
