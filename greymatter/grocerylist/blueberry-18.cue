...
Blueberry_18: {
	...
	config: [
		...
		// Blueberry_18 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_18 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-18/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-18$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-18
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-18 proxy object. All configs
