...
Kiwi_152: {
	...
	config: [
		...
		// Kiwi_152 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_152 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_152/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_152$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_152
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_152 proxy object. All configs
