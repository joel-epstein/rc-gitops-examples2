...
Kiwi_960: {
	...
	config: [
		...
		// Kiwi_960 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_960 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_960/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_960$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_960
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_960 proxy object. All configs
