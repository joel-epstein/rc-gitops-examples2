...
Kiwi_558: {
	...
	config: [
		...
		// Kiwi_558 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_558 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_558/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_558$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_558
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_558 proxy object. All configs
