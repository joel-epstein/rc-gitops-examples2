...
Kiwi_487: {
	...
	config: [
		...
		// Kiwi_487 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_487 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_487/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_487$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_487
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_487 proxy object. All configs
