...
Kiwi_847: {
	...
	config: [
		...
		// Kiwi_847 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_847 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_847/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_847$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_847
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_847 proxy object. All configs
