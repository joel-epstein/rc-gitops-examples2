...
Orange_95: {
	...
	config: [
		...
		// Orange_95 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_95 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-95/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-95$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-95
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-95 proxy object. All configs
