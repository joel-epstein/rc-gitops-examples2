...
Melon49: {
	...
	config: [
		...
		// Melon49 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon49 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon49/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon49$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon49
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon49 proxy object. All configs
