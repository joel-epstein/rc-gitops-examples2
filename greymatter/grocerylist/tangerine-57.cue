...
Tangerine_57: {
	...
	config: [
		...
		// Tangerine_57 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_57 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-57/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-57$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-57
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-57 proxy object. All configs
