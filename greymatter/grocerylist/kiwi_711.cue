...
Kiwi_711: {
	...
	config: [
		...
		// Kiwi_711 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_711 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_711/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_711$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_711
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_711 proxy object. All configs
