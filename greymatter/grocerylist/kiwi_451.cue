...
Kiwi_451: {
	...
	config: [
		...
		// Kiwi_451 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_451 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_451/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_451$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_451
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_451 proxy object. All configs
