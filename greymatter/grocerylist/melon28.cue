...
Melon28: {
	...
	config: [
		...
		// Melon28 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon28 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon28
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon28 proxy object. All configs
