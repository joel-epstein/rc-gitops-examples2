...
Blueberry22: {
	...
	config: [
		...
		// Blueberry22 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry22 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry22
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry22 proxy object. All configs
