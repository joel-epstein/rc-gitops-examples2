...
Blueberry_29: {
	...
	config: [
		...
		// Blueberry_29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-29
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-29 proxy object. All configs
