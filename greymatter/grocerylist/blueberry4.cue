...
Blueberry4: {
	...
	config: [
		...
		// Blueberry4 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry4 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry4/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry4$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry4
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry4 proxy object. All configs
