...
Kiwi_209: {
	...
	config: [
		...
		// Kiwi_209 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_209 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_209/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_209$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_209
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_209 proxy object. All configs
