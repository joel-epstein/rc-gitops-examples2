...
Melon13: {
	...
	config: [
		...
		// Melon13 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon13 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon13
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon13 proxy object. All configs
