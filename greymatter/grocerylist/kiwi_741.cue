...
Kiwi_741: {
	...
	config: [
		...
		// Kiwi_741 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_741 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_741/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_741$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_741
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_741 proxy object. All configs
