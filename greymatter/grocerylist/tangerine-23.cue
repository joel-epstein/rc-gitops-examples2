...
Tangerine_23: {
	...
	config: [
		...
		// Tangerine_23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-23
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-23 proxy object. All configs
