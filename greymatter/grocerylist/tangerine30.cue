...
Tangerine30: {
	...
	config: [
		...
		// Tangerine30 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine30 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine30/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine30$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine30
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine30 proxy object. All configs
