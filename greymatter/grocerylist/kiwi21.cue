...
Kiwi21: {
	...
	config: [
		...
		// Kiwi21 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi21/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi21$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi21
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi21 proxy object. All configs
