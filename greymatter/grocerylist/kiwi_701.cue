...
Kiwi_701: {
	...
	config: [
		...
		// Kiwi_701 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_701 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_701/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_701$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_701
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_701 proxy object. All configs
