...
Melon_51: {
	...
	config: [
		...
		// Melon_51 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_51 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-51/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-51$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-51
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-51 proxy object. All configs
