...
Melon_87: {
	...
	config: [
		...
		// Melon_87 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_87 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-87/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-87$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-87
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-87 proxy object. All configs
