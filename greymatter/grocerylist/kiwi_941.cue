...
Kiwi_941: {
	...
	config: [
		...
		// Kiwi_941 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_941 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_941/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_941$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_941
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_941 proxy object. All configs
