...
Tangerine40: {
	...
	config: [
		...
		// Tangerine40 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine40 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine40/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine40$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine40
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine40 proxy object. All configs
