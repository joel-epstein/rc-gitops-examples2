...
Kiwi_375: {
	...
	config: [
		...
		// Kiwi_375 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_375 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_375/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_375$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_375
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_375 proxy object. All configs
