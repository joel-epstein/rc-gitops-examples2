...
Tangerine_65: {
	...
	config: [
		...
		// Tangerine_65 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_65 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-65/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-65$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-65
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-65 proxy object. All configs
