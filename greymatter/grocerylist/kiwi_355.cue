...
Kiwi_355: {
	...
	config: [
		...
		// Kiwi_355 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_355 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_355/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_355$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_355
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_355 proxy object. All configs
