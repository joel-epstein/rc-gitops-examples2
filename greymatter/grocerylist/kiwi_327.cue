...
Kiwi_327: {
	...
	config: [
		...
		// Kiwi_327 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_327 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_327/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_327$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_327
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_327 proxy object. All configs
