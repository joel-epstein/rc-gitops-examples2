...
Kiwi49: {
	...
	config: [
		...
		// Kiwi49 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi49 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi49/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi49$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi49
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi49 proxy object. All configs
