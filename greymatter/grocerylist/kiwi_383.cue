...
Kiwi_383: {
	...
	config: [
		...
		// Kiwi_383 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_383 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_383/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_383$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_383
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_383 proxy object. All configs
