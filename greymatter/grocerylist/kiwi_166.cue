...
Kiwi_166: {
	...
	config: [
		...
		// Kiwi_166 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_166 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_166/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_166$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_166
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_166 proxy object. All configs
