...
Kiwi_44: {
	...
	config: [
		...
		// Kiwi_44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-44
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-44 proxy object. All configs
