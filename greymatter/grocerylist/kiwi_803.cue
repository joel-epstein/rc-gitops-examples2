...
Kiwi_803: {
	...
	config: [
		...
		// Kiwi_803 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_803 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_803/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_803$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_803
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_803 proxy object. All configs
