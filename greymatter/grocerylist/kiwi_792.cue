...
Kiwi_792: {
	...
	config: [
		...
		// Kiwi_792 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_792 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_792/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_792$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_792
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_792 proxy object. All configs
