...
Melon_19: {
	...
	config: [
		...
		// Melon_19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-19
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-19 proxy object. All configs
