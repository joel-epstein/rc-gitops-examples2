...
Kiwi_183: {
	...
	config: [
		...
		// Kiwi_183 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_183 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_183/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_183$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_183
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_183 proxy object. All configs
