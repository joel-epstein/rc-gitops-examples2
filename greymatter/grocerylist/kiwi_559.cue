...
Kiwi_559: {
	...
	config: [
		...
		// Kiwi_559 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_559 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_559/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_559$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_559
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_559 proxy object. All configs
