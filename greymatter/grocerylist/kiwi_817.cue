...
Kiwi_817: {
	...
	config: [
		...
		// Kiwi_817 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_817 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_817/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_817$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_817
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_817 proxy object. All configs
