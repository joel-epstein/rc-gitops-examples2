...
Kiwi_636: {
	...
	config: [
		...
		// Kiwi_636 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_636 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_636/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_636$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_636
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_636 proxy object. All configs
