...
Kiwi_942: {
	...
	config: [
		...
		// Kiwi_942 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_942 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_942/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_942$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_942
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_942 proxy object. All configs
