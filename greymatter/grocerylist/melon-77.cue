...
Melon_77: {
	...
	config: [
		...
		// Melon_77 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_77 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-77/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-77$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-77
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-77 proxy object. All configs
