...
Kiwi_115: {
	...
	config: [
		...
		// Kiwi_115 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_115 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_115/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_115$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_115
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_115 proxy object. All configs
