...
Blueberry1: {
	...
	config: [
		...
		// Blueberry1 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry1 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry1/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry1$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry1
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry1 proxy object. All configs
