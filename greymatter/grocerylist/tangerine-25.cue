...
Tangerine_25: {
	...
	config: [
		...
		// Tangerine_25 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_25 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-25/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-25$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-25
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-25 proxy object. All configs
