...
Tangerine48: {
	...
	config: [
		...
		// Tangerine48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine48
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine48 proxy object. All configs
