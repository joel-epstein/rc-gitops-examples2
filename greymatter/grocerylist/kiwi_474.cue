...
Kiwi_474: {
	...
	config: [
		...
		// Kiwi_474 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_474 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_474/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_474$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_474
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_474 proxy object. All configs
