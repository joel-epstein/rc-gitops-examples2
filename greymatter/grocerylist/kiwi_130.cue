...
Kiwi_130: {
	...
	config: [
		...
		// Kiwi_130 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_130 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_130/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_130$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_130
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_130 proxy object. All configs
