...
Kiwi_820: {
	...
	config: [
		...
		// Kiwi_820 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_820 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_820/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_820$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_820
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_820 proxy object. All configs
