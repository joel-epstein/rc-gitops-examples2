...
Kiwi_583: {
	...
	config: [
		...
		// Kiwi_583 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_583 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_583/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_583$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_583
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_583 proxy object. All configs
