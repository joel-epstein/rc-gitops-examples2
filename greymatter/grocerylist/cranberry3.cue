...
Cranberry3: {
	...
	config: [
		...
		// Cranberry3 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry3 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry3/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry3$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry3
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry3 proxy object. All configs
