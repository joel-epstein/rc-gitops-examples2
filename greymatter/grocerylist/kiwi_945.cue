...
Kiwi_945: {
	...
	config: [
		...
		// Kiwi_945 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_945 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_945/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_945$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_945
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_945 proxy object. All configs
