...
Star44: {
	...
	config: [
		...
		// Star44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star44
		#catalog_entry & {
			name:                      Name
		...
		// Shared star44 proxy object. All configs
