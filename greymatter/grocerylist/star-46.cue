...
Star_46: {
	...
	config: [
		...
		// Star_46 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_46 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-46
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-46 proxy object. All configs
