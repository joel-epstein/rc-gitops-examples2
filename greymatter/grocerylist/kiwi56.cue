...
Kiwi56: {
	...
	config: [
		...
		// Kiwi56 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi56/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi56$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi56
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi56 proxy object. All configs
