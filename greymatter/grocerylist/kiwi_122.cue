...
Kiwi_122: {
	...
	config: [
		...
		// Kiwi_122 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_122 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_122/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_122$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_122
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_122 proxy object. All configs
