...
Kiwi_388: {
	...
	config: [
		...
		// Kiwi_388 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_388 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_388/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_388$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_388
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_388 proxy object. All configs
