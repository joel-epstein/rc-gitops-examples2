...
Kiwi_85: {
	...
	config: [
		...
		// Kiwi_85 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_85 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_85/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_85$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_85
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_85 proxy object. All configs
