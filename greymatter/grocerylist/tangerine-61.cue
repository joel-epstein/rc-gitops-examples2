...
Tangerine_61: {
	...
	config: [
		...
		// Tangerine_61 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_61 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-61/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-61$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-61
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-61 proxy object. All configs
