...
Kiwi_262: {
	...
	config: [
		...
		// Kiwi_262 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_262 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_262/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_262$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_262
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_262 proxy object. All configs
