...
Grape_70: {
	...
	config: [
		...
		// Grape_70 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_70 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-70/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-70$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-70
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-70 proxy object. All configs
