...
Kiwi_727: {
	...
	config: [
		...
		// Kiwi_727 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_727 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_727/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_727$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_727
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_727 proxy object. All configs
