...
Tangerine45: {
	...
	config: [
		...
		// Tangerine45 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine45 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine45/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine45$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine45
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine45 proxy object. All configs
