...
Kiwi_304: {
	...
	config: [
		...
		// Kiwi_304 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_304 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_304/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_304$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_304
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_304 proxy object. All configs
