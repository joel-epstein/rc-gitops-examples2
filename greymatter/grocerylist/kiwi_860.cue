...
Kiwi_860: {
	...
	config: [
		...
		// Kiwi_860 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_860 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_860/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_860$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_860
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_860 proxy object. All configs
