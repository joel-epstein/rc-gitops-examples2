...
Melon21: {
	...
	config: [
		...
		// Melon21 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon21 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon21/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon21$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon21
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon21 proxy object. All configs
