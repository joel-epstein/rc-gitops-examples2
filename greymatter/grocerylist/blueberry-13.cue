...
Blueberry_13: {
	...
	config: [
		...
		// Blueberry_13 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_13 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-13
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-13 proxy object. All configs
