...
Kiwi_871: {
	...
	config: [
		...
		// Kiwi_871 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_871 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_871/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_871$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_871
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_871 proxy object. All configs
