...
Orange_60: {
	...
	config: [
		...
		// Orange_60 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_60 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-60/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-60$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-60
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-60 proxy object. All configs
