...
Kiwi_283: {
	...
	config: [
		...
		// Kiwi_283 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_283 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_283/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_283$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_283
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_283 proxy object. All configs
