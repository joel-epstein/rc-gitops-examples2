...
Kiwi_664: {
	...
	config: [
		...
		// Kiwi_664 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_664 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_664/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_664$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_664
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_664 proxy object. All configs
