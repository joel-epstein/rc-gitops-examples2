...
Melon27: {
	...
	config: [
		...
		// Melon27 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon27 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon27/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon27$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon27
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon27 proxy object. All configs
