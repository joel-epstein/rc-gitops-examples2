...
Kiwi_134: {
	...
	config: [
		...
		// Kiwi_134 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_134 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_134/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_134$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_134
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_134 proxy object. All configs
