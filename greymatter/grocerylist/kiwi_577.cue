...
Kiwi_577: {
	...
	config: [
		...
		// Kiwi_577 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_577 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_577/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_577$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_577
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_577 proxy object. All configs
