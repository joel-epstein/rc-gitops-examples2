...
Melon_25: {
	...
	config: [
		...
		// Melon_25 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_25 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-25/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-25$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-25
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-25 proxy object. All configs
