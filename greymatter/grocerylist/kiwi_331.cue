...
Kiwi_331: {
	...
	config: [
		...
		// Kiwi_331 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_331 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_331/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_331$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_331
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_331 proxy object. All configs
