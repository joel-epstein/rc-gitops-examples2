...
Orange_45: {
	...
	config: [
		...
		// Orange_45 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_45 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-45/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-45$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-45
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-45 proxy object. All configs
