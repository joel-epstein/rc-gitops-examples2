...
Kiwi_516: {
	...
	config: [
		...
		// Kiwi_516 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_516 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_516/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_516$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_516
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_516 proxy object. All configs
