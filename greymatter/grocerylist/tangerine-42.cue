...
Tangerine_42: {
	...
	config: [
		...
		// Tangerine_42 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_42 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-42/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-42$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-42
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-42 proxy object. All configs
