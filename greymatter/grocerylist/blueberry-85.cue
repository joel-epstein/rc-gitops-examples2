...
Blueberry_85: {
	...
	config: [
		...
		// Blueberry_85 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_85 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-85/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-85$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-85
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-85 proxy object. All configs
