...
Kiwi_658: {
	...
	config: [
		...
		// Kiwi_658 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_658 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_658/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_658$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_658
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_658 proxy object. All configs
