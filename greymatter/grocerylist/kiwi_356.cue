...
Kiwi_356: {
	...
	config: [
		...
		// Kiwi_356 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_356 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_356/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_356$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_356
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_356 proxy object. All configs
