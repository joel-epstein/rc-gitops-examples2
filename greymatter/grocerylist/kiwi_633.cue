...
Kiwi_633: {
	...
	config: [
		...
		// Kiwi_633 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_633 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_633/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_633$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_633
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_633 proxy object. All configs
