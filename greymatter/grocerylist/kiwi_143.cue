...
Kiwi_143: {
	...
	config: [
		...
		// Kiwi_143 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_143 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_143/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_143$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_143
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_143 proxy object. All configs
