...
Kiwi_65: {
	...
	config: [
		...
		// Kiwi_65 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_65 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_65/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_65$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_65
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_65 proxy object. All configs
