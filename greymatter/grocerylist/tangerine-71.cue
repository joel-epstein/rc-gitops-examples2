...
Tangerine_71: {
	...
	config: [
		...
		// Tangerine_71 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_71 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-71/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-71$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-71
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-71 proxy object. All configs
