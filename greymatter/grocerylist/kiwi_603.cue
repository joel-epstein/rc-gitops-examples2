...
Kiwi_603: {
	...
	config: [
		...
		// Kiwi_603 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_603 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_603/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_603$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_603
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_603 proxy object. All configs
