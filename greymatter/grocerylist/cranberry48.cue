...
Cranberry48: {
	...
	config: [
		...
		// Cranberry48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry48
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry48 proxy object. All configs
