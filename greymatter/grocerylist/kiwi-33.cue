...
Kiwi_33: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-33
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-33 proxy object. All configs
