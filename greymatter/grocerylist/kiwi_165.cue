...
Kiwi_165: {
	...
	config: [
		...
		// Kiwi_165 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_165 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_165/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_165$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_165
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_165 proxy object. All configs
