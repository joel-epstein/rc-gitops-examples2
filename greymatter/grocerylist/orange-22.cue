...
Orange_22: {
	...
	config: [
		...
		// Orange_22 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_22 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-22
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-22 proxy object. All configs
