...
Kiwi_449: {
	...
	config: [
		...
		// Kiwi_449 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_449 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_449/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_449$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_449
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_449 proxy object. All configs
