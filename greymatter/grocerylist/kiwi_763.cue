...
Kiwi_763: {
	...
	config: [
		...
		// Kiwi_763 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_763 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_763/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_763$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_763
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_763 proxy object. All configs
