...
Blueberry_72: {
	...
	config: [
		...
		// Blueberry_72 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_72 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-72/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-72$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-72
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-72 proxy object. All configs
