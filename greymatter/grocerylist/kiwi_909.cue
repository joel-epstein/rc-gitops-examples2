...
Kiwi_909: {
	...
	config: [
		...
		// Kiwi_909 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_909 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_909/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_909$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_909
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_909 proxy object. All configs
