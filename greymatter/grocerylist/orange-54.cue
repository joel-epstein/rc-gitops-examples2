...
Orange_54: {
	...
	config: [
		...
		// Orange_54 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_54 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-54/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-54$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-54
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-54 proxy object. All configs
