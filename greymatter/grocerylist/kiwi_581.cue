...
Kiwi_581: {
	...
	config: [
		...
		// Kiwi_581 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_581 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_581/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_581$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_581
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_581 proxy object. All configs
