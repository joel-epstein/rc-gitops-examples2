...
Kiwi_709: {
	...
	config: [
		...
		// Kiwi_709 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_709 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_709/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_709$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_709
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_709 proxy object. All configs
