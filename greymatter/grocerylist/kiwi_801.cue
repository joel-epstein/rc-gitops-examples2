...
Kiwi_801: {
	...
	config: [
		...
		// Kiwi_801 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_801 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_801/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_801$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_801
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_801 proxy object. All configs
