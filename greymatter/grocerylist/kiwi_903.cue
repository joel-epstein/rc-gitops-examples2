...
Kiwi_903: {
	...
	config: [
		...
		// Kiwi_903 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_903 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_903/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_903$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_903
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_903 proxy object. All configs
