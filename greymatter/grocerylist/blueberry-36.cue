...
Blueberry_36: {
	...
	config: [
		...
		// Blueberry_36 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_36 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-36
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-36 proxy object. All configs
