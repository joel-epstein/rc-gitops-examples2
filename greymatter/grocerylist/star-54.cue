...
Star_54: {
	...
	config: [
		...
		// Star_54 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_54 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-54/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-54$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-54
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-54 proxy object. All configs
