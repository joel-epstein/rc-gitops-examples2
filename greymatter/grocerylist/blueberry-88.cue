...
Blueberry_88: {
	...
	config: [
		...
		// Blueberry_88 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_88 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-88/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-88$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-88
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-88 proxy object. All configs
