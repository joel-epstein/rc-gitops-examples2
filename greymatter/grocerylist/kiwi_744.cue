...
Kiwi_744: {
	...
	config: [
		...
		// Kiwi_744 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_744 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_744/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_744$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_744
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_744 proxy object. All configs
