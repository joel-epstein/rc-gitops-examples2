...
Kiwi_48: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_48
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_48 proxy object. All configs
