...
Kiwi_230: {
	...
	config: [
		...
		// Kiwi_230 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_230 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_230/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_230$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_230
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_230 proxy object. All configs
