...
Melon_37: {
	...
	config: [
		...
		// Melon_37 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_37 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-37/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-37$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-37
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-37 proxy object. All configs
