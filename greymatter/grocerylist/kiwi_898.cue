...
Kiwi_898: {
	...
	config: [
		...
		// Kiwi_898 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_898 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_898/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_898$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_898
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_898 proxy object. All configs
