...
Tangerine_73: {
	...
	config: [
		...
		// Tangerine_73 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_73 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-73/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-73$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-73
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-73 proxy object. All configs
