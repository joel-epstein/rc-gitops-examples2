...
Kiwi100: {
	...
	config: [
		...
		// Kiwi100 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi100/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi100$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi100
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi100 proxy object. All configs
