...
Kiwi_81: {
	...
	config: [
		...
		// Kiwi_81 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_81 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_81/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_81$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_81
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_81 proxy object. All configs
