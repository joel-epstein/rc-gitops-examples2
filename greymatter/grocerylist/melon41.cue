...
Melon41: {
	...
	config: [
		...
		// Melon41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon41
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon41 proxy object. All configs
