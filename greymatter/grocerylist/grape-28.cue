...
Grape_28: {
	...
	config: [
		...
		// Grape_28 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_28 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-28
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-28 proxy object. All configs
