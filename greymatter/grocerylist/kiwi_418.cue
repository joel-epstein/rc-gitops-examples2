...
Kiwi_418: {
	...
	config: [
		...
		// Kiwi_418 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_418 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_418/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_418$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_418
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_418 proxy object. All configs
