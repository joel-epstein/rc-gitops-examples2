...
Kiwi_571: {
	...
	config: [
		...
		// Kiwi_571 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_571 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_571/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_571$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_571
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_571 proxy object. All configs
