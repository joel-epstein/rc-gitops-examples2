...
Kiwi_224: {
	...
	config: [
		...
		// Kiwi_224 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_224 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_224/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_224$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_224
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_224 proxy object. All configs
