...
Kiwi_404: {
	...
	config: [
		...
		// Kiwi_404 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_404 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_404/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_404$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_404
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_404 proxy object. All configs
