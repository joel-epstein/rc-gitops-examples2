...
Kiwi_450: {
	...
	config: [
		...
		// Kiwi_450 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_450 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_450/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_450$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_450
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_450 proxy object. All configs
