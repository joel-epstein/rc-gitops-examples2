...
Kiwi_390: {
	...
	config: [
		...
		// Kiwi_390 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_390 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_390/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_390$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_390
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_390 proxy object. All configs
