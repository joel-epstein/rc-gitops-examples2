...
Melon_45: {
	...
	config: [
		...
		// Melon_45 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_45 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-45/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-45$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-45
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-45 proxy object. All configs
