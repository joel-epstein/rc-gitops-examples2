...
Kiwi_164: {
	...
	config: [
		...
		// Kiwi_164 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_164 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_164/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_164$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_164
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_164 proxy object. All configs
