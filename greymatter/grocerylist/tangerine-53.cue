...
Tangerine_53: {
	...
	config: [
		...
		// Tangerine_53 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_53 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-53/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-53$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-53
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-53 proxy object. All configs
