...
Star24: {
	...
	config: [
		...
		// Star24 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star24 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star24/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star24$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star24
		#catalog_entry & {
			name:                      Name
		...
		// Shared star24 proxy object. All configs
