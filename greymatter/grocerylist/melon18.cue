...
Melon18: {
	...
	config: [
		...
		// Melon18 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon18 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon18/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon18$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon18
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon18 proxy object. All configs
