...
Kiwi_894: {
	...
	config: [
		...
		// Kiwi_894 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_894 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_894/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_894$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_894
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_894 proxy object. All configs
