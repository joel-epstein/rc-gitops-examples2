...
Kiwi_776: {
	...
	config: [
		...
		// Kiwi_776 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_776 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_776/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_776$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_776
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_776 proxy object. All configs
