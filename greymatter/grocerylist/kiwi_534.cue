...
Kiwi_534: {
	...
	config: [
		...
		// Kiwi_534 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_534 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_534/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_534$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_534
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_534 proxy object. All configs
