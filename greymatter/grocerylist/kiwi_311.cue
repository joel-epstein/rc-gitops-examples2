...
Kiwi_311: {
	...
	config: [
		...
		// Kiwi_311 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_311 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_311/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_311$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_311
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_311 proxy object. All configs
