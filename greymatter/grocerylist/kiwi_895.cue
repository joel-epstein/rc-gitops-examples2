...
Kiwi_895: {
	...
	config: [
		...
		// Kiwi_895 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_895 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_895/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_895$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_895
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_895 proxy object. All configs
