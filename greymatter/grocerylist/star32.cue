...
Star32: {
	...
	config: [
		...
		// Star32 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star32 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star32/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star32$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star32
		#catalog_entry & {
			name:                      Name
		...
		// Shared star32 proxy object. All configs
