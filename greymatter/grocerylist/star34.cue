...
Star34: {
	...
	config: [
		...
		// Star34 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star34 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star34
		#catalog_entry & {
			name:                      Name
		...
		// Shared star34 proxy object. All configs
