...
Blueberry28: {
	...
	config: [
		...
		// Blueberry28 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry28 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry28
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry28 proxy object. All configs
