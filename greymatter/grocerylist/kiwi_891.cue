...
Kiwi_891: {
	...
	config: [
		...
		// Kiwi_891 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_891 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_891/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_891$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_891
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_891 proxy object. All configs
