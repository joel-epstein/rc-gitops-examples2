...
Kiwi_98: {
	...
	config: [
		...
		// Kiwi_98 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_98 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_98/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_98$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_98
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_98 proxy object. All configs
