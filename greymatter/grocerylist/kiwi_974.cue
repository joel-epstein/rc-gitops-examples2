...
Kiwi_974: {
	...
	config: [
		...
		// Kiwi_974 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_974 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_974/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_974$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_974
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_974 proxy object. All configs
