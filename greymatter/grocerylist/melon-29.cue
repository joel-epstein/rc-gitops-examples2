...
Melon_29: {
	...
	config: [
		...
		// Melon_29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-29
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-29 proxy object. All configs
