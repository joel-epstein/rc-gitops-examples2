...
Cranberry12: {
	...
	config: [
		...
		// Cranberry12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry12
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry12 proxy object. All configs
