...
Kiwi_527: {
	...
	config: [
		...
		// Kiwi_527 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_527 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_527/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_527$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_527
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_527 proxy object. All configs
