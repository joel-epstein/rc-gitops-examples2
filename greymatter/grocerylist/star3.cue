...
Star3: {
	...
	config: [
		...
		// Star3 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star3 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star3/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star3$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star3
		#catalog_entry & {
			name:                      Name
		...
		// Shared star3 proxy object. All configs
