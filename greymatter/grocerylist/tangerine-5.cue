...
Tangerine_5: {
	...
	config: [
		...
		// Tangerine_5 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_5 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-5/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-5$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-5
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-5 proxy object. All configs
