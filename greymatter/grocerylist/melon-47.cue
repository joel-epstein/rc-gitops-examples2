...
Melon_47: {
	...
	config: [
		...
		// Melon_47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-47
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-47 proxy object. All configs
