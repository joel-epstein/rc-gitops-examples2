...
Kiwi_343: {
	...
	config: [
		...
		// Kiwi_343 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_343 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_343/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_343$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_343
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_343 proxy object. All configs
