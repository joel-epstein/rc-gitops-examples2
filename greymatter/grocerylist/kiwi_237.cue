...
Kiwi_237: {
	...
	config: [
		...
		// Kiwi_237 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_237 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_237/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_237$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_237
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_237 proxy object. All configs
