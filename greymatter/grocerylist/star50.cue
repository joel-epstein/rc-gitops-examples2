...
Star50: {
	...
	config: [
		...
		// Star50 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star50 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star50/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star50$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star50
		#catalog_entry & {
			name:                      Name
		...
		// Shared star50 proxy object. All configs
