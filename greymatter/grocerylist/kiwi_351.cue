...
Kiwi_351: {
	...
	config: [
		...
		// Kiwi_351 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_351 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_351/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_351$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_351
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_351 proxy object. All configs
