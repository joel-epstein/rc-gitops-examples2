...
Tangerine35: {
	...
	config: [
		...
		// Tangerine35 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine35 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine35/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine35$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine35
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine35 proxy object. All configs
