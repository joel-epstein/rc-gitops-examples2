...
Kiwi_141: {
	...
	config: [
		...
		// Kiwi_141 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_141 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_141/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_141$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_141
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_141 proxy object. All configs
