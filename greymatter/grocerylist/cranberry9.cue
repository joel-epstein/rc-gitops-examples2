...
Cranberry9: {
	...
	config: [
		...
		// Cranberry9 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry9 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry9/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry9$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry9
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry9 proxy object. All configs
