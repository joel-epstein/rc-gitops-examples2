...
Blueberry_25: {
	...
	config: [
		...
		// Blueberry_25 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_25 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-25/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-25$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-25
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-25 proxy object. All configs
