...
Kiwi_952: {
	...
	config: [
		...
		// Kiwi_952 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_952 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_952/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_952$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_952
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_952 proxy object. All configs
