...
Kiwi_20: {
	...
	config: [
		...
		// Kiwi_20 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_20 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_20/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_20$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_20
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_20 proxy object. All configs
