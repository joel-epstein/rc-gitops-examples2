...
Orange_86: {
	...
	config: [
		...
		// Orange_86 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_86 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-86/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-86$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-86
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-86 proxy object. All configs
