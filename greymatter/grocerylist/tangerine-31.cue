...
Tangerine_31: {
	...
	config: [
		...
		// Tangerine_31 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_31 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-31/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-31$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-31
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-31 proxy object. All configs
