...
Kiwi_526: {
	...
	config: [
		...
		// Kiwi_526 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_526 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_526/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_526$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_526
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_526 proxy object. All configs
