...
Kiwi_492: {
	...
	config: [
		...
		// Kiwi_492 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_492 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_492/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_492$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_492
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_492 proxy object. All configs
