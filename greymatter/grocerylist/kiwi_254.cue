...
Kiwi_254: {
	...
	config: [
		...
		// Kiwi_254 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_254 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_254/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_254$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_254
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_254 proxy object. All configs
