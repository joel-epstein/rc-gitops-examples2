...
Kiwi_401: {
	...
	config: [
		...
		// Kiwi_401 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_401 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_401/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_401$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_401
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_401 proxy object. All configs
