...
Orange_96: {
	...
	config: [
		...
		// Orange_96 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_96 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-96/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-96$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-96
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-96 proxy object. All configs
