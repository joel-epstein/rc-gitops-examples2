...
Kiwi_99: {
	...
	config: [
		...
		// Kiwi_99 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_99 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_99/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_99$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_99
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_99 proxy object. All configs
