...
Tangerine9: {
	...
	config: [
		...
		// Tangerine9 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine9 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine9/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine9$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine9
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine9 proxy object. All configs
