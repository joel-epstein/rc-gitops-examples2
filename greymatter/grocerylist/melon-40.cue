...
Melon_40: {
	...
	config: [
		...
		// Melon_40 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_40 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-40/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-40$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-40
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-40 proxy object. All configs
