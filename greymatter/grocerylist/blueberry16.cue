...
Blueberry16: {
	...
	config: [
		...
		// Blueberry16 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry16 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry16/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry16$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry16
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry16 proxy object. All configs
