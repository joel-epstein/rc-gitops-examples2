...
Kiwi_328: {
	...
	config: [
		...
		// Kiwi_328 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_328 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_328/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_328$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_328
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_328 proxy object. All configs
