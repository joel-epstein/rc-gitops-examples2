...
Orange_29: {
	...
	config: [
		...
		// Orange_29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-29
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-29 proxy object. All configs
