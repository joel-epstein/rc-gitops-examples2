...
Kiwi_861: {
	...
	config: [
		...
		// Kiwi_861 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_861 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_861/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_861$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_861
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_861 proxy object. All configs
