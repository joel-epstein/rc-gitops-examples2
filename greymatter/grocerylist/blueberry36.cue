...
Blueberry36: {
	...
	config: [
		...
		// Blueberry36 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry36 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry36
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry36 proxy object. All configs
