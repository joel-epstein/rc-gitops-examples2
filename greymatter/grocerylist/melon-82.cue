...
Melon_82: {
	...
	config: [
		...
		// Melon_82 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_82 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-82/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-82$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-82
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-82 proxy object. All configs
