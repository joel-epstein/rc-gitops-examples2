...
Kiwi_635: {
	...
	config: [
		...
		// Kiwi_635 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_635 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_635/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_635$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_635
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_635 proxy object. All configs
