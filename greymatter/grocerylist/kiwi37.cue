...
Kiwi37: {
	...
	config: [
		...
		// Kiwi37 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi37/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi37$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi37
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi37 proxy object. All configs
