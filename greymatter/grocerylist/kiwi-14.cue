...
Kiwi_14: {
	...
	config: [
		...
		// Kiwi_14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-14
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-14 proxy object. All configs
