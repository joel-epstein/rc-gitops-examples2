...
Kiwi_395: {
	...
	config: [
		...
		// Kiwi_395 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_395 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_395/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_395$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_395
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_395 proxy object. All configs
