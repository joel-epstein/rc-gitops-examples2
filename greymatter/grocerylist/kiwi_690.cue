...
Kiwi_690: {
	...
	config: [
		...
		// Kiwi_690 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_690 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_690/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_690$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_690
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_690 proxy object. All configs
