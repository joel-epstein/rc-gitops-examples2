...
Grape_87: {
	...
	config: [
		...
		// Grape_87 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_87 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-87/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-87$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-87
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-87 proxy object. All configs
