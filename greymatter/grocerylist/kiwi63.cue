...
Kiwi63: {
	...
	config: [
		...
		// Kiwi63 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi63 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi63/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi63$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi63
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi63 proxy object. All configs
