...
Kiwi_697: {
	...
	config: [
		...
		// Kiwi_697 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_697 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_697/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_697$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_697
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_697 proxy object. All configs
