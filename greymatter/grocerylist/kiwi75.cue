...
Kiwi75: {
	...
	config: [
		...
		// Kiwi75 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi75/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi75$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi75
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi75 proxy object. All configs
