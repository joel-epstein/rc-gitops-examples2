...
Melon_79: {
	...
	config: [
		...
		// Melon_79 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_79 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-79/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-79$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-79
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-79 proxy object. All configs
