...
Kiwi_139: {
	...
	config: [
		...
		// Kiwi_139 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_139 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_139/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_139$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_139
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_139 proxy object. All configs
