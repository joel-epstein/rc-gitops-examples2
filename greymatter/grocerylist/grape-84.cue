...
Grape_84: {
	...
	config: [
		...
		// Grape_84 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_84 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-84/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-84$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-84
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-84 proxy object. All configs
