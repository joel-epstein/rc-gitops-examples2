...
Kiwi_717: {
	...
	config: [
		...
		// Kiwi_717 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_717 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_717/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_717$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_717
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_717 proxy object. All configs
