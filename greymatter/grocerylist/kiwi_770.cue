...
Kiwi_770: {
	...
	config: [
		...
		// Kiwi_770 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_770 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_770/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_770$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_770
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_770 proxy object. All configs
