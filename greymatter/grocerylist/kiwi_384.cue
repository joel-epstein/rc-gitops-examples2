...
Kiwi_384: {
	...
	config: [
		...
		// Kiwi_384 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_384 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_384/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_384$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_384
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_384 proxy object. All configs
