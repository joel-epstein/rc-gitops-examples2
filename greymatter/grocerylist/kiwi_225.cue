...
Kiwi_225: {
	...
	config: [
		...
		// Kiwi_225 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_225 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_225/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_225$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_225
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_225 proxy object. All configs
