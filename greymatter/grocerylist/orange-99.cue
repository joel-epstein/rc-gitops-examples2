...
Orange_99: {
	...
	config: [
		...
		// Orange_99 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_99 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-99/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-99$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-99
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-99 proxy object. All configs
