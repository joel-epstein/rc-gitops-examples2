...
Kiwi_613: {
	...
	config: [
		...
		// Kiwi_613 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_613 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_613/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_613$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_613
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_613 proxy object. All configs
