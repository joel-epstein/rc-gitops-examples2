...
Kiwi_56: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-56/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-56$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-56
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-56 proxy object. All configs
