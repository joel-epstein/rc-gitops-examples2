...
Kiwi_276: {
	...
	config: [
		...
		// Kiwi_276 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_276 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_276/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_276$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_276
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_276 proxy object. All configs
