...
Grape_30: {
	...
	config: [
		...
		// Grape_30 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_30 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-30/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-30$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-30
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-30 proxy object. All configs
