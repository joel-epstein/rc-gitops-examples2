...
Star_29: {
	...
	config: [
		...
		// Star_29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-29
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-29 proxy object. All configs
