...
Tangerine_60: {
	...
	config: [
		...
		// Tangerine_60 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_60 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-60/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-60$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-60
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-60 proxy object. All configs
