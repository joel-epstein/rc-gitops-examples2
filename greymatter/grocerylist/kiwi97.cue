...
Kiwi97: {
	...
	config: [
		...
		// Kiwi97 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi97/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi97$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi97
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi97 proxy object. All configs
