...
Kiwi_606: {
	...
	config: [
		...
		// Kiwi_606 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_606 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_606/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_606$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_606
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_606 proxy object. All configs
