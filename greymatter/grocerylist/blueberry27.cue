...
Blueberry27: {
	...
	config: [
		...
		// Blueberry27 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry27 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry27/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry27$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry27
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry27 proxy object. All configs
