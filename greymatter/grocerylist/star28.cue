...
Star28: {
	...
	config: [
		...
		// Star28 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star28 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star28
		#catalog_entry & {
			name:                      Name
		...
		// Shared star28 proxy object. All configs
