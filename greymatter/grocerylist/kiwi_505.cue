...
Kiwi_505: {
	...
	config: [
		...
		// Kiwi_505 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_505 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_505/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_505$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_505
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_505 proxy object. All configs
