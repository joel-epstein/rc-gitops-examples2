...
Cranberry4: {
	...
	config: [
		...
		// Cranberry4 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry4 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry4/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry4$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry4
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry4 proxy object. All configs
