...
Kiwi_585: {
	...
	config: [
		...
		// Kiwi_585 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_585 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_585/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_585$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_585
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_585 proxy object. All configs
