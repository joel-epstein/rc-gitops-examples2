...
Kiwi_123: {
	...
	config: [
		...
		// Kiwi_123 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_123 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_123/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_123$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_123
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_123 proxy object. All configs
