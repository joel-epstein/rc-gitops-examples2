...
Kiwi_963: {
	...
	config: [
		...
		// Kiwi_963 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_963 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_963/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_963$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_963
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_963 proxy object. All configs
