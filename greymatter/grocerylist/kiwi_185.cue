...
Kiwi_185: {
	...
	config: [
		...
		// Kiwi_185 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_185 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_185/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_185$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_185
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_185 proxy object. All configs
