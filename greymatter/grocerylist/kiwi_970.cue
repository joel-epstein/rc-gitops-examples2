...
Kiwi_970: {
	...
	config: [
		...
		// Kiwi_970 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_970 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_970/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_970$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_970
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_970 proxy object. All configs
