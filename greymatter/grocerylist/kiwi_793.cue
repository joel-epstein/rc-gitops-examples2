...
Kiwi_793: {
	...
	config: [
		...
		// Kiwi_793 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_793 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_793/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_793$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_793
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_793 proxy object. All configs
