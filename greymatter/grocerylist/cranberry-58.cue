...
Cranberry_58: {
	...
	config: [
		...
		// Cranberry_58 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_58 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-58/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-58$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-58
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-58 proxy object. All configs
