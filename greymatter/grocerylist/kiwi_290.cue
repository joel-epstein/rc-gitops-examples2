...
Kiwi_290: {
	...
	config: [
		...
		// Kiwi_290 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_290 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_290/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_290$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_290
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_290 proxy object. All configs
