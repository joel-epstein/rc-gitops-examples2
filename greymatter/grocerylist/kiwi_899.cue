...
Kiwi_899: {
	...
	config: [
		...
		// Kiwi_899 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_899 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_899/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_899$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_899
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_899 proxy object. All configs
