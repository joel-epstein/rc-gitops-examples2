...
Kiwi_253: {
	...
	config: [
		...
		// Kiwi_253 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_253 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_253/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_253$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_253
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_253 proxy object. All configs
