...
Tangerine17: {
	...
	config: [
		...
		// Tangerine17 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine17 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine17
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine17 proxy object. All configs
