...
Kiwi_549: {
	...
	config: [
		...
		// Kiwi_549 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_549 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_549/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_549$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_549
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_549 proxy object. All configs
