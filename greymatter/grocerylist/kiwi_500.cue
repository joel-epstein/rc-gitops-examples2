...
Kiwi_500: {
	...
	config: [
		...
		// Kiwi_500 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_500 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_500/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_500$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_500
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_500 proxy object. All configs
