...
Kiwi_661: {
	...
	config: [
		...
		// Kiwi_661 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_661 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_661/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_661$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_661
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_661 proxy object. All configs
