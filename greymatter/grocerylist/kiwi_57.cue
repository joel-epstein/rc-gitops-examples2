...
Kiwi_57: {
	...
	config: [
		...
		// Kiwi_57 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_57 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_57/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_57$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_57
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_57 proxy object. All configs
