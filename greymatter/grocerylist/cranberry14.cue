...
Cranberry14: {
	...
	config: [
		...
		// Cranberry14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry14
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry14 proxy object. All configs
