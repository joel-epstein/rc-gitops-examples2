...
Blueberry15: {
	...
	config: [
		...
		// Blueberry15 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry15 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry15/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry15$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry15
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry15 proxy object. All configs
