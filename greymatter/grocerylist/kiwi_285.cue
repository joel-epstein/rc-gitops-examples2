...
Kiwi_285: {
	...
	config: [
		...
		// Kiwi_285 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_285 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_285/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_285$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_285
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_285 proxy object. All configs
