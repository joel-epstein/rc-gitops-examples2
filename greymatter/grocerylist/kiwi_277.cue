...
Kiwi_277: {
	...
	config: [
		...
		// Kiwi_277 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_277 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_277/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_277$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_277
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_277 proxy object. All configs
