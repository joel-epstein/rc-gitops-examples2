...
Kiwi_300: {
	...
	config: [
		...
		// Kiwi_300 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_300 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_300/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_300$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_300
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_300 proxy object. All configs
