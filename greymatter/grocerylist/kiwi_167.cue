...
Kiwi_167: {
	...
	config: [
		...
		// Kiwi_167 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_167 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_167/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_167$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_167
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_167 proxy object. All configs
