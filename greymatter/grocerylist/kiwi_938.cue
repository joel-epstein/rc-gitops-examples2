...
Kiwi_938: {
	...
	config: [
		...
		// Kiwi_938 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_938 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_938/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_938$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_938
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_938 proxy object. All configs
