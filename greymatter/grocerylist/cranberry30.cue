...
Cranberry30: {
	...
	config: [
		...
		// Cranberry30 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry30 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry30/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry30$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry30
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry30 proxy object. All configs
