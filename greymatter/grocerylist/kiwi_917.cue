...
Kiwi_917: {
	...
	config: [
		...
		// Kiwi_917 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_917 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_917/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_917$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_917
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_917 proxy object. All configs
