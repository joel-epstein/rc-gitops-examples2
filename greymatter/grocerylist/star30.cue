...
Star30: {
	...
	config: [
		...
		// Star30 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star30 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star30/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star30$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star30
		#catalog_entry & {
			name:                      Name
		...
		// Shared star30 proxy object. All configs
