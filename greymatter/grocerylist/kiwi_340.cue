...
Kiwi_340: {
	...
	config: [
		...
		// Kiwi_340 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_340 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_340/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_340$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_340
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_340 proxy object. All configs
