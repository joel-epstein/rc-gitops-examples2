...
Blueberry_75: {
	...
	config: [
		...
		// Blueberry_75 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_75 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-75/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-75$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-75
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-75 proxy object. All configs
