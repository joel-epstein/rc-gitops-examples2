...
Kiwi_201: {
	...
	config: [
		...
		// Kiwi_201 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_201 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_201/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_201$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_201
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_201 proxy object. All configs
