...
Kiwi_207: {
	...
	config: [
		...
		// Kiwi_207 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_207 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_207/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_207$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_207
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_207 proxy object. All configs
