...
Kiwi_826: {
	...
	config: [
		...
		// Kiwi_826 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_826 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_826/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_826$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_826
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_826 proxy object. All configs
