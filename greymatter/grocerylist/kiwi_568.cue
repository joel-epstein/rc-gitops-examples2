...
Kiwi_568: {
	...
	config: [
		...
		// Kiwi_568 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_568 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_568/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_568$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_568
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_568 proxy object. All configs
