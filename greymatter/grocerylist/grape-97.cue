...
Grape_97: {
	...
	config: [
		...
		// Grape_97 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_97 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-97/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-97$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-97
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-97 proxy object. All configs
