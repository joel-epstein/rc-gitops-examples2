...
Kiwi_501: {
	...
	config: [
		...
		// Kiwi_501 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_501 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_501/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_501$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_501
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_501 proxy object. All configs
