...
Tangerine13: {
	...
	config: [
		...
		// Tangerine13 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine13 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine13
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine13 proxy object. All configs
