...
Kiwi_755: {
	...
	config: [
		...
		// Kiwi_755 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_755 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_755/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_755$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_755
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_755 proxy object. All configs
