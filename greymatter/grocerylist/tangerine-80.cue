...
Tangerine_80: {
	...
	config: [
		...
		// Tangerine_80 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_80 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-80/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-80$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-80
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-80 proxy object. All configs
