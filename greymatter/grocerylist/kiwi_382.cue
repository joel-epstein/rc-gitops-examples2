...
Kiwi_382: {
	...
	config: [
		...
		// Kiwi_382 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_382 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_382/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_382$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_382
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_382 proxy object. All configs
