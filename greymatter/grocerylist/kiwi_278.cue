...
Kiwi_278: {
	...
	config: [
		...
		// Kiwi_278 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_278 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_278/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_278$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_278
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_278 proxy object. All configs
