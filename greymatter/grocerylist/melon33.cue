...
Melon33: {
	...
	config: [
		...
		// Melon33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon33
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon33 proxy object. All configs
