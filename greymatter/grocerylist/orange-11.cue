...
Orange_11: {
	...
	config: [
		...
		// Orange_11 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_11 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-11/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-11$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-11
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-11 proxy object. All configs
