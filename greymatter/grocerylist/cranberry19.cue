...
Cranberry19: {
	...
	config: [
		...
		// Cranberry19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry19
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry19 proxy object. All configs
