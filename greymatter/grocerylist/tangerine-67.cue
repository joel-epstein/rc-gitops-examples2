...
Tangerine_67: {
	...
	config: [
		...
		// Tangerine_67 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_67 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-67/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-67$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-67
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-67 proxy object. All configs
