...
Kiwi_176: {
	...
	config: [
		...
		// Kiwi_176 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_176 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_176/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_176$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_176
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_176 proxy object. All configs
