...
Star9: {
	...
	config: [
		...
		// Star9 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star9 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star9/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star9$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star9
		#catalog_entry & {
			name:                      Name
		...
		// Shared star9 proxy object. All configs
