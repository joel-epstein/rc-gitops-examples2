...
Kiwi_490: {
	...
	config: [
		...
		// Kiwi_490 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_490 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_490/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_490$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_490
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_490 proxy object. All configs
