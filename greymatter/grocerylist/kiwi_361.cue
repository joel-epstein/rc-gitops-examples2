...
Kiwi_361: {
	...
	config: [
		...
		// Kiwi_361 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_361 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_361/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_361$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_361
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_361 proxy object. All configs
