...
Orange_98: {
	...
	config: [
		...
		// Orange_98 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_98 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-98/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-98$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-98
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-98 proxy object. All configs
