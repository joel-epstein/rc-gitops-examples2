...
Kiwi_22: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_22
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_22 proxy object. All configs
