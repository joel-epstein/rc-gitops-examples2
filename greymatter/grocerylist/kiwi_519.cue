...
Kiwi_519: {
	...
	config: [
		...
		// Kiwi_519 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_519 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_519/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_519$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_519
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_519 proxy object. All configs
