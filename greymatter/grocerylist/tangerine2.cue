...
Tangerine2: {
	...
	config: [
		...
		// Tangerine2 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine2 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine2/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine2$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine2
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine2 proxy object. All configs
