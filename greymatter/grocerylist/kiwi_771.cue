...
Kiwi_771: {
	...
	config: [
		...
		// Kiwi_771 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_771 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_771/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_771$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_771
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_771 proxy object. All configs
