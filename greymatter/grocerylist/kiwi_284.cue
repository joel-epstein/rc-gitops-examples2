...
Kiwi_284: {
	...
	config: [
		...
		// Kiwi_284 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_284 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_284/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_284$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_284
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_284 proxy object. All configs
