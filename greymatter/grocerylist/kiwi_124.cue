...
Kiwi_124: {
	...
	config: [
		...
		// Kiwi_124 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_124 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_124/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_124$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_124
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_124 proxy object. All configs
