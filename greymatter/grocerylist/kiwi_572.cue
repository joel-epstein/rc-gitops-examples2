...
Kiwi_572: {
	...
	config: [
		...
		// Kiwi_572 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_572 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_572/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_572$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_572
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_572 proxy object. All configs
