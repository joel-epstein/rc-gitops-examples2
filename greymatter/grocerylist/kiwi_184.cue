...
Kiwi_184: {
	...
	config: [
		...
		// Kiwi_184 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_184 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_184/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_184$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_184
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_184 proxy object. All configs
