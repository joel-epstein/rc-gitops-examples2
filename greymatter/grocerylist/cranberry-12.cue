...
Cranberry_12: {
	...
	config: [
		...
		// Cranberry_12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-12
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-12 proxy object. All configs
