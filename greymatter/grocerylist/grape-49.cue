...
Grape_49: {
	...
	config: [
		...
		// Grape_49 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_49 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-49/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-49$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-49
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-49 proxy object. All configs
