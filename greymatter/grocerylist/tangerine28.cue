...
Tangerine28: {
	...
	config: [
		...
		// Tangerine28 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine28 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine28
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine28 proxy object. All configs
