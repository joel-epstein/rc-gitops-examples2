...
Grape_39: {
	...
	config: [
		...
		// Grape_39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-39
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-39 proxy object. All configs
