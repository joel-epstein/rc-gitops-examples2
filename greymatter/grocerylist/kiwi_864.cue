...
Kiwi_864: {
	...
	config: [
		...
		// Kiwi_864 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_864 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_864/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_864$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_864
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_864 proxy object. All configs
