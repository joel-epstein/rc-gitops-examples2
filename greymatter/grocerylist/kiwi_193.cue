...
Kiwi_193: {
	...
	config: [
		...
		// Kiwi_193 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_193 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_193/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_193$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_193
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_193 proxy object. All configs
