...
Kiwi84: {
	...
	config: [
		...
		// Kiwi84 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi84/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi84$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi84
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi84 proxy object. All configs
