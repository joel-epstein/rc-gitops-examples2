...
Star48: {
	...
	config: [
		...
		// Star48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star48
		#catalog_entry & {
			name:                      Name
		...
		// Shared star48 proxy object. All configs
