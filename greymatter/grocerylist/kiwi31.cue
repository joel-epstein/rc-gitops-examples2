...
Kiwi31: {
	...
	config: [
		...
		// Kiwi31 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi31/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi31$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi31
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi31 proxy object. All configs
