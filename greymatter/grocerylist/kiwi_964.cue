...
Kiwi_964: {
	...
	config: [
		...
		// Kiwi_964 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_964 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_964/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_964$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_964
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_964 proxy object. All configs
