...
Tangerine_13: {
	...
	config: [
		...
		// Tangerine_13 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_13 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-13
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-13 proxy object. All configs
