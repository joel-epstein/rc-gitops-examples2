...
Kiwi_36: {
	...
	config: [
		...
		// Kiwi_36 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_36 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-36
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-36 proxy object. All configs
