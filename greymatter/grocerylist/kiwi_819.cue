...
Kiwi_819: {
	...
	config: [
		...
		// Kiwi_819 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_819 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_819/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_819$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_819
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_819 proxy object. All configs
