...
Cranberry7: {
	...
	config: [
		...
		// Cranberry7 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry7 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry7/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry7$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry7
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry7 proxy object. All configs
