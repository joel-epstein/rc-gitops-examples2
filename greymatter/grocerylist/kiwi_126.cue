...
Kiwi_126: {
	...
	config: [
		...
		// Kiwi_126 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_126 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_126/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_126$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_126
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_126 proxy object. All configs
