...
Melon38: {
	...
	config: [
		...
		// Melon38 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon38 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon38
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon38 proxy object. All configs
