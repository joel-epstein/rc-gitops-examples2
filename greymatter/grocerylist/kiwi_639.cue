...
Kiwi_639: {
	...
	config: [
		...
		// Kiwi_639 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_639 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_639/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_639$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_639
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_639 proxy object. All configs
