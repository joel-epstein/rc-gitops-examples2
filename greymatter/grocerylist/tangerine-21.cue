...
Tangerine_21: {
	...
	config: [
		...
		// Tangerine_21 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_21 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-21/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-21$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-21
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-21 proxy object. All configs
