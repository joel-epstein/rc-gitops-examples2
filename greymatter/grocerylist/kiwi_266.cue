...
Kiwi_266: {
	...
	config: [
		...
		// Kiwi_266 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_266 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_266/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_266$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_266
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_266 proxy object. All configs
