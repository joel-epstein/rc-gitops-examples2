...
Kiwi_444: {
	...
	config: [
		...
		// Kiwi_444 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_444 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_444/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_444$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_444
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_444 proxy object. All configs
