...
Kiwi_158: {
	...
	config: [
		...
		// Kiwi_158 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_158 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_158/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_158$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_158
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_158 proxy object. All configs
