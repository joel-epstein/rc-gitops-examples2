...
Tangerine_93: {
	...
	config: [
		...
		// Tangerine_93 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_93 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-93/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-93$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-93
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-93 proxy object. All configs
