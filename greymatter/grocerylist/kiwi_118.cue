...
Kiwi_118: {
	...
	config: [
		...
		// Kiwi_118 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_118 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_118/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_118$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_118
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_118 proxy object. All configs
