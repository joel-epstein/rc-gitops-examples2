...
Kiwi_980: {
	...
	config: [
		...
		// Kiwi_980 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_980 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_980/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_980$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_980
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_980 proxy object. All configs
