...
Kiwi_703: {
	...
	config: [
		...
		// Kiwi_703 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_703 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_703/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_703$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_703
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_703 proxy object. All configs
