...
Blueberry_52: {
	...
	config: [
		...
		// Blueberry_52 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_52 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-52/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-52$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-52
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-52 proxy object. All configs
