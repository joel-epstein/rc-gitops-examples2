...
Cranberry17: {
	...
	config: [
		...
		// Cranberry17 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry17 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry17
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry17 proxy object. All configs
