...
Kiwi_790: {
	...
	config: [
		...
		// Kiwi_790 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_790 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_790/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_790$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_790
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_790 proxy object. All configs
