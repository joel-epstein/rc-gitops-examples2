...
Kiwi_177: {
	...
	config: [
		...
		// Kiwi_177 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_177 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_177/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_177$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_177
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_177 proxy object. All configs
