...
Orange_17: {
	...
	config: [
		...
		// Orange_17 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_17 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-17
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-17 proxy object. All configs
