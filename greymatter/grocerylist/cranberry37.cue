...
Cranberry37: {
	...
	config: [
		...
		// Cranberry37 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry37 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry37/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry37$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry37
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry37 proxy object. All configs
