...
Kiwi_812: {
	...
	config: [
		...
		// Kiwi_812 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_812 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_812/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_812$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_812
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_812 proxy object. All configs
