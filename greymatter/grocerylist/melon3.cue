...
Melon3: {
	...
	config: [
		...
		// Melon3 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon3 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon3/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon3$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon3
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon3 proxy object. All configs
