...
Kiwi_546: {
	...
	config: [
		...
		// Kiwi_546 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_546 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_546/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_546$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_546
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_546 proxy object. All configs
