...
Kiwi_840: {
	...
	config: [
		...
		// Kiwi_840 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_840 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_840/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_840$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_840
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_840 proxy object. All configs
