...
Kiwi_704: {
	...
	config: [
		...
		// Kiwi_704 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_704 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_704/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_704$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_704
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_704 proxy object. All configs
