...
Kiwi_440: {
	...
	config: [
		...
		// Kiwi_440 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_440 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_440/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_440$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_440
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_440 proxy object. All configs
