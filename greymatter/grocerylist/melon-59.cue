...
Melon_59: {
	...
	config: [
		...
		// Melon_59 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_59 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-59/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-59$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-59
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-59 proxy object. All configs
