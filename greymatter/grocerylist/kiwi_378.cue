...
Kiwi_378: {
	...
	config: [
		...
		// Kiwi_378 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_378 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_378/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_378$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_378
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_378 proxy object. All configs
