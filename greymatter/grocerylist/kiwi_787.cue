...
Kiwi_787: {
	...
	config: [
		...
		// Kiwi_787 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_787 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_787/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_787$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_787
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_787 proxy object. All configs
