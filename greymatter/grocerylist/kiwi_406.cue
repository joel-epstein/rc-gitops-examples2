...
Kiwi_406: {
	...
	config: [
		...
		// Kiwi_406 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_406 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_406/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_406$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_406
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_406 proxy object. All configs
