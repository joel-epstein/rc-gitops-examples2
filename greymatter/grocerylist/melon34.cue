...
Melon34: {
	...
	config: [
		...
		// Melon34 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon34 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon34
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon34 proxy object. All configs
