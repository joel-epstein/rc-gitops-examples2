...
Tangerine29: {
	...
	config: [
		...
		// Tangerine29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine29
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine29 proxy object. All configs
