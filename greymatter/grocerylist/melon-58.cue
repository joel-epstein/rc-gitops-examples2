...
Melon_58: {
	...
	config: [
		...
		// Melon_58 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_58 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-58/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-58$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-58
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-58 proxy object. All configs
