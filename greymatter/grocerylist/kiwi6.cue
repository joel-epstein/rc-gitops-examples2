...
Kiwi6: {
	...
	config: [
		...
		// Kiwi6 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi6/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi6$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi6
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi6 proxy object. All configs
