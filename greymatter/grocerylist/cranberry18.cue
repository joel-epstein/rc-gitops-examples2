...
Cranberry18: {
	...
	config: [
		...
		// Cranberry18 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry18 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry18/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry18$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry18
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry18 proxy object. All configs
