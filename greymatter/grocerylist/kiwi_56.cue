...
Kiwi_56: {
	...
	config: [
		...
		// Kiwi_56 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_56 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_56/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_56$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_56
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_56 proxy object. All configs
