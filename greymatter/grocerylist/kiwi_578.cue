...
Kiwi_578: {
	...
	config: [
		...
		// Kiwi_578 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_578 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_578/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_578$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_578
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_578 proxy object. All configs
