...
Kiwi_517: {
	...
	config: [
		...
		// Kiwi_517 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_517 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_517/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_517$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_517
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_517 proxy object. All configs
