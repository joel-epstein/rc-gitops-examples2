...
Orange_26: {
	...
	config: [
		...
		// Orange_26 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_26 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-26/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-26$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-26
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-26 proxy object. All configs
