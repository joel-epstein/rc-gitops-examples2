...
Cranberry24: {
	...
	config: [
		...
		// Cranberry24 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry24 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry24/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry24$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry24
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry24 proxy object. All configs
