...
Tangerine_46: {
	...
	config: [
		...
		// Tangerine_46 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_46 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-46
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-46 proxy object. All configs
