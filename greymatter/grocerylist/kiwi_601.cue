...
Kiwi_601: {
	...
	config: [
		...
		// Kiwi_601 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_601 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_601/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_601$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_601
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_601 proxy object. All configs
