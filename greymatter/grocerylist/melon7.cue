...
Melon7: {
	...
	config: [
		...
		// Melon7 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon7 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon7/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon7$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon7
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon7 proxy object. All configs
