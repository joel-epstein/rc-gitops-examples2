...
Kiwi_506: {
	...
	config: [
		...
		// Kiwi_506 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_506 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_506/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_506$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_506
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_506 proxy object. All configs
