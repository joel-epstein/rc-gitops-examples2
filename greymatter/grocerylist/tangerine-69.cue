...
Tangerine_69: {
	...
	config: [
		...
		// Tangerine_69 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_69 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-69/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-69$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-69
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-69 proxy object. All configs
