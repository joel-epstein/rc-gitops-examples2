...
Kiwi_747: {
	...
	config: [
		...
		// Kiwi_747 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_747 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_747/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_747$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_747
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_747 proxy object. All configs
