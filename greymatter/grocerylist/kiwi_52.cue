...
Kiwi_52: {
	...
	config: [
		...
		// Kiwi_52 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_52 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_52/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_52$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_52
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_52 proxy object. All configs
