...
Kiwi_543: {
	...
	config: [
		...
		// Kiwi_543 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_543 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_543/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_543$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_543
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_543 proxy object. All configs
