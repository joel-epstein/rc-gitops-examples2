...
Melon_70: {
	...
	config: [
		...
		// Melon_70 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_70 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-70/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-70$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-70
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-70 proxy object. All configs
