...
Kiwi_239: {
	...
	config: [
		...
		// Kiwi_239 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_239 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_239/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_239$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_239
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_239 proxy object. All configs
