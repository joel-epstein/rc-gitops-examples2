...
Kiwi_347: {
	...
	config: [
		...
		// Kiwi_347 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_347 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_347/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_347$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_347
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_347 proxy object. All configs
