...
Blueberry3: {
	...
	config: [
		...
		// Blueberry3 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry3 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry3/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry3$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry3
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry3 proxy object. All configs
