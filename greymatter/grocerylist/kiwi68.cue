...
Kiwi68: {
	...
	config: [
		...
		// Kiwi68 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi68 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi68/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi68$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi68
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi68 proxy object. All configs
