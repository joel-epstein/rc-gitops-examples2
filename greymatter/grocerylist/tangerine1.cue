...
Tangerine1: {
	...
	config: [
		...
		// Tangerine1 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine1 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine1/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine1$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine1
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine1 proxy object. All configs
