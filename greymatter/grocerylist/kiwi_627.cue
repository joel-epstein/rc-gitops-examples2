...
Kiwi_627: {
	...
	config: [
		...
		// Kiwi_627 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_627 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_627/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_627$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_627
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_627 proxy object. All configs
