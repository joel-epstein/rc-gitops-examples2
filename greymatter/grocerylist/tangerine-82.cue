...
Tangerine_82: {
	...
	config: [
		...
		// Tangerine_82 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_82 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-82/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-82$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-82
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-82 proxy object. All configs
