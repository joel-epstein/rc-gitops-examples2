...
Star19: {
	...
	config: [
		...
		// Star19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star19
		#catalog_entry & {
			name:                      Name
		...
		// Shared star19 proxy object. All configs
