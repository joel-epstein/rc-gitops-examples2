...
Orange_84: {
	...
	config: [
		...
		// Orange_84 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_84 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-84/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-84$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-84
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-84 proxy object. All configs
