...
Kiwi_435: {
	...
	config: [
		...
		// Kiwi_435 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_435 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_435/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_435$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_435
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_435 proxy object. All configs
