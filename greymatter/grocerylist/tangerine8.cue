...
Tangerine8: {
	...
	config: [
		...
		// Tangerine8 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine8 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine8/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine8$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine8
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine8 proxy object. All configs
