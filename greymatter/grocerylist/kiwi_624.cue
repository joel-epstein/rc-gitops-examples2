...
Kiwi_624: {
	...
	config: [
		...
		// Kiwi_624 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_624 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_624/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_624$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_624
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_624 proxy object. All configs
