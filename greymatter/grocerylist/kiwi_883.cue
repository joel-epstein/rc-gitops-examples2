...
Kiwi_883: {
	...
	config: [
		...
		// Kiwi_883 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_883 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_883/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_883$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_883
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_883 proxy object. All configs
