...
Kiwi_614: {
	...
	config: [
		...
		// Kiwi_614 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_614 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_614/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_614$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_614
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_614 proxy object. All configs
