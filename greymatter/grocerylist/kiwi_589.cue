...
Kiwi_589: {
	...
	config: [
		...
		// Kiwi_589 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_589 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_589/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_589$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_589
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_589 proxy object. All configs
