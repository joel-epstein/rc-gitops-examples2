...
Orange_63: {
	...
	config: [
		...
		// Orange_63 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_63 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-63/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-63$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-63
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-63 proxy object. All configs
