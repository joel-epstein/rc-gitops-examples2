...
Kiwi_309: {
	...
	config: [
		...
		// Kiwi_309 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_309 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_309/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_309$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_309
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_309 proxy object. All configs
