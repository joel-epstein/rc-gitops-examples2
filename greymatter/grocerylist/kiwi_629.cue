...
Kiwi_629: {
	...
	config: [
		...
		// Kiwi_629 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_629 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_629/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_629$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_629
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_629 proxy object. All configs
