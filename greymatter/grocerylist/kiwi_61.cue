...
Kiwi_61: {
	...
	config: [
		...
		// Kiwi_61 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_61 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_61/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_61$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_61
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_61 proxy object. All configs
