...
Kiwi_905: {
	...
	config: [
		...
		// Kiwi_905 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_905 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_905/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_905$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_905
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_905 proxy object. All configs
