...
Grape_14: {
	...
	config: [
		...
		// Grape_14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-14
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-14 proxy object. All configs
