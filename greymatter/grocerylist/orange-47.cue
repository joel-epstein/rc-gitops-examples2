...
Orange_47: {
	...
	config: [
		...
		// Orange_47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-47
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-47 proxy object. All configs
