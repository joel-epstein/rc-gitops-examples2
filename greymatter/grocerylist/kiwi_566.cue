...
Kiwi_566: {
	...
	config: [
		...
		// Kiwi_566 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_566 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_566/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_566$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_566
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_566 proxy object. All configs
