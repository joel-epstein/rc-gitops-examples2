...
Melon_49: {
	...
	config: [
		...
		// Melon_49 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_49 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-49/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-49$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-49
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-49 proxy object. All configs
