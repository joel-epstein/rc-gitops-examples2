...
Kiwi_760: {
	...
	config: [
		...
		// Kiwi_760 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_760 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_760/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_760$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_760
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_760 proxy object. All configs
