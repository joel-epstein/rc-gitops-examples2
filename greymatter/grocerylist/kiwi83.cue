...
Kiwi83: {
	...
	config: [
		...
		// Kiwi83 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi83/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi83$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi83
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi83 proxy object. All configs
