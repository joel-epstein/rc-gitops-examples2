...
Kiwi_644: {
	...
	config: [
		...
		// Kiwi_644 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_644 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_644/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_644$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_644
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_644 proxy object. All configs
