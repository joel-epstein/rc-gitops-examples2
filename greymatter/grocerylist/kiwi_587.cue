...
Kiwi_587: {
	...
	config: [
		...
		// Kiwi_587 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_587 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_587/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_587$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_587
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_587 proxy object. All configs
