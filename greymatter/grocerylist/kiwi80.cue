...
Kiwi80: {
	...
	config: [
		...
		// Kiwi80 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi80 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi80/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi80$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi80
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi80 proxy object. All configs
