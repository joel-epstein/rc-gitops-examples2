...
Star21: {
	...
	config: [
		...
		// Star21 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star21 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star21/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star21$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star21
		#catalog_entry & {
			name:                      Name
		...
		// Shared star21 proxy object. All configs
