...
Tangerine_85: {
	...
	config: [
		...
		// Tangerine_85 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_85 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-85/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-85$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-85
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-85 proxy object. All configs
