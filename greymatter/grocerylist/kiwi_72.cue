...
Kiwi_72: {
	...
	config: [
		...
		// Kiwi_72 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_72 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_72/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_72$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_72
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_72 proxy object. All configs
