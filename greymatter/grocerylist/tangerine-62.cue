...
Tangerine_62: {
	...
	config: [
		...
		// Tangerine_62 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_62 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-62/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-62$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-62
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-62 proxy object. All configs
