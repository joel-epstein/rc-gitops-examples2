...
Blueberry_27: {
	...
	config: [
		...
		// Blueberry_27 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_27 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-27/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-27$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-27
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-27 proxy object. All configs
