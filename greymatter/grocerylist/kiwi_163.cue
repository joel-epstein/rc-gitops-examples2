...
Kiwi_163: {
	...
	config: [
		...
		// Kiwi_163 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_163 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_163/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_163$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_163
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_163 proxy object. All configs
