...
Kiwi_809: {
	...
	config: [
		...
		// Kiwi_809 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_809 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_809/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_809$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_809
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_809 proxy object. All configs
