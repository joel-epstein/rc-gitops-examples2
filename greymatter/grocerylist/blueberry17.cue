...
Blueberry17: {
	...
	config: [
		...
		// Blueberry17 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry17 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry17
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry17 proxy object. All configs
