...
Kiwi_634: {
	...
	config: [
		...
		// Kiwi_634 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_634 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_634/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_634$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_634
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_634 proxy object. All configs
