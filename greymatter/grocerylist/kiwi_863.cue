...
Kiwi_863: {
	...
	config: [
		...
		// Kiwi_863 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_863 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_863/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_863$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_863
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_863 proxy object. All configs
