...
Kiwi_710: {
	...
	config: [
		...
		// Kiwi_710 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_710 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_710/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_710$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_710
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_710 proxy object. All configs
