...
Tangerine_38: {
	...
	config: [
		...
		// Tangerine_38 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_38 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-38
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-38 proxy object. All configs
