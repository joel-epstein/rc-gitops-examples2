...
Blueberry_87: {
	...
	config: [
		...
		// Blueberry_87 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_87 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-87/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-87$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-87
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-87 proxy object. All configs
