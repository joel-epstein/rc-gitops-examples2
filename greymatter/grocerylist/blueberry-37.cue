...
Blueberry_37: {
	...
	config: [
		...
		// Blueberry_37 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_37 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-37/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-37$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-37
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-37 proxy object. All configs
