...
Kiwi_890: {
	...
	config: [
		...
		// Kiwi_890 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_890 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_890/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_890$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_890
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_890 proxy object. All configs
