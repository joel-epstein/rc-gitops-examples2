...
Kiwi_491: {
	...
	config: [
		...
		// Kiwi_491 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_491 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_491/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_491$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_491
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_491 proxy object. All configs
