...
Kiwi79: {
	...
	config: [
		...
		// Kiwi79 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi79 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi79/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi79$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi79
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi79 proxy object. All configs
