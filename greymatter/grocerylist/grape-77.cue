...
Grape_77: {
	...
	config: [
		...
		// Grape_77 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_77 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-77/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-77$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-77
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-77 proxy object. All configs
