...
Cranberry13: {
	...
	config: [
		...
		// Cranberry13 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry13 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry13
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry13 proxy object. All configs
