...
Kiwi_626: {
	...
	config: [
		...
		// Kiwi_626 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_626 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_626/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_626$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_626
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_626 proxy object. All configs
