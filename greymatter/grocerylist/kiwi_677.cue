...
Kiwi_677: {
	...
	config: [
		...
		// Kiwi_677 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_677 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_677/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_677$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_677
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_677 proxy object. All configs
