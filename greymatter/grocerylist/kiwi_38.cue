...
Kiwi_38: {
	...
	config: [
		...
		// Kiwi_38 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_38 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_38
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_38 proxy object. All configs
