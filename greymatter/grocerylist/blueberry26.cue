...
Blueberry26: {
	...
	config: [
		...
		// Blueberry26 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry26 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry26/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry26$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry26
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry26 proxy object. All configs
