...
Blueberry9: {
	...
	config: [
		...
		// Blueberry9 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry9 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry9/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry9$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry9
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry9 proxy object. All configs
