...
Kiwi_657: {
	...
	config: [
		...
		// Kiwi_657 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_657 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_657/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_657$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_657
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_657 proxy object. All configs
