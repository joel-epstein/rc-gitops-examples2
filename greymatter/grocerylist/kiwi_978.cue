...
Kiwi_978: {
	...
	config: [
		...
		// Kiwi_978 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_978 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_978/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_978$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_978
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_978 proxy object. All configs
