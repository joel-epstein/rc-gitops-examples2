...
Cranberry5: {
	...
	config: [
		...
		// Cranberry5 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry5 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry5/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry5$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry5
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry5 proxy object. All configs
