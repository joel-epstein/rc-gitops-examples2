...
Orange_55: {
	...
	config: [
		...
		// Orange_55 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_55 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-55/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-55$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-55
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-55 proxy object. All configs
