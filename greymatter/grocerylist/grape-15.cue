...
Grape_15: {
	...
	config: [
		...
		// Grape_15 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_15 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-15/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-15$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-15
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-15 proxy object. All configs
