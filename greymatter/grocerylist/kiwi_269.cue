...
Kiwi_269: {
	...
	config: [
		...
		// Kiwi_269 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_269 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_269/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_269$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_269
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_269 proxy object. All configs
