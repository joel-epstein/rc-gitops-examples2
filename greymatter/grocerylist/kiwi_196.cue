...
Kiwi_196: {
	...
	config: [
		...
		// Kiwi_196 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_196 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_196/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_196$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_196
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_196 proxy object. All configs
