...
Kiwi_641: {
	...
	config: [
		...
		// Kiwi_641 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_641 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_641/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_641$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_641
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_641 proxy object. All configs
