...
Orange_82: {
	...
	config: [
		...
		// Orange_82 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_82 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-82/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-82$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-82
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-82 proxy object. All configs
