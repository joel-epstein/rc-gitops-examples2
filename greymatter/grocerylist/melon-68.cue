...
Melon_68: {
	...
	config: [
		...
		// Melon_68 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_68 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-68/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-68$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-68
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-68 proxy object. All configs
