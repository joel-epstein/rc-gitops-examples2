...
Star8: {
	...
	config: [
		...
		// Star8 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star8 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star8/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star8$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star8
		#catalog_entry & {
			name:                      Name
		...
		// Shared star8 proxy object. All configs
