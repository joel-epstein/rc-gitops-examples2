...
Kiwi22: {
	...
	config: [
		...
		// Kiwi22 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi22
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi22 proxy object. All configs
