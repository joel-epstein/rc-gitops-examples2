...
Kiwi_168: {
	...
	config: [
		...
		// Kiwi_168 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_168 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_168/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_168$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_168
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_168 proxy object. All configs
