...
Kiwi_887: {
	...
	config: [
		...
		// Kiwi_887 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_887 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_887/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_887$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_887
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_887 proxy object. All configs
