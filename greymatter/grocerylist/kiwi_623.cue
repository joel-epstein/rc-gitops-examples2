...
Kiwi_623: {
	...
	config: [
		...
		// Kiwi_623 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_623 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_623/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_623$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_623
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_623 proxy object. All configs
