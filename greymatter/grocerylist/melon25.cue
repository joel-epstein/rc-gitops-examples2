...
Melon25: {
	...
	config: [
		...
		// Melon25 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon25 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon25/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon25$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon25
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon25 proxy object. All configs
