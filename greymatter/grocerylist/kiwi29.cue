...
Kiwi29: {
	...
	config: [
		...
		// Kiwi29 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi29
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi29 proxy object. All configs
