...
Kiwi43: {
	...
	config: [
		...
		// Kiwi43 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi43 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi43/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi43$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi43
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi43 proxy object. All configs
