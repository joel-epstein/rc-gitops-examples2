...
Kiwi_693: {
	...
	config: [
		...
		// Kiwi_693 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_693 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_693/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_693$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_693
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_693 proxy object. All configs
