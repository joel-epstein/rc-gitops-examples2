...
Kiwi_30: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-30/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-30$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-30
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-30 proxy object. All configs
