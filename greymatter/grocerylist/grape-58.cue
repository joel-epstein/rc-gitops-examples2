...
Grape_58: {
	...
	config: [
		...
		// Grape_58 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_58 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-58/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-58$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-58
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-58 proxy object. All configs
