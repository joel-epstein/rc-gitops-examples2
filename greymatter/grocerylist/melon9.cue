...
Melon9: {
	...
	config: [
		...
		// Melon9 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon9 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon9/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon9$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon9
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon9 proxy object. All configs
