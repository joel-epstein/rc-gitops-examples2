...
Orange_37: {
	...
	config: [
		...
		// Orange_37 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_37 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-37/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-37$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-37
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-37 proxy object. All configs
