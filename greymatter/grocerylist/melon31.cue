...
Melon31: {
	...
	config: [
		...
		// Melon31 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon31 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon31/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon31$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon31
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon31 proxy object. All configs
