...
Kiwi_367: {
	...
	config: [
		...
		// Kiwi_367 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_367 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_367/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_367$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_367
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_367 proxy object. All configs
