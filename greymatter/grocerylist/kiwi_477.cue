...
Kiwi_477: {
	...
	config: [
		...
		// Kiwi_477 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_477 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_477/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_477$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_477
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_477 proxy object. All configs
