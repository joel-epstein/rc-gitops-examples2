...
Kiwi_508: {
	...
	config: [
		...
		// Kiwi_508 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_508 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_508/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_508$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_508
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_508 proxy object. All configs
