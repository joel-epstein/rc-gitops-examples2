...
Tangerine10: {
	...
	config: [
		...
		// Tangerine10 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine10 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine10/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine10$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine10
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine10 proxy object. All configs
