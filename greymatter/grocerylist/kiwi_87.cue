...
Kiwi_87: {
	...
	config: [
		...
		// Kiwi_87 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_87 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_87/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_87$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_87
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_87 proxy object. All configs
