...
Kiwi_33: {
	...
	config: [
		...
		// Kiwi_33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_33
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_33 proxy object. All configs
