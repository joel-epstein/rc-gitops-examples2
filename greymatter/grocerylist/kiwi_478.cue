...
Kiwi_478: {
	...
	config: [
		...
		// Kiwi_478 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_478 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_478/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_478$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_478
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_478 proxy object. All configs
