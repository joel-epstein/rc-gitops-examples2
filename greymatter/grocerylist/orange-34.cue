...
Orange_34: {
	...
	config: [
		...
		// Orange_34 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_34 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-34
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-34 proxy object. All configs
