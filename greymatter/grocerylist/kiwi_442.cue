...
Kiwi_442: {
	...
	config: [
		...
		// Kiwi_442 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_442 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_442/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_442$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_442
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_442 proxy object. All configs
