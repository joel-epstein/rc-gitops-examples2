...
Kiwi_967: {
	...
	config: [
		...
		// Kiwi_967 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_967 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_967/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_967$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_967
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_967 proxy object. All configs
