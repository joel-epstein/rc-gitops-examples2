...
Grape_23: {
	...
	config: [
		...
		// Grape_23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-23
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-23 proxy object. All configs
