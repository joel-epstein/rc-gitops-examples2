...
Kiwi_605: {
	...
	config: [
		...
		// Kiwi_605 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_605 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_605/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_605$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_605
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_605 proxy object. All configs
