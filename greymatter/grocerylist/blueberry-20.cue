...
Blueberry_20: {
	...
	config: [
		...
		// Blueberry_20 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_20 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-20/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-20$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-20
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-20 proxy object. All configs
