...
Tangerine24: {
	...
	config: [
		...
		// Tangerine24 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine24 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine24/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine24$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine24
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine24 proxy object. All configs
