...
Kiwi61: {
	...
	config: [
		...
		// Kiwi61 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi61 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi61/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi61$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi61
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi61 proxy object. All configs
