...
Kiwi_64: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-64/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-64$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-64
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-64 proxy object. All configs
