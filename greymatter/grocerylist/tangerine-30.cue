...
Tangerine_30: {
	...
	config: [
		...
		// Tangerine_30 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_30 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-30/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-30$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-30
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-30 proxy object. All configs
