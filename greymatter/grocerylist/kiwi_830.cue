...
Kiwi_830: {
	...
	config: [
		...
		// Kiwi_830 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_830 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_830/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_830$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_830
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_830 proxy object. All configs
