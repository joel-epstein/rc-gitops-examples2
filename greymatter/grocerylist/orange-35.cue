...
Orange_35: {
	...
	config: [
		...
		// Orange_35 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_35 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-35/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-35$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-35
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-35 proxy object. All configs
