...
Tangerine25: {
	...
	config: [
		...
		// Tangerine25 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine25 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine25/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine25$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine25
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine25 proxy object. All configs
