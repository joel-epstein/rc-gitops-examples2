...
Melon_39: {
	...
	config: [
		...
		// Melon_39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-39
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-39 proxy object. All configs
