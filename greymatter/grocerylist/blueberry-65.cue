...
Blueberry_65: {
	...
	config: [
		...
		// Blueberry_65 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_65 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-65/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-65$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-65
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-65 proxy object. All configs
