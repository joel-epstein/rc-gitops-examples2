...
Kiwi_670: {
	...
	config: [
		...
		// Kiwi_670 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_670 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_670/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_670$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_670
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_670 proxy object. All configs
