...
Kiwi_255: {
	...
	config: [
		...
		// Kiwi_255 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_255 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_255/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_255$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_255
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_255 proxy object. All configs
