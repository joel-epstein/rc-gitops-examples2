...
Kiwi_924: {
	...
	config: [
		...
		// Kiwi_924 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_924 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_924/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_924$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_924
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_924 proxy object. All configs
