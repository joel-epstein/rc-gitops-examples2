...
Kiwi_774: {
	...
	config: [
		...
		// Kiwi_774 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_774 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_774/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_774$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_774
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_774 proxy object. All configs
