...
Kiwi_824: {
	...
	config: [
		...
		// Kiwi_824 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_824 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_824/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_824$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_824
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_824 proxy object. All configs
