...
Kiwi_773: {
	...
	config: [
		...
		// Kiwi_773 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_773 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_773/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_773$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_773
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_773 proxy object. All configs
