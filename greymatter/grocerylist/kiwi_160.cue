...
Kiwi_160: {
	...
	config: [
		...
		// Kiwi_160 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_160 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_160/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_160$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_160
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_160 proxy object. All configs
