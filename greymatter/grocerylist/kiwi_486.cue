...
Kiwi_486: {
	...
	config: [
		...
		// Kiwi_486 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_486 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_486/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_486$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_486
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_486 proxy object. All configs
