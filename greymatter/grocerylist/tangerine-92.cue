...
Tangerine_92: {
	...
	config: [
		...
		// Tangerine_92 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_92 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-92/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-92$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-92
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-92 proxy object. All configs
