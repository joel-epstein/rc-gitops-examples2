...
Kiwi92: {
	...
	config: [
		...
		// Kiwi92 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi92 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi92/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi92$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi92
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi92 proxy object. All configs
