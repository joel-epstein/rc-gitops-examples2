...
Kiwi_684: {
	...
	config: [
		...
		// Kiwi_684 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_684 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_684/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_684$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_684
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_684 proxy object. All configs
