...
Kiwi_548: {
	...
	config: [
		...
		// Kiwi_548 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_548 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_548/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_548$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_548
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_548 proxy object. All configs
