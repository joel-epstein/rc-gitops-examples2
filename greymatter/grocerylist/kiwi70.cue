...
Kiwi70: {
	...
	config: [
		...
		// Kiwi70 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi70/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi70$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi70
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi70 proxy object. All configs
