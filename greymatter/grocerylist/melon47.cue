...
Melon47: {
	...
	config: [
		...
		// Melon47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon47
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon47 proxy object. All configs
