...
Kiwi_592: {
	...
	config: [
		...
		// Kiwi_592 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_592 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_592/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_592$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_592
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_592 proxy object. All configs
