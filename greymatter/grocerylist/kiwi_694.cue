...
Kiwi_694: {
	...
	config: [
		...
		// Kiwi_694 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_694 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_694/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_694$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_694
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_694 proxy object. All configs
