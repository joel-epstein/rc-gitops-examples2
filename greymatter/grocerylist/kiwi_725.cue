...
Kiwi_725: {
	...
	config: [
		...
		// Kiwi_725 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_725 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_725/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_725$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_725
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_725 proxy object. All configs
