...
Melon1: {
	...
	config: [
		...
		// Melon1 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon1 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon1/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon1$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon1
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon1 proxy object. All configs
