...
Orange_94: {
	...
	config: [
		...
		// Orange_94 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_94 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-94/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-94$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-94
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-94 proxy object. All configs
