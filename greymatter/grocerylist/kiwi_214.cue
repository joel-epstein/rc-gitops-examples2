...
Kiwi_214: {
	...
	config: [
		...
		// Kiwi_214 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_214 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_214/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_214$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_214
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_214 proxy object. All configs
