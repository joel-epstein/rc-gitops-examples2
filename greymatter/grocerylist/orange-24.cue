...
Orange_24: {
	...
	config: [
		...
		// Orange_24 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_24 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-24/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-24$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-24
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-24 proxy object. All configs
