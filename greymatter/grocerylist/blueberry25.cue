...
Blueberry25: {
	...
	config: [
		...
		// Blueberry25 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry25 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry25/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry25$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry25
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry25 proxy object. All configs
