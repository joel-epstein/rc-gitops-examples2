...
Blueberry49: {
	...
	config: [
		...
		// Blueberry49 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry49 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry49/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry49$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry49
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry49 proxy object. All configs
