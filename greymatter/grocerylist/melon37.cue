...
Melon37: {
	...
	config: [
		...
		// Melon37 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon37 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon37/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon37$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon37
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon37 proxy object. All configs
