...
Cranberry10: {
	...
	config: [
		...
		// Cranberry10 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry10 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry10/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry10$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry10
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry10 proxy object. All configs
