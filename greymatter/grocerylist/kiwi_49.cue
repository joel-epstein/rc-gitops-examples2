...
Kiwi_49: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_49/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_49$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_49
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_49 proxy object. All configs
