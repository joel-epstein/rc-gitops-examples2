...
Cranberry_53: {
	...
	config: [
		...
		// Cranberry_53 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_53 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-53/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-53$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-53
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-53 proxy object. All configs
