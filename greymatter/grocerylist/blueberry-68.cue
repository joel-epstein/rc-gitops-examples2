...
Blueberry_68: {
	...
	config: [
		...
		// Blueberry_68 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_68 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-68/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-68$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-68
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-68 proxy object. All configs
