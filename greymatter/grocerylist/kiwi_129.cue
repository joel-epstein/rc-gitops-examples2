...
Kiwi_129: {
	...
	config: [
		...
		// Kiwi_129 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_129 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_129/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_129$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_129
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_129 proxy object. All configs
