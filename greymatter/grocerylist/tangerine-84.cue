...
Tangerine_84: {
	...
	config: [
		...
		// Tangerine_84 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_84 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-84/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-84$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-84
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-84 proxy object. All configs
