...
Melon_43: {
	...
	config: [
		...
		// Melon_43 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_43 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-43/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-43$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-43
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-43 proxy object. All configs
