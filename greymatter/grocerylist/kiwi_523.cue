...
Kiwi_523: {
	...
	config: [
		...
		// Kiwi_523 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_523 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_523/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_523$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_523
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_523 proxy object. All configs
