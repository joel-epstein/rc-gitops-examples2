...
Blueberry_92: {
	...
	config: [
		...
		// Blueberry_92 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_92 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-92/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-92$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-92
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-92 proxy object. All configs
