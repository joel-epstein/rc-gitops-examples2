...
Kiwi_904: {
	...
	config: [
		...
		// Kiwi_904 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_904 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_904/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_904$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_904
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_904 proxy object. All configs
