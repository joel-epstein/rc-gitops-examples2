...
Melon_74: {
	...
	config: [
		...
		// Melon_74 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_74 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-74/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-74$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-74
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-74 proxy object. All configs
