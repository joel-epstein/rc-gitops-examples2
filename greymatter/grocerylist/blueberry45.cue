...
Blueberry45: {
	...
	config: [
		...
		// Blueberry45 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry45 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry45/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry45$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry45
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry45 proxy object. All configs
