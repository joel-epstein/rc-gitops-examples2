...
Kiwi_993: {
	...
	config: [
		...
		// Kiwi_993 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_993 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_993/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_993$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_993
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_993 proxy object. All configs
