...
Kiwi66: {
	...
	config: [
		...
		// Kiwi66 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi66/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi66$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi66
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi66 proxy object. All configs
