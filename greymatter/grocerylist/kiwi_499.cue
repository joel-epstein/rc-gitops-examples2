...
Kiwi_499: {
	...
	config: [
		...
		// Kiwi_499 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_499 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_499/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_499$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_499
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_499 proxy object. All configs
