...
Tangerine_48: {
	...
	config: [
		...
		// Tangerine_48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-48
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-48 proxy object. All configs
