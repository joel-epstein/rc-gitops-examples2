...
Kiwi_380: {
	...
	config: [
		...
		// Kiwi_380 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_380 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_380/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_380$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_380
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_380 proxy object. All configs
