...
Kiwi_484: {
	...
	config: [
		...
		// Kiwi_484 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_484 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_484/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_484$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_484
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_484 proxy object. All configs
