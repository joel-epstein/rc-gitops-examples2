...
Kiwi_716: {
	...
	config: [
		...
		// Kiwi_716 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_716 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_716/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_716$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_716
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_716 proxy object. All configs
