...
Blueberry_49: {
	...
	config: [
		...
		// Blueberry_49 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_49 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-49/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-49$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-49
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-49 proxy object. All configs
