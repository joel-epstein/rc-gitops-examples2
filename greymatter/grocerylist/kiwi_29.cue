...
Kiwi_29: {
	...
	config: [
		...
		// Kiwi_29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_29
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_29 proxy object. All configs
