...
Kiwi_426: {
	...
	config: [
		...
		// Kiwi_426 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_426 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_426/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_426$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_426
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_426 proxy object. All configs
