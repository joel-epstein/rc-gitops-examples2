...
Kiwi_317: {
	...
	config: [
		...
		// Kiwi_317 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_317 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_317/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_317$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_317
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_317 proxy object. All configs
