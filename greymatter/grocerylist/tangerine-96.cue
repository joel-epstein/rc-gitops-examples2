...
Tangerine_96: {
	...
	config: [
		...
		// Tangerine_96 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_96 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-96/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-96$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-96
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-96 proxy object. All configs
