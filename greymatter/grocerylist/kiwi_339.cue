...
Kiwi_339: {
	...
	config: [
		...
		// Kiwi_339 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_339 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_339/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_339$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_339
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_339 proxy object. All configs
