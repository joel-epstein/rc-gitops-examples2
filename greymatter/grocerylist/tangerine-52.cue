...
Tangerine_52: {
	...
	config: [
		...
		// Tangerine_52 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_52 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-52/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-52$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-52
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-52 proxy object. All configs
