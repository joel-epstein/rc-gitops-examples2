...
Kiwi_149: {
	...
	config: [
		...
		// Kiwi_149 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_149 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_149/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_149$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_149
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_149 proxy object. All configs
