...
Kiwi_204: {
	...
	config: [
		...
		// Kiwi_204 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_204 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_204/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_204$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_204
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_204 proxy object. All configs
