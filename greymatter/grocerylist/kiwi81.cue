...
Kiwi81: {
	...
	config: [
		...
		// Kiwi81 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi81/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi81$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi81
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi81 proxy object. All configs
