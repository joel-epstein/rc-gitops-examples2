...
Kiwi_448: {
	...
	config: [
		...
		// Kiwi_448 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_448 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_448/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_448$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_448
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_448 proxy object. All configs
