...
Kiwi_732: {
	...
	config: [
		...
		// Kiwi_732 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_732 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_732/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_732$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_732
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_732 proxy object. All configs
