...
Kiwi_268: {
	...
	config: [
		...
		// Kiwi_268 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_268 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_268/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_268$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_268
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_268 proxy object. All configs
