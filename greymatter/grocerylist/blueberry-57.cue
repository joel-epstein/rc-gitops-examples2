...
Blueberry_57: {
	...
	config: [
		...
		// Blueberry_57 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_57 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-57/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-57$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-57
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-57 proxy object. All configs
