...
Cranberry21: {
	...
	config: [
		...
		// Cranberry21 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry21 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry21/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry21$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry21
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry21 proxy object. All configs
