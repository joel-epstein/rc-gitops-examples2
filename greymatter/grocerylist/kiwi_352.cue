...
Kiwi_352: {
	...
	config: [
		...
		// Kiwi_352 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_352 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_352/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_352$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_352
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_352 proxy object. All configs
