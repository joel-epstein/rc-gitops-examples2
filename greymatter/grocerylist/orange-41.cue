...
Orange_41: {
	...
	config: [
		...
		// Orange_41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-41
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-41 proxy object. All configs
