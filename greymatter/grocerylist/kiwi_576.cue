...
Kiwi_576: {
	...
	config: [
		...
		// Kiwi_576 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_576 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_576/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_576$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_576
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_576 proxy object. All configs
