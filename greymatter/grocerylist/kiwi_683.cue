...
Kiwi_683: {
	...
	config: [
		...
		// Kiwi_683 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_683 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_683/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_683$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_683
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_683 proxy object. All configs
