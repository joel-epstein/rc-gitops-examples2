...
Melon_14: {
	...
	config: [
		...
		// Melon_14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-14
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-14 proxy object. All configs
