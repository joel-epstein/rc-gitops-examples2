...
Kiwi_436: {
	...
	config: [
		...
		// Kiwi_436 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_436 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_436/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_436$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_436
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_436 proxy object. All configs
