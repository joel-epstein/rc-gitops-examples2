...
Kiwi_922: {
	...
	config: [
		...
		// Kiwi_922 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_922 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_922/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_922$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_922
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_922 proxy object. All configs
