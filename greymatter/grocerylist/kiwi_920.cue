...
Kiwi_920: {
	...
	config: [
		...
		// Kiwi_920 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_920 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_920/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_920$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_920
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_920 proxy object. All configs
