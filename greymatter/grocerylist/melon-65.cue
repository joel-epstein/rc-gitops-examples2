...
Melon_65: {
	...
	config: [
		...
		// Melon_65 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_65 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-65/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-65$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-65
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-65 proxy object. All configs
