...
Tangerine_43: {
	...
	config: [
		...
		// Tangerine_43 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_43 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-43/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-43$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-43
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-43 proxy object. All configs
