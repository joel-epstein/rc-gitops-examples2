...
Kiwi_39: {
	...
	config: [
		...
		// Kiwi_39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-39
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-39 proxy object. All configs
