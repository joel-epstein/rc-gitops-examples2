...
Star11: {
	...
	config: [
		...
		// Star11 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star11 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star11/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star11$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star11
		#catalog_entry & {
			name:                      Name
		...
		// Shared star11 proxy object. All configs
