...
Kiwi_142: {
	...
	config: [
		...
		// Kiwi_142 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_142 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_142/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_142$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_142
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_142 proxy object. All configs
