...
Kiwi_358: {
	...
	config: [
		...
		// Kiwi_358 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_358 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_358/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_358$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_358
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_358 proxy object. All configs
