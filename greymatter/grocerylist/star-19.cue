...
Star_19: {
	...
	config: [
		...
		// Star_19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-19
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-19 proxy object. All configs
