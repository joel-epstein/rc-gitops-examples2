...
Cranberry45: {
	...
	config: [
		...
		// Cranberry45 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry45 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry45/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry45$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry45
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry45 proxy object. All configs
