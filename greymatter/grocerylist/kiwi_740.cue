...
Kiwi_740: {
	...
	config: [
		...
		// Kiwi_740 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_740 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_740/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_740$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_740
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_740 proxy object. All configs
