...
Kiwi_5: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-5/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-5$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-5
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-5 proxy object. All configs
