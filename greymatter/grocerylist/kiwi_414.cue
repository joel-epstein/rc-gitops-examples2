...
Kiwi_414: {
	...
	config: [
		...
		// Kiwi_414 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_414 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_414/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_414$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_414
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_414 proxy object. All configs
