...
Kiwi94: {
	...
	config: [
		...
		// Kiwi94 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi94/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi94$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi94
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi94 proxy object. All configs
