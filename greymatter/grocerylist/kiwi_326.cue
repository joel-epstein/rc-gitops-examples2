...
Kiwi_326: {
	...
	config: [
		...
		// Kiwi_326 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_326 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_326/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_326$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_326
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_326 proxy object. All configs
