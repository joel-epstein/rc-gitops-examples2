...
Blueberry39: {
	...
	config: [
		...
		// Blueberry39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry39
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry39 proxy object. All configs
