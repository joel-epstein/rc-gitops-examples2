...
Blueberry5: {
	...
	config: [
		...
		// Blueberry5 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry5 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry5/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry5$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry5
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry5 proxy object. All configs
