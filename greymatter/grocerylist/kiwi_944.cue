...
Kiwi_944: {
	...
	config: [
		...
		// Kiwi_944 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_944 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_944/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_944$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_944
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_944 proxy object. All configs
