...
Kiwi_782: {
	...
	config: [
		...
		// Kiwi_782 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_782 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_782/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_782$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_782
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_782 proxy object. All configs
