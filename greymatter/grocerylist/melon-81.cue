...
Melon_81: {
	...
	config: [
		...
		// Melon_81 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_81 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-81/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-81$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-81
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-81 proxy object. All configs
