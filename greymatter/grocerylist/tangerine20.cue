...
Tangerine20: {
	...
	config: [
		...
		// Tangerine20 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine20 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine20/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine20$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine20
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine20 proxy object. All configs
