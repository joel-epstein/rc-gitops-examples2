...
Kiwi_588: {
	...
	config: [
		...
		// Kiwi_588 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_588 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_588/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_588$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_588
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_588 proxy object. All configs
