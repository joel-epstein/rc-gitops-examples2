...
Kiwi_353: {
	...
	config: [
		...
		// Kiwi_353 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_353 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_353/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_353$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_353
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_353 proxy object. All configs
