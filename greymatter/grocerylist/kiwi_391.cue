...
Kiwi_391: {
	...
	config: [
		...
		// Kiwi_391 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_391 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_391/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_391$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_391
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_391 proxy object. All configs
