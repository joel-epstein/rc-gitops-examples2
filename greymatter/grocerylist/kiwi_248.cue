...
Kiwi_248: {
	...
	config: [
		...
		// Kiwi_248 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_248 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_248/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_248$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_248
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_248 proxy object. All configs
