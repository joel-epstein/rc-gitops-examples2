...
Kiwi_407: {
	...
	config: [
		...
		// Kiwi_407 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_407 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_407/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_407$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_407
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_407 proxy object. All configs
