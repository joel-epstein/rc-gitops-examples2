...
Orange_62: {
	...
	config: [
		...
		// Orange_62 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_62 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-62/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-62$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-62
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-62 proxy object. All configs
