...
Kiwi_105: {
	...
	config: [
		...
		// Kiwi_105 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_105 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_105/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_105$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_105
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_105 proxy object. All configs
