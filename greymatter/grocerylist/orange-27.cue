...
Orange_27: {
	...
	config: [
		...
		// Orange_27 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_27 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-27/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-27$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-27
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-27 proxy object. All configs
