...
Kiwi_853: {
	...
	config: [
		...
		// Kiwi_853 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_853 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_853/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_853$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_853
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_853 proxy object. All configs
