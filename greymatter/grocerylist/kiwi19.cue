...
Kiwi19: {
	...
	config: [
		...
		// Kiwi19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi19
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi19 proxy object. All configs
