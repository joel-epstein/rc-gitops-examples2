...
Kiwi_622: {
	...
	config: [
		...
		// Kiwi_622 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_622 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_622/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_622$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_622
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_622 proxy object. All configs
