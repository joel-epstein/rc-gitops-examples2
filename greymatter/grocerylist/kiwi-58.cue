...
Kiwi_58: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-58/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-58$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-58
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-58 proxy object. All configs
