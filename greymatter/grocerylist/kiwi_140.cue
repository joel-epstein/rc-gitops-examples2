...
Kiwi_140: {
	...
	config: [
		...
		// Kiwi_140 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_140 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_140/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_140$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_140
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_140 proxy object. All configs
