...
Kiwi_192: {
	...
	config: [
		...
		// Kiwi_192 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_192 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_192/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_192$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_192
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_192 proxy object. All configs
