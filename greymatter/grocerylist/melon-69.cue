...
Melon_69: {
	...
	config: [
		...
		// Melon_69 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_69 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-69/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-69$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-69
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-69 proxy object. All configs
