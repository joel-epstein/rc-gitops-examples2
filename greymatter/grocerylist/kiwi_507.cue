...
Kiwi_507: {
	...
	config: [
		...
		// Kiwi_507 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_507 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_507/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_507$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_507
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_507 proxy object. All configs
