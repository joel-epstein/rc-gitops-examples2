...
Kiwi_79: {
	...
	config: [
		...
		// Kiwi_79 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_79 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-79/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-79$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-79
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-79 proxy object. All configs
