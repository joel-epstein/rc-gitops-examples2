...
Orange_56: {
	...
	config: [
		...
		// Orange_56 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_56 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-56/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-56$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-56
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-56 proxy object. All configs
