...
Kiwi_28: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_28
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_28 proxy object. All configs
