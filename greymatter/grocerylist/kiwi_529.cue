...
Kiwi_529: {
	...
	config: [
		...
		// Kiwi_529 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_529 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_529/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_529$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_529
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_529 proxy object. All configs
