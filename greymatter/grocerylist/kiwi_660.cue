...
Kiwi_660: {
	...
	config: [
		...
		// Kiwi_660 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_660 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_660/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_660$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_660
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_660 proxy object. All configs
