...
Tangerine7: {
	...
	config: [
		...
		// Tangerine7 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine7 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine7/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine7$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine7
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine7 proxy object. All configs
