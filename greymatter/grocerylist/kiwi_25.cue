...
Kiwi_25: {
	...
	config: [
		...
		// Kiwi_25 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_25 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_25/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_25$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_25
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_25 proxy object. All configs
