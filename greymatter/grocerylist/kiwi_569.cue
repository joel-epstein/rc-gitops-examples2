...
Kiwi_569: {
	...
	config: [
		...
		// Kiwi_569 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_569 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_569/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_569$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_569
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_569 proxy object. All configs
