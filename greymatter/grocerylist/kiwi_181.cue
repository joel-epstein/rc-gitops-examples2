...
Kiwi_181: {
	...
	config: [
		...
		// Kiwi_181 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_181 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_181/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_181$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_181
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_181 proxy object. All configs
