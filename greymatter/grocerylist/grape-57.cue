...
Grape_57: {
	...
	config: [
		...
		// Grape_57 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_57 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-57/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-57$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-57
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-57 proxy object. All configs
