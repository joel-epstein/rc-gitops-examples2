...
Melon_41: {
	...
	config: [
		...
		// Melon_41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-41
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-41 proxy object. All configs
