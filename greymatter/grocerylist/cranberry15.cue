...
Cranberry15: {
	...
	config: [
		...
		// Cranberry15 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry15 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry15/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry15$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry15
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry15 proxy object. All configs
