...
Orange_21: {
	...
	config: [
		...
		// Orange_21 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_21 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-21/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-21$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-21
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-21 proxy object. All configs
