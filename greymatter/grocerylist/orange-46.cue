...
Orange_46: {
	...
	config: [
		...
		// Orange_46 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_46 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-46
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-46 proxy object. All configs
