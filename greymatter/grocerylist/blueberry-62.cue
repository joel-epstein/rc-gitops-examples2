...
Blueberry_62: {
	...
	config: [
		...
		// Blueberry_62 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_62 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-62/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-62$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-62
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-62 proxy object. All configs
