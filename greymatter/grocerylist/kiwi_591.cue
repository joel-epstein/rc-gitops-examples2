...
Kiwi_591: {
	...
	config: [
		...
		// Kiwi_591 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_591 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_591/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_591$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_591
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_591 proxy object. All configs
