...
Tangerine_49: {
	...
	config: [
		...
		// Tangerine_49 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_49 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-49/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-49$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-49
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-49 proxy object. All configs
