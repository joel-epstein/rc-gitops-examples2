...
Kiwi_32: {
	...
	config: [
		...
		// Kiwi_32 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_32 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_32/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_32$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_32
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_32 proxy object. All configs
