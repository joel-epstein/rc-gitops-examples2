...
Kiwi_530: {
	...
	config: [
		...
		// Kiwi_530 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_530 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_530/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_530$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_530
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_530 proxy object. All configs
