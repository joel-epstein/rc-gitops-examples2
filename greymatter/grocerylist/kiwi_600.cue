...
Kiwi_600: {
	...
	config: [
		...
		// Kiwi_600 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_600 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_600/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_600$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_600
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_600 proxy object. All configs
