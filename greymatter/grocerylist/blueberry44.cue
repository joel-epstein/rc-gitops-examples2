...
Blueberry44: {
	...
	config: [
		...
		// Blueberry44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry44
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry44 proxy object. All configs
