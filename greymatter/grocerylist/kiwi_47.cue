...
Kiwi_47: {
	...
	config: [
		...
		// Kiwi_47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_47
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_47 proxy object. All configs
