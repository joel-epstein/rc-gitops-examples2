...
Kiwi_464: {
	...
	config: [
		...
		// Kiwi_464 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_464 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_464/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_464$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_464
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_464 proxy object. All configs
