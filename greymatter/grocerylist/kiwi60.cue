...
Kiwi60: {
	...
	config: [
		...
		// Kiwi60 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi60 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi60/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi60$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi60
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi60 proxy object. All configs
