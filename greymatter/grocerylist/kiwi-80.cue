...
Kiwi_80: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-80/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-80$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-80
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-80 proxy object. All configs
