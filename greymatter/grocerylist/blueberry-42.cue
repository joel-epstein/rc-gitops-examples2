...
Blueberry_42: {
	...
	config: [
		...
		// Blueberry_42 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_42 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-42/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-42$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-42
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-42 proxy object. All configs
