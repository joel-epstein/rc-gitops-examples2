...
Kiwi_929: {
	...
	config: [
		...
		// Kiwi_929 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_929 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_929/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_929$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_929
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_929 proxy object. All configs
