...
Kiwi_839: {
	...
	config: [
		...
		// Kiwi_839 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_839 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_839/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_839$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_839
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_839 proxy object. All configs
