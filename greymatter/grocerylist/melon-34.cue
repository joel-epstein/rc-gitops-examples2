...
Melon_34: {
	...
	config: [
		...
		// Melon_34 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_34 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-34
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-34 proxy object. All configs
