...
Tangerine_47: {
	...
	config: [
		...
		// Tangerine_47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-47
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-47 proxy object. All configs
