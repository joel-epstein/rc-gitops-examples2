...
Melon16: {
	...
	config: [
		...
		// Melon16 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon16 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon16/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon16$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon16
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon16 proxy object. All configs
