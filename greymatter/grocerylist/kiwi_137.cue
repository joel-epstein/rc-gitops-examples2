...
Kiwi_137: {
	...
	config: [
		...
		// Kiwi_137 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_137 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_137/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_137$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_137
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_137 proxy object. All configs
