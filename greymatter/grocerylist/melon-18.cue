...
Melon_18: {
	...
	config: [
		...
		// Melon_18 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_18 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-18/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-18$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-18
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-18 proxy object. All configs
