...
Orange_44: {
	...
	config: [
		...
		// Orange_44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-44
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-44 proxy object. All configs
