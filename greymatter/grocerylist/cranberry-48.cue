...
Cranberry_48: {
	...
	config: [
		...
		// Cranberry_48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-48
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-48 proxy object. All configs
