...
Kiwi51: {
	...
	config: [
		...
		// Kiwi51 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi51 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi51/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi51$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi51
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi51 proxy object. All configs
