...
Grape_72: {
	...
	config: [
		...
		// Grape_72 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_72 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-72/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-72$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-72
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-72 proxy object. All configs
