...
Kiwi_867: {
	...
	config: [
		...
		// Kiwi_867 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_867 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_867/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_867$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_867
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_867 proxy object. All configs
