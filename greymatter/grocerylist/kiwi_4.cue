...
Kiwi_4: {
	...
	config: [
		...
		// Kiwi_4 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_4 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_4/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_4$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_4
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_4 proxy object. All configs
