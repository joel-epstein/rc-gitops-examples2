...
Kiwi_752: {
	...
	config: [
		...
		// Kiwi_752 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_752 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_752/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_752$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_752
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_752 proxy object. All configs
