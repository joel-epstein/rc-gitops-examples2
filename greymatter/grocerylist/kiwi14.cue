...
Kiwi14: {
	...
	config: [
		...
		// Kiwi14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi14
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi14 proxy object. All configs
