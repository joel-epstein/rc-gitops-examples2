...
Kiwi_668: {
	...
	config: [
		...
		// Kiwi_668 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_668 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_668/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_668$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_668
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_668 proxy object. All configs
