...
Kiwi_791: {
	...
	config: [
		...
		// Kiwi_791 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_791 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_791/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_791$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_791
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_791 proxy object. All configs
