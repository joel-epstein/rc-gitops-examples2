...
Kiwi_121: {
	...
	config: [
		...
		// Kiwi_121 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_121 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_121/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_121$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_121
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_121 proxy object. All configs
