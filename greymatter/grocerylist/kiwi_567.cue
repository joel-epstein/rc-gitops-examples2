...
Kiwi_567: {
	...
	config: [
		...
		// Kiwi_567 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_567 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_567/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_567$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_567
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_567 proxy object. All configs
