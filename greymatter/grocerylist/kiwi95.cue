...
Kiwi95: {
	...
	config: [
		...
		// Kiwi95 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi95/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi95$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi95
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi95 proxy object. All configs
