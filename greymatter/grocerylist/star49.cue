...
Star49: {
	...
	config: [
		...
		// Star49 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star49 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star49/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star49$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star49
		#catalog_entry & {
			name:                      Name
		...
		// Shared star49 proxy object. All configs
