...
Kiwi8: {
	...
	config: [
		...
		// Kiwi8 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi8 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi8/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi8$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi8
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi8 proxy object. All configs
