...
Kiwi_162: {
	...
	config: [
		...
		// Kiwi_162 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_162 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_162/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_162$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_162
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_162 proxy object. All configs
