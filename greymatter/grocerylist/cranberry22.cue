...
Cranberry22: {
	...
	config: [
		...
		// Cranberry22 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry22 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry22
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry22 proxy object. All configs
