...
Melon22: {
	...
	config: [
		...
		// Melon22 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon22 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon22
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon22 proxy object. All configs
