...
Kiwi_610: {
	...
	config: [
		...
		// Kiwi_610 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_610 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_610/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_610$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_610
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_610 proxy object. All configs
