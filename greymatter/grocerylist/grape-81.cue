...
Grape_81: {
	...
	config: [
		...
		// Grape_81 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_81 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-81/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-81$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-81
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-81 proxy object. All configs
