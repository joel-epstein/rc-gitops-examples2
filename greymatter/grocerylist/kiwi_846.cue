...
Kiwi_846: {
	...
	config: [
		...
		// Kiwi_846 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_846 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_846/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_846$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_846
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_846 proxy object. All configs
