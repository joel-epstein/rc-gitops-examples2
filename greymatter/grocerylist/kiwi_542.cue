...
Kiwi_542: {
	...
	config: [
		...
		// Kiwi_542 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_542 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_542/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_542$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_542
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_542 proxy object. All configs
