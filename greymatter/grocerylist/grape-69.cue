...
Grape_69: {
	...
	config: [
		...
		// Grape_69 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_69 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-69/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-69$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-69
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-69 proxy object. All configs
