...
Cranberry44: {
	...
	config: [
		...
		// Cranberry44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry44
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry44 proxy object. All configs
