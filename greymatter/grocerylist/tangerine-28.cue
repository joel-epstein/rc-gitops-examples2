...
Tangerine_28: {
	...
	config: [
		...
		// Tangerine_28 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_28 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-28
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-28 proxy object. All configs
