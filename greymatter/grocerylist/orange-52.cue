...
Orange_52: {
	...
	config: [
		...
		// Orange_52 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_52 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-52/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-52$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-52
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-52 proxy object. All configs
