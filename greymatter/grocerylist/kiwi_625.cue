...
Kiwi_625: {
	...
	config: [
		...
		// Kiwi_625 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_625 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_625/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_625$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_625
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_625 proxy object. All configs
