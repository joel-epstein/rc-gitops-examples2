...
Star_44: {
	...
	config: [
		...
		// Star_44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-44
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-44 proxy object. All configs
