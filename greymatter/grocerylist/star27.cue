...
Star27: {
	...
	config: [
		...
		// Star27 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star27 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star27/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star27$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star27
		#catalog_entry & {
			name:                      Name
		...
		// Shared star27 proxy object. All configs
