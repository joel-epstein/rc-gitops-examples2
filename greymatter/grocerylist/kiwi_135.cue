...
Kiwi_135: {
	...
	config: [
		...
		// Kiwi_135 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_135 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_135/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_135$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_135
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_135 proxy object. All configs
