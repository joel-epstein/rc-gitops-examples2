...
Orange_19: {
	...
	config: [
		...
		// Orange_19 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_19 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-19/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-19$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-19
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-19 proxy object. All configs
