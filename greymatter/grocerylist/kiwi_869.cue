...
Kiwi_869: {
	...
	config: [
		...
		// Kiwi_869 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_869 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_869/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_869$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_869
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_869 proxy object. All configs
