...
Kiwi_609: {
	...
	config: [
		...
		// Kiwi_609 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_609 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_609/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_609$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_609
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_609 proxy object. All configs
