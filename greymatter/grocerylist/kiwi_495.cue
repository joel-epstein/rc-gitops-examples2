...
Kiwi_495: {
	...
	config: [
		...
		// Kiwi_495 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_495 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_495/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_495$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_495
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_495 proxy object. All configs
