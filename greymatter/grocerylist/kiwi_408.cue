...
Kiwi_408: {
	...
	config: [
		...
		// Kiwi_408 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_408 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_408/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_408$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_408
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_408 proxy object. All configs
