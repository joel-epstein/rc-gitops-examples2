...
Kiwi_305: {
	...
	config: [
		...
		// Kiwi_305 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_305 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_305/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_305$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_305
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_305 proxy object. All configs
