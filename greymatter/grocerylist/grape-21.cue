...
Grape_21: {
	...
	config: [
		...
		// Grape_21 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_21 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-21/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-21$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-21
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-21 proxy object. All configs
