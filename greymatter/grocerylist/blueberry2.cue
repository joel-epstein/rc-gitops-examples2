...
Blueberry2: {
	...
	config: [
		...
		// Blueberry2 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry2 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry2/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry2$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry2
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry2 proxy object. All configs
