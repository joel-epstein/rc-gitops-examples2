...
Orange_64: {
	...
	config: [
		...
		// Orange_64 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_64 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-64/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-64$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-64
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-64 proxy object. All configs
