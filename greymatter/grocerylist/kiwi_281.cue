...
Kiwi_281: {
	...
	config: [
		...
		// Kiwi_281 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_281 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_281/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_281$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_281
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_281 proxy object. All configs
