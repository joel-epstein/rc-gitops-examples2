...
Tangerine31: {
	...
	config: [
		...
		// Tangerine31 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine31 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine31/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine31$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine31
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine31 proxy object. All configs
