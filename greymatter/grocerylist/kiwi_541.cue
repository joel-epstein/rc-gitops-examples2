...
Kiwi_541: {
	...
	config: [
		...
		// Kiwi_541 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_541 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_541/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_541$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_541
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_541 proxy object. All configs
