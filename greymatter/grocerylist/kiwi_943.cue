...
Kiwi_943: {
	...
	config: [
		...
		// Kiwi_943 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_943 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_943/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_943$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_943
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_943 proxy object. All configs
