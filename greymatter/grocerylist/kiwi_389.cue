...
Kiwi_389: {
	...
	config: [
		...
		// Kiwi_389 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_389 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_389/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_389$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_389
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_389 proxy object. All configs
