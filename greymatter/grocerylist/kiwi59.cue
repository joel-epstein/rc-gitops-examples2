...
Kiwi59: {
	...
	config: [
		...
		// Kiwi59 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi59/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi59$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi59
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi59 proxy object. All configs
