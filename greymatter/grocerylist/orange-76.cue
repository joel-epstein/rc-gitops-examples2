...
Orange_76: {
	...
	config: [
		...
		// Orange_76 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_76 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-76/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-76$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-76
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-76 proxy object. All configs
