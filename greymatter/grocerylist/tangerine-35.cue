...
Tangerine_35: {
	...
	config: [
		...
		// Tangerine_35 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_35 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-35/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-35$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-35
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-35 proxy object. All configs
