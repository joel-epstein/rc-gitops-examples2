...
Kiwi_761: {
	...
	config: [
		...
		// Kiwi_761 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_761 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_761/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_761$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_761
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_761 proxy object. All configs
