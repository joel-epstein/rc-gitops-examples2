...
Melon_97: {
	...
	config: [
		...
		// Melon_97 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_97 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-97/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-97$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-97
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-97 proxy object. All configs
