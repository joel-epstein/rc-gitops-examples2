...
Blueberry41: {
	...
	config: [
		...
		// Blueberry41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry41
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry41 proxy object. All configs
