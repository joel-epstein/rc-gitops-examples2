...
Kiwi_805: {
	...
	config: [
		...
		// Kiwi_805 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_805 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_805/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_805$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_805
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_805 proxy object. All configs
