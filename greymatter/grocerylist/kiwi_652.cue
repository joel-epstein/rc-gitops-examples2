...
Kiwi_652: {
	...
	config: [
		...
		// Kiwi_652 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_652 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_652/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_652$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_652
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_652 proxy object. All configs
