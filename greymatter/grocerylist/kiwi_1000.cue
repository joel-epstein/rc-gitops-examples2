...
Kiwi_1000: {
	...
	config: [
		...
		// Kiwi_1000 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_1000 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_1000/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_1000$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_1000
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_1000 proxy object. All configs
