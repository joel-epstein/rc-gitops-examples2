...
Melon_42: {
	...
	config: [
		...
		// Melon_42 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_42 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-42/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-42$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-42
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-42 proxy object. All configs
