...
Grape_47: {
	...
	config: [
		...
		// Grape_47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-47
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-47 proxy object. All configs
