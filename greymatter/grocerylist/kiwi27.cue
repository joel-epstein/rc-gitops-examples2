...
Kiwi27: {
	...
	config: [
		...
		// Kiwi27 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi27/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi27$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi27
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi27 proxy object. All configs
