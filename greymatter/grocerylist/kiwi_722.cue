...
Kiwi_722: {
	...
	config: [
		...
		// Kiwi_722 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_722 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_722/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_722$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_722
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_722 proxy object. All configs
