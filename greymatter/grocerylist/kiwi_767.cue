...
Kiwi_767: {
	...
	config: [
		...
		// Kiwi_767 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_767 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_767/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_767$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_767
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_767 proxy object. All configs
