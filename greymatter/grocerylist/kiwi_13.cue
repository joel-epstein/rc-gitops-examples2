...
Kiwi_13: {
	...
	config: [
		...
		// Kiwi_13 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_13 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_13
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_13 proxy object. All configs
