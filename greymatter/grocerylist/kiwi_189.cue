...
Kiwi_189: {
	...
	config: [
		...
		// Kiwi_189 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_189 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_189/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_189$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_189
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_189 proxy object. All configs
