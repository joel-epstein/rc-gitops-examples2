...
Orange_18: {
	...
	config: [
		...
		// Orange_18 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_18 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-18/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-18$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-18
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-18 proxy object. All configs
