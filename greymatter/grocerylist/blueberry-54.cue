...
Blueberry_54: {
	...
	config: [
		...
		// Blueberry_54 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_54 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-54/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-54$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-54
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-54 proxy object. All configs
