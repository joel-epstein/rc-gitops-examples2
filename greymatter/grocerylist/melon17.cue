...
Melon17: {
	...
	config: [
		...
		// Melon17 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon17 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon17
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon17 proxy object. All configs
