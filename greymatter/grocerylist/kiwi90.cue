...
Kiwi90: {
	...
	config: [
		...
		// Kiwi90 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi90 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi90/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi90$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi90
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi90 proxy object. All configs
