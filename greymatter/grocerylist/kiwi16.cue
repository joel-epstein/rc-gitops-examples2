...
Kiwi16: {
	...
	config: [
		...
		// Kiwi16 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi16/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi16$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi16
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi16 proxy object. All configs
