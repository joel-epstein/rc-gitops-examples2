...
Kiwi_423: {
	...
	config: [
		...
		// Kiwi_423 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_423 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_423/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_423$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_423
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_423 proxy object. All configs
