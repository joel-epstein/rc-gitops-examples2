...
Kiwi_939: {
	...
	config: [
		...
		// Kiwi_939 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_939 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_939/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_939$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_939
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_939 proxy object. All configs
