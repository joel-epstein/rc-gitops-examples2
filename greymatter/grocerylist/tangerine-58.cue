...
Tangerine_58: {
	...
	config: [
		...
		// Tangerine_58 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_58 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-58/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-58$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-58
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-58 proxy object. All configs
