...
Kiwi_537: {
	...
	config: [
		...
		// Kiwi_537 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_537 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_537/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_537$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_537
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_537 proxy object. All configs
