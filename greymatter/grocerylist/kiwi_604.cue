...
Kiwi_604: {
	...
	config: [
		...
		// Kiwi_604 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_604 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_604/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_604$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_604
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_604 proxy object. All configs
