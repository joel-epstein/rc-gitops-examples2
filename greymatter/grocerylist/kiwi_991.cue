...
Kiwi_991: {
	...
	config: [
		...
		// Kiwi_991 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_991 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_991/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_991$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_991
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_991 proxy object. All configs
