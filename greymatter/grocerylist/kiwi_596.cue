...
Kiwi_596: {
	...
	config: [
		...
		// Kiwi_596 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_596 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_596/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_596$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_596
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_596 proxy object. All configs
