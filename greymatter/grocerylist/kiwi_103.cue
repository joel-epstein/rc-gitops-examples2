...
Kiwi_103: {
	...
	config: [
		...
		// Kiwi_103 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_103 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_103/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_103$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_103
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_103 proxy object. All configs
