...
Melon_35: {
	...
	config: [
		...
		// Melon_35 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_35 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-35/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-35$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-35
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-35 proxy object. All configs
