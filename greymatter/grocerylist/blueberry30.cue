...
Blueberry30: {
	...
	config: [
		...
		// Blueberry30 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry30 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry30/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry30$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry30
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry30 proxy object. All configs
