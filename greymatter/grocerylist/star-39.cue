...
Star_39: {
	...
	config: [
		...
		// Star_39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-39
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-39 proxy object. All configs
