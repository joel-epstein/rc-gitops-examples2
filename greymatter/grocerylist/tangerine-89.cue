...
Tangerine_89: {
	...
	config: [
		...
		// Tangerine_89 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_89 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-89/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-89$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-89
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-89 proxy object. All configs
