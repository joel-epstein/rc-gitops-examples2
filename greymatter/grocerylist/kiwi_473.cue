...
Kiwi_473: {
	...
	config: [
		...
		// Kiwi_473 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_473 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_473/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_473$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_473
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_473 proxy object. All configs
