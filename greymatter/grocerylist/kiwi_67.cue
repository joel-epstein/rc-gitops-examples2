...
Kiwi_67: {
	...
	config: [
		...
		// Kiwi_67 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_67 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_67/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_67$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_67
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_67 proxy object. All configs
