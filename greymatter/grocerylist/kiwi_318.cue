...
Kiwi_318: {
	...
	config: [
		...
		// Kiwi_318 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_318 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_318/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_318$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_318
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_318 proxy object. All configs
