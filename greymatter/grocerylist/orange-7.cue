...
Orange_7: {
	...
	config: [
		...
		// Orange_7 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_7 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-7/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-7$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-7
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-7 proxy object. All configs
