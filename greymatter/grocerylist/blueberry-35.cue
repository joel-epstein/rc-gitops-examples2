...
Blueberry_35: {
	...
	config: [
		...
		// Blueberry_35 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_35 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-35/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-35$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-35
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-35 proxy object. All configs
