...
Kiwi_58: {
	...
	config: [
		...
		// Kiwi_58 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_58 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_58/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_58$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_58
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_58 proxy object. All configs
