...
Kiwi_875: {
	...
	config: [
		...
		// Kiwi_875 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_875 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_875/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_875$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_875
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_875 proxy object. All configs
