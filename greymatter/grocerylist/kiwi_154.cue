...
Kiwi_154: {
	...
	config: [
		...
		// Kiwi_154 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_154 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_154/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_154$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_154
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_154 proxy object. All configs
