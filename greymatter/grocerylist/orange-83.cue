...
Orange_83: {
	...
	config: [
		...
		// Orange_83 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_83 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-83/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-83$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-83
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-83 proxy object. All configs
