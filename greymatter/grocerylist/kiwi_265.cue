...
Kiwi_265: {
	...
	config: [
		...
		// Kiwi_265 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_265 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_265/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_265$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_265
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_265 proxy object. All configs
