...
Kiwi_244: {
	...
	config: [
		...
		// Kiwi_244 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_244 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_244/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_244$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_244
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_244 proxy object. All configs
