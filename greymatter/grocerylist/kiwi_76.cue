...
Kiwi_76: {
	...
	config: [
		...
		// Kiwi_76 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_76 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_76/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_76$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_76
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_76 proxy object. All configs
