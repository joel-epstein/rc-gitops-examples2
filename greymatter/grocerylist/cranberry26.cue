...
Cranberry26: {
	...
	config: [
		...
		// Cranberry26 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry26 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry26/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry26$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry26
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry26 proxy object. All configs
