...
Kiwi_844: {
	...
	config: [
		...
		// Kiwi_844 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_844 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_844/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_844$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_844
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_844 proxy object. All configs
