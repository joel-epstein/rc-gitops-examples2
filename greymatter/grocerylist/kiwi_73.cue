...
Kiwi_73: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_73/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_73$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_73
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_73 proxy object. All configs
