...
Kiwi_405: {
	...
	config: [
		...
		// Kiwi_405 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_405 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_405/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_405$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_405
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_405 proxy object. All configs
