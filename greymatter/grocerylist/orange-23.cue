...
Orange_23: {
	...
	config: [
		...
		// Orange_23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-23
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-23 proxy object. All configs
