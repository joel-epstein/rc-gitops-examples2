...
Star26: {
	...
	config: [
		...
		// Star26 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star26 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star26/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star26$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star26
		#catalog_entry & {
			name:                      Name
		...
		// Shared star26 proxy object. All configs
