...
Kiwi_923: {
	...
	config: [
		...
		// Kiwi_923 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_923 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_923/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_923$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_923
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_923 proxy object. All configs
