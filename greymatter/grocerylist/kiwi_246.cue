...
Kiwi_246: {
	...
	config: [
		...
		// Kiwi_246 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_246 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_246/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_246$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_246
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_246 proxy object. All configs
