...
Tangerine46: {
	...
	config: [
		...
		// Tangerine46 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine46 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine46
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine46 proxy object. All configs
