...
Melon_28: {
	...
	config: [
		...
		// Melon_28 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_28 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-28
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-28 proxy object. All configs
