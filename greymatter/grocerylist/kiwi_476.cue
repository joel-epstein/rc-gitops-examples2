...
Kiwi_476: {
	...
	config: [
		...
		// Kiwi_476 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_476 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_476/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_476$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_476
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_476 proxy object. All configs
