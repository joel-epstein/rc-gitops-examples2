...
Kiwi_48: {
	...
	config: [
		...
		// Kiwi_48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-48
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-48 proxy object. All configs
