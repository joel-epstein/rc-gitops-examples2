...
Kiwi_89: {
	...
	config: [
		...
		// Kiwi_89 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_89 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_89/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_89$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_89
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_89 proxy object. All configs
