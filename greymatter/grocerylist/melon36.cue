...
Melon36: {
	...
	config: [
		...
		// Melon36 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon36 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon36
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon36 proxy object. All configs
