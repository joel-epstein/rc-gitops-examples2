...
Kiwi_312: {
	...
	config: [
		...
		// Kiwi_312 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_312 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_312/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_312$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_312
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_312 proxy object. All configs
