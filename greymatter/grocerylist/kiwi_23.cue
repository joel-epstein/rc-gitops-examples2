...
Kiwi_23: {
	...
	config: [
		...
		// Kiwi_23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_23
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_23 proxy object. All configs
