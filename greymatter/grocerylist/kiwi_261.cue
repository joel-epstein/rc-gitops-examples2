...
Kiwi_261: {
	...
	config: [
		...
		// Kiwi_261 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_261 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_261/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_261$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_261
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_261 proxy object. All configs
