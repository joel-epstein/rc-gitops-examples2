...
Kiwi_977: {
	...
	config: [
		...
		// Kiwi_977 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_977 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_977/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_977$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_977
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_977 proxy object. All configs
