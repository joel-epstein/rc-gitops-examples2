...
Kiwi_646: {
	...
	config: [
		...
		// Kiwi_646 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_646 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_646/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_646$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_646
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_646 proxy object. All configs
