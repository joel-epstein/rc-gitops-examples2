...
Melon_54: {
	...
	config: [
		...
		// Melon_54 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_54 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-54/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-54$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-54
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-54 proxy object. All configs
