...
Kiwi_582: {
	...
	config: [
		...
		// Kiwi_582 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_582 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_582/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_582$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_582
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_582 proxy object. All configs
