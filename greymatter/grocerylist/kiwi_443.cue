...
Kiwi_443: {
	...
	config: [
		...
		// Kiwi_443 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_443 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_443/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_443$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_443
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_443 proxy object. All configs
