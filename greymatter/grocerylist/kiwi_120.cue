...
Kiwi_120: {
	...
	config: [
		...
		// Kiwi_120 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_120 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_120/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_120$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_120
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_120 proxy object. All configs
