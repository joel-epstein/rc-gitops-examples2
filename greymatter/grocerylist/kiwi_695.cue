...
Kiwi_695: {
	...
	config: [
		...
		// Kiwi_695 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_695 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_695/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_695$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_695
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_695 proxy object. All configs
