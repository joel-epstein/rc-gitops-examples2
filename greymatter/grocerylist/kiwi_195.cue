...
Kiwi_195: {
	...
	config: [
		...
		// Kiwi_195 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_195 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_195/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_195$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_195
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_195 proxy object. All configs
