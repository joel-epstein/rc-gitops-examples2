...
Kiwi_206: {
	...
	config: [
		...
		// Kiwi_206 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_206 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_206/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_206$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_206
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_206 proxy object. All configs
