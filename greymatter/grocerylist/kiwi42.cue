...
Kiwi42: {
	...
	config: [
		...
		// Kiwi42 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi42 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi42/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi42$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi42
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi42 proxy object. All configs
