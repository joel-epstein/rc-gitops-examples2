...
Kiwi46: {
	...
	config: [
		...
		// Kiwi46 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi46
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi46 proxy object. All configs
