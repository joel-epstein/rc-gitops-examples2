...
Kiwi_350: {
	...
	config: [
		...
		// Kiwi_350 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_350 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_350/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_350$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_350
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_350 proxy object. All configs
