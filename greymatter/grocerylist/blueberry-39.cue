...
Blueberry_39: {
	...
	config: [
		...
		// Blueberry_39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-39
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-39 proxy object. All configs
