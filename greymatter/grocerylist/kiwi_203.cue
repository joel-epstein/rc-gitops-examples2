...
Kiwi_203: {
	...
	config: [
		...
		// Kiwi_203 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_203 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_203/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_203$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_203
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_203 proxy object. All configs
