...
Kiwi_966: {
	...
	config: [
		...
		// Kiwi_966 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_966 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_966/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_966$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_966
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_966 proxy object. All configs
