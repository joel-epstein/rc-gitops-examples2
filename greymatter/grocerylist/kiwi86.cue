...
Kiwi86: {
	...
	config: [
		...
		// Kiwi86 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi86 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi86/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi86$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi86
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi86 proxy object. All configs
