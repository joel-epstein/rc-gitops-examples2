...
Blueberry_12: {
	...
	config: [
		...
		// Blueberry_12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-12
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-12 proxy object. All configs
