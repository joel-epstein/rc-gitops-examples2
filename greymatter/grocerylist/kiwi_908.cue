...
Kiwi_908: {
	...
	config: [
		...
		// Kiwi_908 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_908 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_908/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_908$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_908
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_908 proxy object. All configs
