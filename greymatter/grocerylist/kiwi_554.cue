...
Kiwi_554: {
	...
	config: [
		...
		// Kiwi_554 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_554 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_554/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_554$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_554
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_554 proxy object. All configs
