...
Blueberry_84: {
	...
	config: [
		...
		// Blueberry_84 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_84 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-84/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-84$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-84
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-84 proxy object. All configs
