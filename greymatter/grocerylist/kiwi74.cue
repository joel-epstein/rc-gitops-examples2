...
Kiwi74: {
	...
	config: [
		...
		// Kiwi74 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi74 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi74/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi74$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi74
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi74 proxy object. All configs
