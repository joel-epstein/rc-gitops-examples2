...
Kiwi_850: {
	...
	config: [
		...
		// Kiwi_850 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_850 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_850/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_850$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_850
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_850 proxy object. All configs
