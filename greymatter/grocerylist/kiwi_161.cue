...
Kiwi_161: {
	...
	config: [
		...
		// Kiwi_161 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_161 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_161/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_161$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_161
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_161 proxy object. All configs
