...
Melon_17: {
	...
	config: [
		...
		// Melon_17 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_17 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-17
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-17 proxy object. All configs
