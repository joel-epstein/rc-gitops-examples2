...
Kiwi_514: {
	...
	config: [
		...
		// Kiwi_514 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_514 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_514/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_514$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_514
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_514 proxy object. All configs
