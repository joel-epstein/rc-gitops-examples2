...
Kiwi_488: {
	...
	config: [
		...
		// Kiwi_488 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_488 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_488/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_488$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_488
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_488 proxy object. All configs
