...
Kiwi_75: {
	...
	config: [
		...
		// Kiwi_75 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_75 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-75/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-75$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-75
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-75 proxy object. All configs
