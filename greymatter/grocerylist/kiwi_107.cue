...
Kiwi_107: {
	...
	config: [
		...
		// Kiwi_107 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_107 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_107/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_107$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_107
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_107 proxy object. All configs
