...
Kiwi_78: {
	...
	config: [
		...
		// Kiwi_78 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_78 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_78/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_78$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_78
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_78 proxy object. All configs
