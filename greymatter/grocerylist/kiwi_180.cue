...
Kiwi_180: {
	...
	config: [
		...
		// Kiwi_180 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_180 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_180/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_180$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_180
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_180 proxy object. All configs
