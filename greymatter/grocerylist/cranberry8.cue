...
Cranberry8: {
	...
	config: [
		...
		// Cranberry8 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry8 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry8/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry8$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry8
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry8 proxy object. All configs
