...
Kiwi_852: {
	...
	config: [
		...
		// Kiwi_852 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_852 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_852/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_852$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_852
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_852 proxy object. All configs
