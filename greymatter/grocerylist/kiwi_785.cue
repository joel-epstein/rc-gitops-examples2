...
Kiwi_785: {
	...
	config: [
		...
		// Kiwi_785 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_785 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_785/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_785$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_785
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_785 proxy object. All configs
