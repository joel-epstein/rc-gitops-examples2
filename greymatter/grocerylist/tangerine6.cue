...
Tangerine6: {
	...
	config: [
		...
		// Tangerine6 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine6 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine6/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine6$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine6
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine6 proxy object. All configs
