...
Grape_48: {
	...
	config: [
		...
		// Grape_48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-48
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-48 proxy object. All configs
