...
Kiwi_31: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_31/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_31$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_31
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_31 proxy object. All configs
