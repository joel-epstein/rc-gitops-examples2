...
Kiwi_412: {
	...
	config: [
		...
		// Kiwi_412 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_412 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_412/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_412$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_412
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_412 proxy object. All configs
