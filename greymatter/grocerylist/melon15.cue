...
Melon15: {
	...
	config: [
		...
		// Melon15 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon15 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon15/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon15$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon15
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon15 proxy object. All configs
