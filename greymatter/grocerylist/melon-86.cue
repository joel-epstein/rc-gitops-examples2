...
Melon_86: {
	...
	config: [
		...
		// Melon_86 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_86 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-86/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-86$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-86
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-86 proxy object. All configs
