...
Grape_44: {
	...
	config: [
		...
		// Grape_44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-44
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-44 proxy object. All configs
