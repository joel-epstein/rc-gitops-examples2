...
Kiwi_988: {
	...
	config: [
		...
		// Kiwi_988 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_988 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_988/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_988$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_988
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_988 proxy object. All configs
