...
Star31: {
	...
	config: [
		...
		// Star31 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star31 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star31/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star31$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star31
		#catalog_entry & {
			name:                      Name
		...
		// Shared star31 proxy object. All configs
