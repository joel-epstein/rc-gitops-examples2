...
Blueberry_11: {
	...
	config: [
		...
		// Blueberry_11 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_11 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-11/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-11$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-11
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-11 proxy object. All configs
