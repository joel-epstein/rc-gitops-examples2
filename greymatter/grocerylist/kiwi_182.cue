...
Kiwi_182: {
	...
	config: [
		...
		// Kiwi_182 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_182 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_182/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_182$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_182
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_182 proxy object. All configs
