...
Star22: {
	...
	config: [
		...
		// Star22 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star22 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star22
		#catalog_entry & {
			name:                      Name
		...
		// Shared star22 proxy object. All configs
