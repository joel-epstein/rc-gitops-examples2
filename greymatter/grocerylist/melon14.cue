...
Melon14: {
	...
	config: [
		...
		// Melon14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon14
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon14 proxy object. All configs
