...
Kiwi_783: {
	...
	config: [
		...
		// Kiwi_783 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_783 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_783/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_783$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_783
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_783 proxy object. All configs
