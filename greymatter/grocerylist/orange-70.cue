...
Orange_70: {
	...
	config: [
		...
		// Orange_70 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_70 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-70/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-70$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-70
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-70 proxy object. All configs
