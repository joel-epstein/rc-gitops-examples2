...
Blueberry32: {
	...
	config: [
		...
		// Blueberry32 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry32 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry32/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry32$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry32
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry32 proxy object. All configs
