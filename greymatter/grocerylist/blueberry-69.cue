...
Blueberry_69: {
	...
	config: [
		...
		// Blueberry_69 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_69 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-69/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-69$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-69
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-69 proxy object. All configs
