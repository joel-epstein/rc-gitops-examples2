...
Kiwi_521: {
	...
	config: [
		...
		// Kiwi_521 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_521 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_521/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_521$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_521
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_521 proxy object. All configs
