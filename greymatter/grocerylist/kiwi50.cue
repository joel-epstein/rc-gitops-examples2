...
Kiwi50: {
	...
	config: [
		...
		// Kiwi50 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi50 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi50/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi50$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi50
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi50 proxy object. All configs
