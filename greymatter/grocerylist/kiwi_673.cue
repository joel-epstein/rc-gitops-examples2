...
Kiwi_673: {
	...
	config: [
		...
		// Kiwi_673 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_673 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_673/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_673$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_673
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_673 proxy object. All configs
