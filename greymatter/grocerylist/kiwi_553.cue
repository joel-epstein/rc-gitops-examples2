...
Kiwi_553: {
	...
	config: [
		...
		// Kiwi_553 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_553 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_553/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_553$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_553
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_553 proxy object. All configs
