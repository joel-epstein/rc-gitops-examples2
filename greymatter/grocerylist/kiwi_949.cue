...
Kiwi_949: {
	...
	config: [
		...
		// Kiwi_949 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_949 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_949/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_949$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_949
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_949 proxy object. All configs
