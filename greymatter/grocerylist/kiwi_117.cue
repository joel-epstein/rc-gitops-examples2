...
Kiwi_117: {
	...
	config: [
		...
		// Kiwi_117 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_117 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_117/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_117$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_117
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_117 proxy object. All configs
