...
Star1: {
	...
	config: [
		...
		// Star1 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star1 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star1/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star1$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star1
		#catalog_entry & {
			name:                      Name
		...
		// Shared star1 proxy object. All configs
