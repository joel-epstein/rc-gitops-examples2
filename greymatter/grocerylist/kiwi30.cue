...
Kiwi30: {
	...
	config: [
		...
		// Kiwi30 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi30 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi30/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi30$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi30
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi30 proxy object. All configs
