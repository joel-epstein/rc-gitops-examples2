...
Kiwi69: {
	...
	config: [
		...
		// Kiwi69 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi69/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi69$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi69
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi69 proxy object. All configs
