...
Kiwi_151: {
	...
	config: [
		...
		// Kiwi_151 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_151 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_151/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_151$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_151
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_151 proxy object. All configs
