...
Kiwi_116: {
	...
	config: [
		...
		// Kiwi_116 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_116 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_116/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_116$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_116
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_116 proxy object. All configs
