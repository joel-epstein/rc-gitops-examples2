...
Tangerine16: {
	...
	config: [
		...
		// Tangerine16 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine16 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine16/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine16$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine16
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine16 proxy object. All configs
