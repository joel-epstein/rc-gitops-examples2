...
Kiwi_550: {
	...
	config: [
		...
		// Kiwi_550 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_550 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_550/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_550$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_550
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_550 proxy object. All configs
