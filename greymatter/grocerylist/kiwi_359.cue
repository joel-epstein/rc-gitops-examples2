...
Kiwi_359: {
	...
	config: [
		...
		// Kiwi_359 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_359 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_359/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_359$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_359
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_359 proxy object. All configs
