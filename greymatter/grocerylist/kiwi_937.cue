...
Kiwi_937: {
	...
	config: [
		...
		// Kiwi_937 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_937 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_937/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_937$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_937
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_937 proxy object. All configs
