...
Tangerine38: {
	...
	config: [
		...
		// Tangerine38 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine38 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine38
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine38 proxy object. All configs
