...
Star18: {
	...
	config: [
		...
		// Star18 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star18 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star18/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star18$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star18
		#catalog_entry & {
			name:                      Name
		...
		// Shared star18 proxy object. All configs
