...
Kiwi_461: {
	...
	config: [
		...
		// Kiwi_461 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_461 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_461/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_461$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_461
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_461 proxy object. All configs
