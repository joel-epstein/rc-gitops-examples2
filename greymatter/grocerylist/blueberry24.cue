...
Blueberry24: {
	...
	config: [
		...
		// Blueberry24 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry24 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry24/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry24$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry24
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry24 proxy object. All configs
