...
Kiwi_431: {
	...
	config: [
		...
		// Kiwi_431 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_431 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_431/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_431$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_431
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_431 proxy object. All configs
