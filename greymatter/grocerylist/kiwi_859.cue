...
Kiwi_859: {
	...
	config: [
		...
		// Kiwi_859 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_859 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_859/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_859$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_859
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_859 proxy object. All configs
