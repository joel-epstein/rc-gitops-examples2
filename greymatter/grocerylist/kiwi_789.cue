...
Kiwi_789: {
	...
	config: [
		...
		// Kiwi_789 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_789 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_789/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_789$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_789
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_789 proxy object. All configs
