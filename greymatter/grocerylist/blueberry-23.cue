...
Blueberry_23: {
	...
	config: [
		...
		// Blueberry_23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-23
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-23 proxy object. All configs
