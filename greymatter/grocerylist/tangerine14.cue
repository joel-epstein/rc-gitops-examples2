...
Tangerine14: {
	...
	config: [
		...
		// Tangerine14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine14
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine14 proxy object. All configs
