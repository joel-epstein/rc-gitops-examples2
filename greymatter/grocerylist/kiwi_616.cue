...
Kiwi_616: {
	...
	config: [
		...
		// Kiwi_616 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_616 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_616/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_616$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_616
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_616 proxy object. All configs
