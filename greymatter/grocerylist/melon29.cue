...
Melon29: {
	...
	config: [
		...
		// Melon29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon29
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon29 proxy object. All configs
