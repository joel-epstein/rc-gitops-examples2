...
Kiwi_302: {
	...
	config: [
		...
		// Kiwi_302 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_302 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_302/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_302$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_302
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_302 proxy object. All configs
