...
Melon8: {
	...
	config: [
		...
		// Melon8 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon8 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon8/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon8$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon8
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon8 proxy object. All configs
