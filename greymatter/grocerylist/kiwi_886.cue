...
Kiwi_886: {
	...
	config: [
		...
		// Kiwi_886 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_886 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_886/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_886$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_886
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_886 proxy object. All configs
