...
Tangerine_87: {
	...
	config: [
		...
		// Tangerine_87 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_87 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-87/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-87$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-87
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-87 proxy object. All configs
