...
Kiwi_539: {
	...
	config: [
		...
		// Kiwi_539 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_539 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_539/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_539$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_539
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_539 proxy object. All configs
