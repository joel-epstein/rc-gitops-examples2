...
Orange_28: {
	...
	config: [
		...
		// Orange_28 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_28 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-28
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-28 proxy object. All configs
