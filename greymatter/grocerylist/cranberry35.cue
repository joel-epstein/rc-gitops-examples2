...
Cranberry35: {
	...
	config: [
		...
		// Cranberry35 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry35 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry35/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry35$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry35
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry35 proxy object. All configs
