...
Kiwi_398: {
	...
	config: [
		...
		// Kiwi_398 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_398 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_398/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_398$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_398
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_398 proxy object. All configs
