...
Cranberry41: {
	...
	config: [
		...
		// Cranberry41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry41
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry41 proxy object. All configs
