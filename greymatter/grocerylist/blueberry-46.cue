...
Blueberry_46: {
	...
	config: [
		...
		// Blueberry_46 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_46 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-46
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-46 proxy object. All configs
