...
Kiwi_308: {
	...
	config: [
		...
		// Kiwi_308 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_308 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_308/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_308$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_308
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_308 proxy object. All configs
