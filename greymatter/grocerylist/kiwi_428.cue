...
Kiwi_428: {
	...
	config: [
		...
		// Kiwi_428 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_428 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_428/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_428$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_428
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_428 proxy object. All configs
