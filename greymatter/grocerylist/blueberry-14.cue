...
Blueberry_14: {
	...
	config: [
		...
		// Blueberry_14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-14
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-14 proxy object. All configs
