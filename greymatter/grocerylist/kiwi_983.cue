...
Kiwi_983: {
	...
	config: [
		...
		// Kiwi_983 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_983 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_983/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_983$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_983
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_983 proxy object. All configs
