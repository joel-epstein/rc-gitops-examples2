...
Tangerine_54: {
	...
	config: [
		...
		// Tangerine_54 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_54 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-54/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-54$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-54
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-54 proxy object. All configs
