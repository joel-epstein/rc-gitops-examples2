...
Kiwi_989: {
	...
	config: [
		...
		// Kiwi_989 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_989 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_989/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_989$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_989
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_989 proxy object. All configs
