...
Kiwi_724: {
	...
	config: [
		...
		// Kiwi_724 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_724 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_724/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_724$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_724
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_724 proxy object. All configs
