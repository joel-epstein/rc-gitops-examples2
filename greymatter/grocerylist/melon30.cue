...
Melon30: {
	...
	config: [
		...
		// Melon30 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon30 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon30/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon30$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon30
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon30 proxy object. All configs
