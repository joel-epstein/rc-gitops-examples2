...
Kiwi_403: {
	...
	config: [
		...
		// Kiwi_403 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_403 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_403/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_403$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_403
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_403 proxy object. All configs
