...
Melon10: {
	...
	config: [
		...
		// Melon10 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon10 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon10/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon10$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon10
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon10 proxy object. All configs
