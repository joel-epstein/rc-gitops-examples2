...
Kiwi_485: {
	...
	config: [
		...
		// Kiwi_485 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_485 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_485/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_485$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_485
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_485 proxy object. All configs
