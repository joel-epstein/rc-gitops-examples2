...
Kiwi_678: {
	...
	config: [
		...
		// Kiwi_678 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_678 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_678/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_678$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_678
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_678 proxy object. All configs
