...
Kiwi_247: {
	...
	config: [
		...
		// Kiwi_247 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_247 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_247/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_247$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_247
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_247 proxy object. All configs
