...
Kiwi_915: {
	...
	config: [
		...
		// Kiwi_915 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_915 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_915/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_915$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_915
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_915 proxy object. All configs
