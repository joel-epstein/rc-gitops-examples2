...
Kiwi_981: {
	...
	config: [
		...
		// Kiwi_981 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_981 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_981/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_981$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_981
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_981 proxy object. All configs
