...
Orange_36: {
	...
	config: [
		...
		// Orange_36 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_36 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-36
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-36 proxy object. All configs
