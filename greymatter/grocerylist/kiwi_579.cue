...
Kiwi_579: {
	...
	config: [
		...
		// Kiwi_579 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_579 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_579/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_579$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_579
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_579 proxy object. All configs
