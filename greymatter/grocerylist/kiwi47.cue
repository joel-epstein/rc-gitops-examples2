...
Kiwi47: {
	...
	config: [
		...
		// Kiwi47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi47
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi47 proxy object. All configs
