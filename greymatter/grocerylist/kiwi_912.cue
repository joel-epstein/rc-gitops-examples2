...
Kiwi_912: {
	...
	config: [
		...
		// Kiwi_912 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_912 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_912/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_912$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_912
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_912 proxy object. All configs
