...
Kiwi48: {
	...
	config: [
		...
		// Kiwi48 -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi48
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi48 proxy object. All configs
