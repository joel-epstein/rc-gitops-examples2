...
Kiwi_47: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-47
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-47 proxy object. All configs
