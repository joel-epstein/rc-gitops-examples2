...
Kiwi_296: {
	...
	config: [
		...
		// Kiwi_296 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_296 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_296/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_296$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_296
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_296 proxy object. All configs
