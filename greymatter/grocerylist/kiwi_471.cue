...
Kiwi_471: {
	...
	config: [
		...
		// Kiwi_471 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_471 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_471/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_471$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_471
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_471 proxy object. All configs
