...
Kiwi_888: {
	...
	config: [
		...
		// Kiwi_888 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Kiwi_888 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi_888/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi_888$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi_888
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi_888 proxy object. All configs
