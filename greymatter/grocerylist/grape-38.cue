...
Grape_38: {
	...
	config: [
		...
		// Grape_38 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_38 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-38
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-38 proxy object. All configs
